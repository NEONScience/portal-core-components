...
var buildManifestRequestUrl = function buildManifestRequestUrl(config) {
  ...
  var url = "".concat(_NeonEnvironment.default.getFullApiPath('manifest'), "/manifest/rollup");
...
var downloadManifest = function downloadManifest(manifest) {
  ...
  form.action = "".concat(_NeonEnvironment.default.getFullApiPath('download'), "/stream");
  form.method = 'POST';
...
var downloadAopManifest = function downloadAopManifest(config, s3Files) {
  ...
  var siteCodes = [];
  var s3FileValues = s3Files.cachedValues;
  var manifestS3Files = s3FileValues.map(function (file) {
    return {
