...
const downloadAopManifest = function (config, s3Files, params) {
  let documentation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'include';
  const siteCodes = [];
