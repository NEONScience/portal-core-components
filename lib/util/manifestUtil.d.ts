...
export declare const downloadManifest: (manifest: ManifestRequest, params?: Record<string, string>) => void;
export declare const downloadAopManifest: (config: ManifestConfig, s3Files: Record<string, unknown>, params?: Record<string, string>, documentation?: string) => void;
