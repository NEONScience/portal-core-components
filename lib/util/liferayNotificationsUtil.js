...
export const getLiferayNotificationsApiPath = ()=>NeonEnvironment.getFullAuthPath('notifications');
...
/* eslint-disable no-bitwise */ export const generateNotificationId = (message)=>{
    let hash = 0;
    if (!message.length) {
        return hash;
    }
...
/* eslint-enable no-bitwise */ export default getLiferayNotificationsApiPath;
