...
const RouteService = {
  ...
  getDataPoliciesPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/data-samples/guidelines-policies"),
  getDataPoliciesCitationPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/data-samples/guidelines-policies/citing"),
  ...
  getDataSamplesPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/data"),
  getSamplesPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/samples"),
  getDataSamplesDataPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/data"),
  ...
  getThemeDetailPath: theme => "".concat(_NeonEnvironment.default.getWebHost(), "/data-samples/data-themes/").concat(theme),
  ...
  getTaxonomicListsPath: () => "".concat(_NeonEnvironment.default.getApiHost(), "/taxonomic-lists"),
  getDataProductCitationDownloadUrl: () => _NeonEnvironment.default.getApiHost(),
  ...
  getDataProductExplorePath: () => "".concat(_NeonEnvironment.default.getApiHost(), "/data-products/explore"),
  ...
  getPrototypeDatasetsPath: () => "".concat(_NeonEnvironment.default.getApiHost(), "/prototype-datasets"),
  getPrototypeDatasetDetailPath: uuid => "".concat(_NeonEnvironment.default.getApiHost(), "/prototype-datasets/").concat(uuid),
  getSaeViewerUrl: () => // TODO: replace with web host once switch over happens
  "".concat(_NeonEnvironment.default.getApiHost(), "/visualizations/sae-visualization"),
  getSaeViewerUrlPath: (product, site, startDate, endDate) => {
    const url = new URL("".concat(_NeonEnvironment.default.getApiHost(), "/visualizations/sae-visualization"));
    if (product) {
