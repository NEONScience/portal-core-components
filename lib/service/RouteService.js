...
const RouteService = {
  ...
  getDataPoliciesPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/usage-policies"),
  getDataPoliciesCitationPath: () => "".concat(_NeonEnvironment.default.getWebHost(), "/data/guidelines-policies/citing"),
