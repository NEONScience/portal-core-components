...
const RouteService = {
  ...
  getDataPoliciesPath: () => `${_NeonEnvironment.default.getWebHost()}/data-samples/guidelines-policies`,
  getDataPoliciesCitationPath: () => `${_NeonEnvironment.default.getWebHost()}/data-samples/guidelines-policies/citing`,
  ...
  getThemeDetailPath: theme => `${_NeonEnvironment.default.getWebHost()}/data-samples/data-themes/${theme}`,
