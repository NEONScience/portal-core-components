...
var RouteService = {
  ...
  getContactUsPath: function getContactUsPath() {
    return "".concat(_NeonEnvironment.default.getWebHost(), "/about/contact-us");
  },
  getDownloadExplorePath: function getDownloadExplorePath() {
    return "".concat(_NeonEnvironment.default.getWebHost(), "/resources/learning-hub/tutorials/download-explore-neon-data");
  },
  ...
  getDataProductBundlesPath: function getDataProductBundlesPath() {
    return "".concat(_NeonEnvironment.default.getWebHost(), "/data-samples/data-management/data-product-bundles");
  },
  ...
  getDataProductExploreSearchPath: function getDataProductExploreSearchPath(query) {
    return "".concat(RouteService.getDataProductExplorePath(), "?search=").concat(encodeURIComponent(query));
  },
  ...
  getProductDetailPath: function getProductDetailPath(productCode, release) {
    var releasePath = (0, _typeUtil.isStringNonEmpty)(release) ? "/".concat(release) : '';
    // TODO: replace with web host once switch over happens
