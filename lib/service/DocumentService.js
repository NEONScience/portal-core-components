...
var VIEWER_SUPPORTED_DOC_TYPES = ['application/pdf', 'text/html', 'text/markdown', 'text/plain']; // See full list of device types here:
// https://github.com/faisalman/ua-parser-js#methods

exports.VIEWER_SUPPORTED_DOC_TYPES = VIEWER_SUPPORTED_DOC_TYPES;
var VIEWER_NOT_SUPPORTED_DEVICE_TYPES = ['console', 'mobile', 'tablet', 'smarttv', 'wearable', 'embedded'];
var documentTypes = {
  pdf: {
...
var DocumentService = {
  ...
  getQuickStartGuideNameRegex: function getQuickStartGuideNameRegex() {
    return (// eslint-disable-next-line prefer-regex-literals
      new RegExp( /*#__PURE__*/_wrapRegExp(/^(NEON[.]QSG[.]DP[0-9]{1}[.][0-9]{5}[.][0-9]{3})(v([0-9]+))*([.]([a-z]+))*$/, {
        name: 1,
        version: 2,
        versionNumber: 3,
        extension: 4,
  ...
  isViewerDeviceSupported: function isViewerDeviceSupported() {
    var uaParser = new _uaParserJs.default();
