...
export interface IAsyncFlowProvider {
    create: <S extends AnyObject, A extends AsyncActionType, T>(actionTypes: AsyncFlowActionTypes, parserFunction: ParserFunction<T>, ignoreWhenDevEnv?: boolean) => AsyncFlowHandler<S, A, T>;
