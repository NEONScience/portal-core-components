...
const transformRequests = (ajax, requests, action, ajaxBodyCreator, ajaxRequestInjector)=>/* eslint-disable indent */ requests.map((request, index)=>transformRequest(ajax, request, action, ajaxBodyCreator, ajaxRequestInjector, index));
/* eslint-enable indent */ const createSingleAjaxObservable = (ajax, ajaxConfig, operators, action, ajaxBodyCreator, ajaxRequestInjector)=>{
