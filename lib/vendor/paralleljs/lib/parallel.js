...
var isCommonJS = typeof module !== 'undefined' && module.exports; // const isNode = !(typeof window !== 'undefined' && this === window);
...
var defaults = {
  ...
  evalPath: null,
  maxWorkers: isNode ? 2 : navigator.hardwareConcurrency || 4,
  synchronous: true,
  env: {},
  envNamespace: 'env'
};
