...
const LoginRequiredCard = props => {
  ...
  const hasValidationSteps = (0, _typeUtil.existsNonEmpty)(accountValidationSteps);
  ...
  const renderContents = () => {
    ...
    if ((0, _typeUtil.exists)(customContent)) {
      ...
      message = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, customContent);
    } else {
      ...
      }, "You must sign in or create and validate an account before proceeding.", ' ', " Navigate to ", myAccountLink, " to sign in or create an account.", ' ', " ", accountInfoLink, " about the benefits of having an account."), !hasValidationSteps ? /*#__PURE__*/_react.default.createElement(_NeonSignInButton.default, {
        disableMargin: true
      }) : null);
    }
  ...
  return /*#__PURE__*/_react.default.createElement(_InfoMessageCard.default, _extends({}, props, {
    title: (0, _typeUtil.isStringNonEmpty)(customTitle) ? customTitle : 'Login Required',
    classes: {
      card: classes.card,
