...
var TimeSeriesViewerDateRange = function TimeSeriesViewerDateRange(props) {
  ...
  if (!displayRange.length) {
    return _react.default.createElement("div", null, _react.default.createElement(_Skeleton.default, {
      variant: "rect",
      width: "100%",
      height: 56
      ...
      width: 300,
      height: 28
    }), _react.default.createElement("br", null), _react.default.createElement(_Skeleton.default, {
      variant: "rect",
      width: "100%",
      height: 80
    }));
  ...
  }, "Select by Data Product Availability"), _react.default.createElement(_FullWidthVisualization.default, {
    vizRef: svgRef,
