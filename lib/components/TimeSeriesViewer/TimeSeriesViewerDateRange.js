...
const getYearMonthMoment = (yearMonth, day = 15) => (0, _moment.default)(`${yearMonth}-${day.toString().padStart(2, '0')}`);
...
const useStyles = (0, _styles.makeStyles)(() => ({
  ...
  slider: {
    ...
    width: `calc(100% - ${_Theme.default.spacing(6)})`,
...
const TimeSeriesViewerDateRange = props => {
  ...
  const pointsPerMonth = _TimeSeriesViewerContext.default.calcPredictedPointsByDateRange(state, currentRange[0], currentRange[0]);
  ...
  if (!displayRange.length || !selectedSites.length) {
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Skeleton.default, {
        ...
        width: 300,
        height: 28
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), /*#__PURE__*/(0, _jsxRuntime.jsx)(_Skeleton.default, {
        variant: "rectangular",
        width: "100%",
        height: 80
      })]
  ...
  const renderedSlider = uniqueSliderMarks <= 1 ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(_Slider.default, {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_AvailabilitySvgComponents.SvgDefs, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
        variant: "h6",
        gutterBottom: true,
        children: "Select by Data Product Availability"
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_FullWidthVisualization.default, {
        vizRef: svgRef,
      ...
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_BasicAvailabilityKey.default, {
        style: {
          flexGrow: 1
        },
