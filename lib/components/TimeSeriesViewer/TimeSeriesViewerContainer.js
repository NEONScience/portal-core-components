...
var useTabStyles = (0, _styles.makeStyles)(function (theme) {
  var _notFirstChild, _root, _selected;

  return {
    root: (_root = {}, _defineProperty(_root, theme.breakpoints.down('sm'), {
      paddingRight: theme.spacing(2.5)
    }), _defineProperty(_root, "textTransform", 'none'), _defineProperty(_root, "opacity", 1), _defineProperty(_root, '&:not(:first-child)', (_notFirstChild = {}, _defineProperty(_notFirstChild, theme.breakpoints.down('sm'), {
      marginLeft: '-1.5px'
    }), _defineProperty(_notFirstChild, theme.breakpoints.up('md'), {
      marginTop: '-1.5px'
    }), _notFirstChild)), _root),
