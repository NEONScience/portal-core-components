...
function TimeSeriesViewerContainer() {
  ...
  var _useState = (0, _react.useState)(DEFAULT_PANEL),
  ...
  var renderPanelComponent = function renderPanelComponent(panelId) {
    ...
    switch (panelId) {
      case 'DATE_RANGE':
        return _react.default.createElement(PanelComponent, {
          dateRangeSliderRef: dateRangeSliderRef
        });

      default:
        return _react.default.createElement(PanelComponent, null);
    }
  };
