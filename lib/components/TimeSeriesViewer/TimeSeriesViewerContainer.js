...
*/ export function TimeSeriesViewerSummary() {
    ...
    if (state.release === null) {
        releaseTooltip = 'You are viewing only the latest released and provisional data ' + `(release: ${latestRelease || 'unknown'}).`;
    } else {
        releaseTooltip = `You are viewing product data only from the ${state.release} ` + 'release (no provisional data will be included).';
    }
    ...
    const axesSummary = /*#__PURE__*/ _jsx(TableContainer, {
        children: /*#__PURE__*/ _jsx(Table, {
            size: "small",
            className: classes.axisTableRoot,
...
export default function TimeSeriesViewerContainer() {
    ...
    const renderTabPanels = ()=>/*#__PURE__*/ _jsx("div", {
            ...
            children: Object.keys(TABS).map((tabId)=>{
                ...
                return /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        /*#__PURE__*/ _jsx(TimeSeriesViewerLimitedCard, {
                            showInfoOnly: true
                        }),
                        /*#__PURE__*/ _jsx(TabComponent, {
                            ...tabComponentProps
                        })
                    ]
                }, tabId);
    ...
    const renderGraphOverlay = ()=>{
        ...
        if (isError || isWarning || isLoginRequired) {
            const icon = isLoginRequired ? /*#__PURE__*/ _jsx(InfoIcon, {
                fontSize: "large",
            ...
            return /*#__PURE__*/ _jsxs(Grid, {
                children: [
                    /*#__PURE__*/ _jsx(WarnIcon, {
                        fontSize: "medium",
                        className: classes.statusBarWarningIcon
                    }),
                    /*#__PURE__*/ _jsx("div", {
                        style: {
                            display: 'inline-flex',
                        ...
                        children: /*#__PURE__*/ _jsx(Typography, {
                            ...
                            children: "Data point total approaching limit; some options are disabled."
                        })
                    })
                ]
            });
                    ...
                    /*#__PURE__*/ _jsxs(Grid, {
                        ...
                        children: [
                            /*#__PURE__*/ _jsx(ComputerIcon, {
                                fontSize: "medium",
                                className: classes.statusBarIcon
                            }),
                            /*#__PURE__*/ _jsxs("div", {
                                style: {
                                    display: 'inline-flex',
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ _jsx(Typography, {
                                        variant: "body2",
                                        className: classes.statusBarPointsText,
                                        children: `${pointTotal} of ${addThousandsSeparator(POINTS_PERFORMANCE_LIMIT)}`
                                    })
                                ]
                            })
                        ]
