...
var _TimeSeriesViewerLimitedCard = _interopRequireDefault(require("./TimeSeriesViewerLimitedCard"));
...
function TimeSeriesViewerContainer() {
  ...
  const renderTabPanels = () => /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, /*#__PURE__*/_react.default.createElement(_TimeSeriesViewerLimitedCard.default, {
      showInfoOnly: true
    }), /*#__PURE__*/_react.default.createElement(TabComponent, tabComponentProps));
  }));
  const renderGraphOverlay = () => {
    const isLoginRequired = state.status === _constants.TIME_SERIES_VIEWER_STATUS.LOGIN_REQUIRED;
    ...
    if (isError || isWarning || isLoginRequired) {
      const icon = isLoginRequired ? /*#__PURE__*/_react.default.createElement(_Info.default, {
        fontSize: "large",
      ...
      }, state.displayError || 'An unknown error occurred; unable to visualize data product'), icon);
    }
  ...
  const renderStatusBar = () => {
    ...
    const numPointsPos = _TimeSeriesViewerContext.default.calcPredictedPointsForNewPosition(state);
    const numPointsVar = _TimeSeriesViewerContext.default.calcPredictedPointsForNewVariable(state);
    if (numPointsPos > _TimeSeriesViewerContext.POINTS_PERFORMANCE_LIMIT || numPointsVar > _TimeSeriesViewerContext.POINTS_PERFORMANCE_LIMIT) {
      showWarning = true;
    }
    return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement(_TimeSeriesViewerLimitedCard.default, null), /*#__PURE__*/_react.default.createElement(_Card.default, {
