...
function TimeSeriesViewerSummary() {
  ...
  var _state$selection = state.selection,
      ...
      rollPeriod = _state$selection.rollPeriod; // Sites

  var sitesSummary = sites.map(function (site) {
  ...
  var dateRangeSummary = "".concat(startMoment.format('MMM YYYY'), " - ").concat(endMoment.format('MMM YYYY'), " (").concat(diff, ")"); // Variables

  var variablesSummary = variables.join(', '); // Options

  var currentTimeStep = timeStep === 'auto' ? autoTimeStep : timeStep;
  var autoTimeStepDisplay = timeStep === 'auto' ? " (".concat(currentTimeStep, ")") : '';
...
function TimeSeriesViewerContainer() {
  ...
  }, _react.default.createElement("b", null, state.status), _react.default.createElement(_TimeSeriesViewerGraph.default, null), _react.default.createElement("br", null), _react.default.createElement("div", {
