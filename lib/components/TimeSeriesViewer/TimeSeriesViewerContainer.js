...
function TimeSeriesViewerContainer() {
  ...
  var getOptionsSummary = function getOptionsSummary() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, options.join(' · '), qualityFlags.length > 0 ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("br", null), "Quality flags: ".concat(qualityFlags.join(', '))) : null);
  };
