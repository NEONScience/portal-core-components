...
function TimeSeriesViewerContainer() {
  ...
  var renderTabs = function renderTabs() {
    return _react.default.createElement(_Tabs.default, {
      ...
      var style = {}; // if (tabId === TAB_IDS.SUMMARY && !belowMd) {
  ...
  return _react.default.createElement("div", {
    ...
    elevation: 4
  }, _react.default.createElement("div", null, state.product.productCode === loadedProductCode ? _react.default.createElement(_TimeSeriesViewerGraph.default, null) : null, renderGraphOverlay()), _react.default.createElement("div", {
