...
function SelectPositionsButton(props) {
  ...
  var availablePositions = Object.keys(state.product.sites[siteCode].positions);
...
function SelectedSite(props) {
  ...
  var selectedSiteContent = _react.default.createElement(_Typography.default, {
    variant: "body1"
  }, siteCode);
  ...
  if (allSites[siteCode]) {
    ...
    var iconSvg = ICON_SVGS[type] && ICON_SVGS[type][terrain] ? ICON_SVGS[type][terrain] : null;
    selectedSiteContent = _react.default.createElement("div", {
      className: classes.startFlex,
      style: {
        flexBasis: '50%'
      }
      ...
      variant: "body2",
      className: classes.optionSubtitle
    }, terrainTypeTitle, _react.default.createElement("br", null), "Domain ".concat(domainCode, " (").concat(domainName, ")"), _react.default.createElement("br", null), "Lat/Lon: ".concat(latitude, ", ").concat(longitude)), _react.default.createElement(SelectPositionsButton, {
      selectedSite: site
    })));
  }
  ...
  return _react.default.createElement(_Paper.default, {
    ...
    gutterBottom: true
  }, "Position(s):"), site.positions.map(function (position) {
...
function TimeSeriesViewerSites() {
  ...
  return _react.default.createElement("div", {
    className: classes.root
  }, _react.default.createElement(SitesSelect, null), _react.default.createElement("div", {
