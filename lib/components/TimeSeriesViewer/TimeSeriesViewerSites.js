...
var POSITION_DETAIL_COMPONENT_XS_UPPER = 300;
var POSITION_DETAIL_COMPONENT_MD_LOWER = 600;
/**
...
function PositionDetail(props) {
  ...
  var positionContainerStyle = {
    alignItems: 'center',
    justifyContent: 'space-between'
  };
  var positionSectionsContainerStyle = {
    display: 'flex',
    flexDirection: 'column'
  };
  var historyButtonContainerStyle = {
    textAlign: 'right'
  };
...
function SelectPositionsButton(props) {
  ...
  var _useState5 = (0, _react.useState)(false),
      ...
      selectDialogOpen = _useState6[0],
      setSelectDialogOpen = _useState6[1]; // Local state for position selections so that no fetches are fired until the dialog is submitted


  var _useState7 = (0, _react.useState)(selectedPositions),
      _useState8 = _slicedToArray(_useState7, 2),
      localSelectedPositions = _useState8[0],
      setLocalSelectedPositions = _useState8[1];
