...
var _iconSiteCoreTerrestrial = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!../SiteMap/svg/icon-site-core-terrestrial.svg"));

var _iconSiteCoreAquatic = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!../SiteMap/svg/icon-site-core-aquatic.svg"));

var _iconSiteGradientTerrestrial = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!../SiteMap/svg/icon-site-gradient-terrestrial.svg"));

var _iconSiteGradientAquatic = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!../SiteMap/svg/icon-site-gradient-aquatic.svg"));
...
function PositionHistoryButton(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Button.default, {
    ...
    if (!isNaN(parsedReferenceElevation)) {
      if (!isNaN(hasZOffset)) {
        elevation = "".concat((parsedReferenceElevation + parsedZOffset).toFixed(2).toString());
      } else {
        elevation = "".concat(parsedReferenceElevation);
      }
    }
...
function SelectedPosition(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_Card.default, {
    ...
    onClick: function onClick() {
      ...
      var positions = state.selection.sites[selectedSiteIdx].positions.filter(function (p) {
        return p !== position;
      });
      dispatch({
...
function TimeSeriesViewerSites(props) {
  ...
  var _TimeSeriesViewerCont11 = _TimeSeriesViewerContext.default.useTimeSeriesViewerState(),
      _TimeSeriesViewerCont12 = _slicedToArray(_TimeSeriesViewerCont11, 2),
      state = _TimeSeriesViewerCont12[0],
      dispatch = _TimeSeriesViewerCont12[1];
  ...
  var selectedItems = state.selection.sites.map(function (site) {
    return site.siteCode;
  });
  return /*#__PURE__*/_react.default.createElement("div", {
...
TimeSeriesViewerSites.propTypes = _TimeSeriesViewerContext.TabComponentPropTypes; // Additional items exported for unit testing

var getTestableItems = function getTestableItems() {
  return process.env.NODE_ENV !== 'test' ? {} : {
    ucWord: ucWord,
    PositionHistoryButton: PositionHistoryButton,
    PositionDetail: PositionDetail,
    SelectedPosition: SelectedPosition,
    SelectPositionsButton: SelectPositionsButton,
