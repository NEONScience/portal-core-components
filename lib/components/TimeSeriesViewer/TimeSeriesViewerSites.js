...
function PositionHistoryButton(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Button.default, {
    ...
    startIcon: /*#__PURE__*/_react.default.createElement(_History.default, null)
  }, `History (${history.length})`), /*#__PURE__*/_react.default.createElement(_Dialog.default, {
    ...
    variant: "h6",
    id: "position-history-dialog-title"
  }, `Position History: ${siteCode} - ${position}`)), /*#__PURE__*/_react.default.createElement(_DialogContent.default, {
    dividers: true
  }, /*#__PURE__*/_react.default.createElement(_DialogContentText.default, {
    id: "position-history-dialog-description",
    tabIndex: -1,
    variant: "body2"
  }, `${positionsDescription} The table below shows changes to the physical location of this position since its creation.`), /*#__PURE__*/_react.default.createElement(_TableContainer.default, null, /*#__PURE__*/_react.default.createElement(_Table.default, {
...
function PositionDetail(props) {
  ...
  const renderDescription = () => {
    ...
    return wide ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, "Location: "), `${appliedDescription} (${appliedName})`)), !includeReference ? null : /*#__PURE__*/_react.default.createElement("div", {
      className: classes.startFlex,
      style: {
        ...fadeStyle,
        marginRight: _Theme.default.spacing(3)
    ...
    }, "Reference Location: "), `${appliedReferenceDescription} (${appliedReferenceName})`))) : /*#__PURE__*/_react.default.createElement("div", {
      style: {
        marginRight: _Theme.default.spacing(3),
        marginTop: _Theme.default.spacing(0.5)
      }
      ...
      variant: "body2"
    }, `${appliedDescription} (${appliedName})`)), !includeReference ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      style: {
        fontWeight: 600
      }
  ...
  }, "x / y / z:"), `${displayXOffset} / ${displayYOffset} / ${displayZOffset}`)), renderDescription()) : /*#__PURE__*/_react.default.createElement("div", {
    ref: containerRef,
    className: classes.startFlex,
  ...
  }, "x:"), `${displayXOffset}`, /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("span", {
    style: {
      ...axisStyle
    }
  }, "y:"), `${displayYOffset}`, /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("span", {
    style: {
      ...axisStyle
    }
  }, "z:"), `${displayZOffset}`))), renderDescription()), /*#__PURE__*/_react.default.createElement("div", {
...
function SelectPositionsButton(props) {
  ...
  }, `${localSelectedPositions.length} of ${availablePositions.length} selected`, /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("span", {
    style: {
      fontWeight: 300,
      color: _Theme.default.palette.grey[500],
      fontStyle: 'italic'
...
function SiteOption(props) {
  ...
  if (stateCode) {
    ...
    optionContent = /*#__PURE__*/_react.default.createElement("div", {
      ...
      variant: "body1"
    }, `${siteCode} - ${description}, ${stateCode}`), /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
...
function SelectedSite(props) {
  ...
  let selectedSiteContent = /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "body1",
    gutterBottom: true
  }, `${siteCode} (loading site details…)`), removeSiteButton);
  if (allSites[siteCode]) {
    ...
    }, `${description} (${siteCode})`), removeSiteButton), /*#__PURE__*/_react.default.createElement("div", {
