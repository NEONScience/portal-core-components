...
function PositionHistoryButton(props) {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Button.default, {
    ...
    className: classes.smallButtonIcon
  }), "History (".concat(history.length, ")")), _react.default.createElement(_Dialog.default, {
    ...
    variant: "h6",
    id: "position-history-dialog-title"
  }, "Position History: ".concat(siteCode, " - ").concat(position))), _react.default.createElement(_DialogContent.default, {
    dividers: true
  }, _react.default.createElement(_DialogContentText.default, {
    id: "position-history-dialog-description",
    tabIndex: -1,
    variant: "body2"
  }, "Positions are distinct physical sensor locations at a given site. The x, y, and z coordinates describe where the sensor is located relative to the ground-level reference point for the site. Positions may change over time. The table below shows changes to the physical location of this position since its creation."), _react.default.createElement(_TableContainer.default, null, _react.default.createElement(_Table.default, {
  ...
  }, _react.default.createElement(_TableCell.default, null, "Start Date"), _react.default.createElement(_TableCell.default, null, "End Date"), _react.default.createElement(_TableCell.default, {
    align: "right"
  }, "x"), _react.default.createElement(_TableCell.default, {
    align: "right"
  }, "y"), _react.default.createElement(_TableCell.default, {
    align: "right"
  }, "z"), _react.default.createElement(_TableCell.default, {
    align: "right"
  }, "Elevation"))), _react.default.createElement(_TableBody.default, null, history.map(function (row, idx) {
    var start = row.start,
        rawEnd = row.end,
        xOffset = row.xOffset,
        yOffset = row.yOffset,
    ...
    return _react.default.createElement(_TableRow.default, {
      ...
      scope: "row",
      style: cellStyle
    }, start), _react.default.createElement(_TableCell.default, {
      component: "th",
      scope: "row",
      style: cellStyle
    }, end), _react.default.createElement(_TableCell.default, {
      align: "right",
      style: cellStyle
    }, "".concat(xOffset, "m")), _react.default.createElement(_TableCell.default, {
      align: "right",
      style: cellStyle
    }, "".concat(yOffset, "m")), _react.default.createElement(_TableCell.default, {
      align: "right",
      style: cellStyle
    }, "".concat(zOffset, "m")), _react.default.createElement(_TableCell.default, {
      align: "right",
      style: cellStyle
    }, "".concat(elevation, "m")));
...
PositionHistoryButton.propTypes = {
  ...
  history: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    referenceStart: _propTypes.default.string.isRequired,
    referenceEnd: _propTypes.default.string.isRequired,
...
function PositionDetail(props) {
  ...
  return wide ? _react.default.createElement("div", null, _react.default.createElement("div", {
  ...
  }, position), _react.default.createElement(_Typography.default, {
    variant: "body2",
    ...
    style: _extends({}, axisStyle)
  }, "z:"), "".concat(zOffset, "m"))), _react.default.createElement("div", {
    style: {
      flexGrow: 1,
      textAlign: 'right'
    }
  }, _react.default.createElement(PositionHistoryButton, {
    siteCode: siteCode,
    position: position,
    history: history
  })));
...
function SelectedSite(props) {
  ...
  var dateRangeTabButton = _react.default.createElement(_Button.default, {
    size: "small",
    color: "secondary",
    onClick: function onClick() {
  ...
  if (allSites[siteCode]) {
    ...
    }, latitude, _react.default.createElement("br", null), longitude)))), _react.default.createElement("div", {
      className: classes.siteDetailsColumn
    }, _react.default.createElement("div", {
      className: classes.siteDetail
    }, _react.default.createElement(_Typography.default, {
  ...
  }, selectedSiteContent, positions.length ? _react.default.createElement("div", null, _react.default.createElement("div", {
  ...
  }, "No Positions Available.")), _react.default.createElement(_Typography.default, {
    variant: "body2",
    className: classes.noneLabel,
    style: {
      fontSize: '0.8rem'
    }
  }, _react.default.createElement("i", null, "This site has no available data for the current selected date range, and thus no positions. See ", dateRangeTabButton, " to compare selection with availability."))));
}
...
function TimeSeriesViewerSites(props) {
  ...
  return _react.default.createElement("div", {
    ...
    return _react.default.createElement(SelectedSite, _extends({
      key: site.siteCode,
      site: site,
