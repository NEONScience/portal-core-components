...
var YAxisRangeOption = function YAxisRangeOption(props) {
  ...
  var _state$selection$yAxe = state.selection.yAxes[axis],
      ...
      standardDeviation = _state$selection$yAxe.standardDeviation; // Local state for the range min/max as we change it. This lets us change the range with
...
function TimeSeriesViewerAxes() {
  ...
  }, renderOption('Y1_AXIS_RANGE')), !hasY2Axis ? null : renderOption('Y2_AXIS_RANGE')), /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "h6",
    gutterBottom: true
