...
import TimeSeriesViewerContext, { TIME_STEPS, Y_AXIS_RANGE_MODES, Y_AXIS_RANGE_MODE_DETAILS, summarizeTimeSteps, POINTS_PERFORMANCE_LIMIT } from './TimeSeriesViewerContext';
...
*/ const YAxisScaleOption = ()=>{
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            ...
            yAxes.y2.units === null ? null : /*#__PURE__*/ _jsxs(Button, {
                color: "primary",
                variant: "outlined",
                onClick: ()=>{
                    dispatch({
...
*/ const YAxisRangeOption = (props)=>{
    ...
    const [state, dispatch] = TimeSeriesViewerContext.useTimeSeriesViewerState();
    const { selection: { logscale, yAxes: { [axis]: { units, dataRange, rangeMode, axisRange, precision, standardDeviation } } } } = state;
    ...
    const debounceSetMax = debounce((value)=>{
        setMax(value);
    }, 200);
    const debounceSetMin = debounce((value)=>{
        setMin(value);
    }, 200);
    return !render ? /*#__PURE__*/ _jsxs("div", {
        ...
        className: classes.yAxisRangeOuterContainer,
        children: [
            !logscale || dataRange[0] >= 0 ? null : /*#__PURE__*/ _jsx(Typography, {
                variant: "caption",
                className: classes.optionExtraDescription,
                children: "Negative values are clipped while in logarithmic scale"
            }),
            /*#__PURE__*/ _jsx(ToggleButtonGroup, {
                ...
                children: Object.keys(Y_AXIS_RANGE_MODES).map((key)=>/*#__PURE__*/ _jsx(ToggleButton, {
                        value: key,
                        size: "small",
                        className: classNames[rangeMode !== key ? 'deselected' : 'selected'],
                        title: Y_AXIS_RANGE_MODE_DETAILS[key].description,
                        children: Y_AXIS_RANGE_MODE_DETAILS[key].name
                    }, key))
            }),
            /*#__PURE__*/ _jsxs("div", {
                className: classes.yAxisRangeInnerContainer,
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ _jsxs("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ _jsx("i", {
                                        children: `${String.fromCharCode(963)}`
                                    }),
                                    " = ",
                                    `${standardDeviation}`
                                ]
...
YAxisRangeOption.propTypes = PropTypes.oneOf([
    'y1',
    'y2'
]).isRequired;
/**
...
*/ const RollPeriodOption = ()=>{
    ...
    const { rollPeriod: currentRollPeriod, timeStep: selectedTimeStep, autoTimeStep } = selection;
    ...
    return !currentTimeStep ? /*#__PURE__*/ _jsx(Skeleton, {
        variant: "rectangular",
        width: "100%",
        height: 56
    }) : /*#__PURE__*/ _jsx("div", {
...
*/ const TimeStepOption = ()=>{
    ...
    return /*#__PURE__*/ _jsx(ToggleButtonGroup, {
        ...
        children: Array.from(availableTimeSteps).map((timeStep)=>{
            const className = timeStep === selectedTimeStep ? `${classes.optionButton} ${classes.optionButtonSelected}` : classes.optionButton;
...
*/ const OPTIONS = {
    ...
    Y1_AXIS_RANGE: {
        ...
        Component: ()=>/*#__PURE__*/ _jsx(YAxisRangeOption, {
                axis: "y1"
            }),
        axis: 'y1'
    },
...
*/ export default function TimeSeriesViewerAxes() {
    ...
    const renderOption = (key)=>{
        const { title, description: rawDescription, Component, axis } = OPTIONS[key];
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsx("div", {
                                ...
                                children: renderOption('Y_AXIS_SCALE')
                            }),
                            /*#__PURE__*/ _jsxs("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ _jsx("div", {
                                        ...
                                        children: renderOption('Y1_AXIS_RANGE')
                                    }),
            ...
            /*#__PURE__*/ _jsxs("div", {
                children: [
                    /*#__PURE__*/ _jsx(Typography, {
                        ...
                        children: "x Axis (Time)"
                    }),
                    /*#__PURE__*/ _jsxs("div", {
                        className: classes.optionsContainer,
                        children: [
                            state.timeStep.availableTimeSteps.size < 3 ? null : /*#__PURE__*/ _jsx("div", {
                                style: {
                                    marginRight: Theme.spacing(4)
                                },
                                children: renderOption('TIME_STEP')
                            }),
