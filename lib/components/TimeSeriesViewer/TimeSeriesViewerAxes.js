...
var YAxisScaleOption = function YAxisScaleOption() {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_ToggleButtonGroup.default, {
    exclusive: true,
    color: "primary",
    variant: "outlined",
    size: "small",
...
var YAxisRangeOption = function YAxisRangeOption(props) {
  ...
  var precision = Math.abs(Math.floor(Math.min(Math.log10(rangeMax), 0))) + (Math.log10(rangeMax) >= 2 ? 0 : 2);
  ...
  var applySliderValues = (0, _react.useCallback)(function (values) {
    ...
    var limited = [Math.max(values[0], rangeMin), Math.min(values[1], rangeMax)].map(function (r) {
      return parseFloat(r.toFixed(precision), 10);
    ...
    yAxisRangeSliderRef.current.querySelector('input[type="hidden"]').setAttribute('value', limited.join(',')); // Apply values to slider drag handles

    [0, 1].forEach(function (idx) {
      yAxisRangeSliderRef.current.querySelector("span[role=\"slider\"][data-index=\"".concat(idx, "\"]")).setAttribute('aria-valuenow', limited[idx].toString());
      yAxisRangeSliderRef.current.querySelector("span[role=\"slider\"][data-index=\"".concat(idx, "\"]")).style.bottom = newBottoms[idx];
      yAxisRangeSliderRef.current.querySelector("span[role=\"slider\"][data-index=\"".concat(idx, "\"] > span > span > span")).innerText = limited[idx];
  ...
  return !render ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, "Auto"), /*#__PURE__*/_react.default.createElement("span", {
    ...
    onClick: function onClick() {
      var range = [Math.max(dataRange[0] - fixedStandardDeviation, 0), dataRange[1] + fixedStandardDeviation].map(function (r) {
        return parseFloat(r.toFixed(precision), 10);
      });
      dispatch({
        type: 'selectYAxisRange',
  ...
  }, "Fit around data by one standard deviation")), /*#__PURE__*/_react.default.createElement(NeonVerticalSlider, {
    disabled: isAuto,
    step: step,
    marks: marks,
...
var RollPeriodOption = function RollPeriodOption() {
  ...
  var applySliderValue = (0, _react.useCallback)(function (value) {
    ...
    rollPeriodSliderRef.current.querySelector('input[type="hidden"]').setAttribute('value', currentValue); // Apply value to slider drag handle
...
function TimeSeriesViewerAxes() {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "h6",
    gutterBottom: true
  }, "y Axes"), /*#__PURE__*/_react.default.createElement(_Grid.default, {
    container: true,
    spacing: 2,
    style: {
    ...
    item: true,
    xs: 12
  }, renderOption('Y_AXIS_SCALE')), /*#__PURE__*/_react.default.createElement(_Grid.default, {
    item: true,
    xs: 12,
    md: hasY2Axis ? 6 : 12
  }, renderOption('Y1_AXIS_RANGE')), !hasY2Axis ? null : /*#__PURE__*/_react.default.createElement(_Grid.default, {
    item: true,
    xs: 12,
    md: 6
  }, renderOption('Y2_AXIS_RANGE'))), /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "h6",
    gutterBottom: true
  }, "x Axis (Time)"), /*#__PURE__*/_react.default.createElement(_Grid.default, {
    container: true,
    spacing: 2
  }, !state.availableTimeSteps.size < 3 ? null : /*#__PURE__*/_react.default.createElement(_Grid.default, {
    item: true,
    xs: 12,
    lg: 4,
    xl: 3
  }, renderOption('TIME_STEP')), /*#__PURE__*/_react.default.createElement(_Grid.default, {
    item: true,
    xs: 12,
    lg: 8,
    xl: 9
