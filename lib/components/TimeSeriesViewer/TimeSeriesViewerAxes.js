  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_ToggleButtonGroup.default, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_ToggleButton.default, {
        ...
        children: "Linear"
      }, "lin"), /*#__PURE__*/(0, _jsxRuntime.jsx)(_ToggleButton.default, {
        value: "log",
        size: "small",
        className: classNames[logscale ? 'selected' : 'deselected'],
        children: "Logarithmic"
      }, "log")]
    }), yAxes.y2.units === null ? null : /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Button.default, {
      color: "primary",
      variant: "outlined",
      onClick: () => {
        dispatch({
...
const YAxisRangeOption = props => {
  ...
  return !render ? /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    className: classes.yAxisRangeOuterContainer,
    children: [!logscale || dataRange[0] >= 0 ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
      variant: "caption",
      ...
      children: Object.keys(_TimeSeriesViewerContext.Y_AXIS_RANGE_MODES).map(key => /*#__PURE__*/(0, _jsxRuntime.jsx)(_ToggleButton.default, {
        value: key,
        size: "small",
        ...
        children: _TimeSeriesViewerContext.Y_AXIS_RANGE_MODE_DETAILS[key].name
      }, key))
    }), /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      className: classes.yAxisRangeInnerContainer,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
...
const RollPeriodOption = () => {
  ...
  return !currentTimeStep ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Skeleton.default, {
    variant: "rectangular",
    width: "100%",
    height: 56
  }) : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
...
const TimeStepOption = () => {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ToggleButtonGroup.default, {
    ...
    children: Array.from(availableTimeSteps).map(timeStep => {
      ...
      const numPoints = _TimeSeriesViewerContext.default.calcPredictedPointsByTimeStep(state, timeStep);
...
const OPTIONS = {
  ...
  Y1_AXIS_RANGE: {
    ...
    Component: () => /*#__PURE__*/(0, _jsxRuntime.jsx)(YAxisRangeOption, {
      axis: "y1"
    }),
    axis: 'y1'
  },
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
        ...
        className: classes.optionsContainer,
        children: [state.timeStep.availableTimeSteps.size < 3 ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          style: {
            marginRight: _Theme.default.spacing(4)
          },
