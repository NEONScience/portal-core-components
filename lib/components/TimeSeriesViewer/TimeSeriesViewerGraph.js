...
/* eslint-disable no-underscore-dangle */ import React, { useRef, useEffect, useReducer, useCallback, useLayoutEffect } from 'react';
...
export default function TimeSeriesViewerGraph() {
    ...
    const { selectionDigest, logscale, qualityFlags, rollPeriod, yAxes } = state.selection;
    ...
    const buildAxesOption = (axes = [])=>{
        ...
        axes.forEach((axis)=>{
            ...
            const valueRange = state.selection.logscale ? [
                axisRange[0] <= 0 ? nonZeroFloor : axisRange[0],
                axisRange[1]
            ] : [
                ...axisRange
            ];
    ...
    const legendFormatter = (graphData)=>{
        const { series, qualityData, timestampMap, qualityLabels } = state.graphData;
        // Series
        const seriesLegend = graphData.series.map((s, idx)=>{
            ...
            if (typeof s.y === 'number' && !Number.isNaN(s.y)) {
                ...
                yUnits = s.isHighlighted ? /*#__PURE__*/ _jsx("b", {
                    children: yUnitsStr
                }) : yUnitsStr;
            }
            ...
            const colorStyle = {
                backgroundColor: s.color || Theme.palette.grey[200]
            };
            if (s.isHighlighted) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ _jsx("br", {}),
                            yUnits,
                            !belowSm || !s.isHighlighted ? null : /*#__PURE__*/ _jsxs(_Fragment, {
                                children: [
                                    /*#__PURE__*/ _jsx("br", {}),
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsx("br", {}),
                                qualityFlags.map((qf, qfIdx)=>qfData === null || !qfData[qlIdx] ? /*#__PURE__*/ _jsx("div", {
                                        children: qf
                                    }, qf) : /*#__PURE__*/ _jsx("div", {
                                        style: isHighlighted ? {
                                            fontWeight: 600
                                        } : {},
        ...
        if (graphData.x && !belowSm) {
            dateLegend = /*#__PURE__*/ _jsx(Card, {
                variant: "outlined",
                className: classes.legendSeriesX,
                children: moment.utc(graphData.x).format('YYYY-MM-DD HH:mm:ss')
            });
        }
        // Render
        return ReactDOMServer.renderToString(/*#__PURE__*/ _jsxs(_Fragment, {
            children: [
                seriesLegend,
                qualityFlagsLegend,
                dateLegend
    ...
    useEffect(()=>{
        if (state.status !== TIME_SERIES_VIEWER_STATUS.READY_FOR_SERIES) {
            return;
        }
    ...
    /* eslint-disable react-hooks/refs */ if (state.status === TIME_SERIES_VIEWER_STATUS.READY) {
    ...
    /* eslint-enable react-hooks/refs */ // Callback to refresh graph dimensions for current DOM
    ...
    const buildGraphTitle = ()=>{
        const releaseTitle = isStringNonEmpty(state.release) ? `, ${state.release} ` : '';
    ...
    const renderCitation = ()=>{
        ...
        return /*#__PURE__*/ _jsx(DataProductCitation, {
    ...
    /* eslint-disable react-hooks/refs */ const downloadImageButton = /*#__PURE__*/ _jsx(Button, {
        size: "small",
        color: "primary",
        variant: "outlined",
        ...
        startIcon: /*#__PURE__*/ _jsx(ImageIcon, {}),
        children: "Download Image (png)"
    });
    /* eslint-enable react-hooks/refs */ // Toggle Series Visibility Button
    const { series } = state.graphData;
    ...
    const toggleSeriesVisibilityButton = /*#__PURE__*/ _jsx(Button, {
        size: "small",
        color: "primary",
        variant: "outlined",
        ...
        startIcon: graphState.hiddenSeries.size ? /*#__PURE__*/ _jsx(ShowIcon, {}) : /*#__PURE__*/ _jsx(HideIcon, {}),
    ...
    const toggleQualityFlagsVisibilityButton = /*#__PURE__*/ _jsx(Button, {
        size: "small",
        color: "primary",
        variant: "outlined",
        ...
        startIcon: graphState.hiddenQualityFlags.size ? /*#__PURE__*/ _jsx(ShowIcon, {}) : /*#__PURE__*/ _jsx(HideIcon, {}),
