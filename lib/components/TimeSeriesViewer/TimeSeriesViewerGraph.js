...
function TimeSeriesViewerGraph() {
  ...
  var buildGraphTitle = function buildGraphTitle() {
    ...
    return state.product.productName ? "".concat(state.product.productName).concat(releaseTitle, " (").concat(state.product.productCode, ")") : "".concat(state.product.productCode).concat(releaseTitle);
  };
