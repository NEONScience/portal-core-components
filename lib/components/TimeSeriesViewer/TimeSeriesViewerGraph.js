...
function TimeSeriesViewerGraph() {
    ...
    if (qualityFlags.length) {
      ...
      qualityFlagsLegend = qualityLabels.slice(2).map((qualityLabel, qlIdx) => {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          className: classes.legendSeriesLabel
        }, `${qualityLabel} - Quality Flags`, /*#__PURE__*/_react.default.createElement("br", null), qualityFlags.map((qf, qfIdx) => qfData === null || !qfData[qlIdx] ? /*#__PURE__*/_react.default.createElement("div", {
          key: qf
  ...
  }, graphState.hiddenSeries.size ? `${belowSm ? '' : 'Show All'} Series` : `${belowSm ? '' : 'Hide All'} Series`);
  ...
  }, graphState.hiddenQualityFlags.size ? `${belowSm ? '' : 'Show All'} Quality Flags` : `${belowSm ? '' : 'Hide All'} Quality Flags`);
