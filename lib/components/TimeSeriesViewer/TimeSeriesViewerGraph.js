...
function TimeSeriesViewerGraph() {
  ...
  const belowSm = (0, _useMediaQuery.default)(_Theme.default.breakpoints.down('md'));
  const {
    selectionDigest,
    logscale,
    qualityFlags,
  ...
  let graphOptions = (0, _cloneDeep.default)(getBaseGraphOptions());
  ...
  const legendFormatter = graphData => {
    ...
    const seriesLegend = graphData.series.map((s, idx) => {
      ...
      if (typeof s.y === 'number' && !Number.isNaN(s.y)) {
        ...
        yUnits = s.isHighlighted ? /*#__PURE__*/(0, _jsxRuntime.jsx)("b", {
          children: yUnitsStr
        }) : yUnitsStr;
      }
      const className = s.isHighlighted ? `${classes.legendSeries} ${classes.legendSeriesActive}` : classes.legendSeries;
      const seriesStyle = {};
      if (isHidden) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Card.default, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          ...
          children: [s.label, /*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), yUnits, !belowSm || !s.isHighlighted ? null : /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), _moment.default.utc(graphData.x).format('YYYY-MM-DD HH:mm:ss')]
          })]
        })]
      }, s.label);
    });
      ...
      qualityFlagsLegend = qualityLabels.slice(2).map((qualityLabel, qlIdx) => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
            ...
            className: classes.legendSeriesLabel,
            children: [`${qualityLabel} - Quality Flags`, /*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), qualityFlags.map((qf, qfIdx) => qfData === null || !qfData[qlIdx] ? /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
              children: qf
            }, qf) : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
              style: isHighlighted ? {
                fontWeight: 600
              } : {},
              children: `${qfData[qlIdx][qfIdx]} - ${qf}`
            }, qf))]
          })]
        }, qualityLabel);
      });
    ...
    if (graphData.x && !belowSm) {
      dateLegend = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Card.default, {
        variant: "outlined",
        className: classes.legendSeriesX,
        children: _moment.default.utc(graphData.x).format('YYYY-MM-DD HH:mm:ss')
      });
    }
    // Render
    return _server.default.renderToString( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [seriesLegend, qualityFlagsLegend, dateLegend]
    }));
  };
  ...
  if (state.status === _constants.TIME_SERIES_VIEWER_STATUS.READY) {
    ...
    graphOptions = {
      ...(0, _cloneDeep.default)(getBaseGraphOptions()),
      labels,
  ...
  const buildGraphTitle = () => {
    const releaseTitle = (0, _typeUtil.isStringNonEmpty)(state.release) ? `, ${state.release} ` : '';
    return state.product.productName ? `${state.product.productName} (${state.product.productCode})${releaseTitle}` : `${state.product.productCode}${releaseTitle}`;
  };
  const renderCitation = () => {
    if (!state.product || !state.product.productCode) {
      return null;
    }
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_DataProductCitation.default, {
  ...
  const getPngDimensions = () => `${graphState.pngDimensions[0] || '?'}px x ${graphState.pngDimensions[1] || '?'}px`;
  const downloadImageButton = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
    ...
    startIcon: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Image.default, {}),
  ...
  const toggleSeriesVisibilityButton = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
    ...
    startIcon: graphState.hiddenSeries.size ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Visibility.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_VisibilityOff.default, {}),
    children: graphState.hiddenSeries.size ? `${belowSm ? '' : 'Show All'} Series` : `${belowSm ? '' : 'Hide All'} Series`
  });
  ...
  const toggleQualityFlagsVisibilityButton = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
    ...
    startIcon: graphState.hiddenQualityFlags.size ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Visibility.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_VisibilityOff.default, {}),
    children: graphState.hiddenQualityFlags.size ? `${belowSm ? '' : 'Show All'} Quality Flags` : `${belowSm ? '' : 'Hide All'} Quality Flags`
  });
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          ...
          children: downloadImageButton
        }), /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          style: {
            marginTop: _Theme.default.spacing(1.5),
            textAlign: 'right'
          },
          children: [toggleQualityFlagsVisibilityButton, toggleSeriesVisibilityButton]
        })]
      })
    })]
  });
