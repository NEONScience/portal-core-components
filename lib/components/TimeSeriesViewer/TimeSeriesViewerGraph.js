...
function TimeSeriesViewerGraph() {
      ...
      positions.forEach(function (position) {
        ...
        continuousDateRange.forEach(function (month) {
          ...
          variables.forEach(function (variable) {
            ...
            var seriesStepCount = posData[month][pkg][timeStep].series[variable].length;
            ...
            if (seriesStepCount !== monthStepCount) {
              ...
              var setSeriesValueByTimestamp = function setSeriesValueByTimestamp(t) {
                ...
                var dataIdx = posData[month][pkg][timeStep].series[dateTimeVariable].findIndex(function (dateTimeVal) {
                  return dateTimeVal === isodate;
                });
                data[t][columnIdx] = dataIdx !== -1 ? posData[month][pkg][timeStep].series[variable][dataIdx] : null;
              };
            ...
            posData[month][pkg][timeStep].series[variable].forEach(function (d, datumIdx) {
          ...
          qualityFlags.forEach(function (qf, qfIdx) {
            ...
            var seriesStepCount = posData[month][pkg][timeStep].series[qf].length;
            ...
            if (seriesStepCount !== monthStepCount) {
              ...
              var setQualityValueByTimestamp = function setQualityValueByTimestamp(t) {
                ...
                var d = posData[month][pkg][timeStep].series[qf][dataIdx];
            ...
            posData[month][pkg][timeStep].series[qf].forEach(function (d, datumIdx) {
    ...
    if (qualityFlags.length) {
      ...
      qualityFlagsLegend = qualityLabels.slice(2).map(function (qualityLabel, qlIdx) {
        ...
        return _react.default.createElement("div", {
          ...
          className: classes.legendSeriesLabel
        }, "".concat(qualityLabel, " - Quality Flags"), _react.default.createElement("br", null), qualityFlags.map(function (qf, qfIdx) {
          return qfData === null || !qfData[qlIdx] ? _react.default.createElement("div", {
            key: qf
          }, qf) : _react.default.createElement("div", {
            key: qf,
            style: isHighlighted ? {
              fontWeight: 600
            } : {}
  ...
  }, [dygraphRef, legendRef, graphInnerContainerRef]); // Layout effect to keep the graph dimensions in-line with resize events
  ...
  var downloadImageButton = _react.default.createElement(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
  ...
  var toggleSeriesVisibilityButton = _react.default.createElement(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
  ...
  }, graphState.hiddenSeries.size ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Visibility.default, {
    className: classes.buttonIcon
  }), "".concat(belowMd ? '' : 'Show All', " Series")) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_VisibilityOff.default, {
    className: classes.buttonIcon
  }), "".concat(belowMd ? '' : 'Hide All', " Series"))); // Toggle Quality Flag Visibility Button
  ...
  var toggleQualityFlagsVisibilityButton = _react.default.createElement(_Button.default, {
    size: "small",
    color: "primary",
    variant: "outlined",
  ...
  }, graphState.hiddenQualityFlags.size ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Visibility.default, {
    className: classes.buttonIcon
  }), "".concat(belowMd ? '' : 'Show All', " Quality Flags")) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_VisibilityOff.default, {
    className: classes.buttonIcon
  }), "".concat(belowMd ? '' : 'Hide All', " Quality Flags")));
  /**
     RENDER
  */
  ...
  }, "National Ecological Observatory Network. ", new Date().getFullYear(), ". Data Product: ", state.product.productCode, ", ", state.product.productName, ". Battelle, Boulder, CO, USA NEON."))), _react.default.createElement("div", {
  ...
  }, downloadImageButton), _react.default.createElement("div", {
    style: {
      marginTop: _Theme.default.spacing(1.5),
      textAlign: 'right'
    }
