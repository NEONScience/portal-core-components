...
function Option(props) {
  ...
  }, `(${units})`)), /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "body2",
    className: classes.optionSubtitle,
    style: {
      ...textStyle
...
const QualityFlags = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, availableQualityFlags.size > 1 ? /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, `Select All (${availableQualityFlags.size})`)) : null, /*#__PURE__*/_react.default.createElement(_FormGroup.default, null, downloadPkgs.map(downloadPkg => /*#__PURE__*/_react.default.createElement("div", {
    key: downloadPkg
  }, /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "subtitle2"
    ...
    variant: "body2",
    className: classes.noneLabel
  }, `No ${downloadPkg} quality flags available`) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, organizedQualityFlags[downloadPkg].map(qf => {
