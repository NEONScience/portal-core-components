...
function Control(props) {
  ...
  const labelText = _TimeSeriesViewerContext.default.calcPredictedPointsForNewVariable(state) > _TimeSeriesViewerContext.POINTS_PERFORMANCE_LIMIT ? 'Add Variables (disabled)' : 'Add Variables';
