...
var QualityFlags = function QualityFlags() {
  ...
  return _react.default.createElement(_react.default.Fragment, null, availableQualityFlags.size > 1 ? _react.default.createElement("div", {
  ...
  }), "Select None"), _react.default.createElement(_Button.default, {
    color: "primary",
    variant: "outlined",
    onClick: function onClick() {
      dispatch({
    ...
    className: classes.smallButtonIcon
  }), "Select All (".concat(availableQualityFlags.size, ")"))) : null, _react.default.createElement(_FormGroup.default, null, downloadPkgs.map(function (downloadPkg) {
    return _react.default.createElement("div", {
      key: downloadPkg
    }, _react.default.createElement(_Typography.default, {
      variant: "subtitle2"
    }, ucWord(downloadPkg)), !organizedQualityFlags[downloadPkg].length ? _react.default.createElement(_Typography.default, {
      variant: "body2",
      className: classes.noneLabel
    }, "No ".concat(downloadPkg, " quality flags available")) : _react.default.createElement(_react.default.Fragment, null, organizedQualityFlags[downloadPkg].map(function (qf) {
...
function TimeSeriesViewerVariables() {
  ...
  }, "Quality Flags"), _react.default.createElement(_Typography.default, {
    variant: "caption",
    style: {
      color: _Theme.default.palette.grey[400]
    }
  }, "Enabling one or more quality flags will highlight regions on the chart to illustrate the results of data quality tests."), _react.default.createElement("div", {
    style: {
      width: '100%',
      marginTop: _Theme.default.spacing(1)
    }
  }, _react.default.createElement(QualityFlags, null))));
}