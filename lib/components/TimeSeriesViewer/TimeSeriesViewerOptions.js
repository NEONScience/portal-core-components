...
var RollPeriodOption = function RollPeriodOption() {
  ...
  var _selection$options = selection.options,
      ...
      selectedTimeStep = _selection$options.timeStep,
      autoTimeStep = _selection$options.autoTimeStep;
...
var TimeStepOption = function TimeStepOption() {
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_ToggleButtonGroup.default, {
    exclusive: true,
    color: "primary",
    variant: "outlined",
    size: "small",
