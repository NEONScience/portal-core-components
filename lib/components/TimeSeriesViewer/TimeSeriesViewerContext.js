...
exports.getTestableItems = exports.default = exports.summarizeTimeSteps = exports.TIME_STEPS = exports.DEFAULT_STATE = exports.TabComponentPropTypes = exports.Y_AXIS_RANGE_MODE_DETAILS = exports.Y_AXIS_RANGE_MODES = exports.TIME_SERIES_VIEWER_STATUS_TITLES = exports.TIME_SERIES_VIEWER_STATUS = void 0;
...
var applyDefaultsToSelection = function applyDefaultsToSelection(state) {
  ...
  if (status === TIME_SERIES_VIEWER_STATUS.READY_FOR_SERIES && selection.isDefault && selection.variables.length && selection.yAxes.y1.dataRange.every(function (x) {
    return x === null;
  })) {
...
var Provider = function Provider(props) {
  ...
  */
  ...
  var stateStorage = (0, _StateStorageService.default)("timeSeriesContextState-".concat(productCode, "-").concat(timeSeriesUniqueId));
