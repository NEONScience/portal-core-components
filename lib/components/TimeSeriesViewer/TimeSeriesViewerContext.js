...
exports.default = exports.TIME_STEPS = exports.TIME_SERIES_VIEWER_STATUS = void 0;
  ...
  switch (action.type) {
    ...
    case 'fetchSiteMonthSucceeded':
      ...
      if (state.selection.options.autoTimeStep === null && newState.availableTimeSteps.size > 1) {
        newState.selection.options.autoTimeStep = Array.from(newState.availableTimeSteps).reduce(function (acc, cur) {
          if (cur === 'auto') {
            return acc;
          }
    ...
    case 'selectToggleQualityFlag':
      if (action.selected && !state.selection.options.qualityFlags.includes(action.qualityFlag)) {
        ...
        newState.selection.options.qualityFlags = newState.selection.options.qualityFlags.filter(function (v) {
...
var Provider = function Provider(props) {
  ...
  */
  ...
  var initialState = _extends({}, DEFAULT_STATE, {
    status: productDataProp ? TIME_SERIES_VIEWER_STATUS.LOADING_META : TIME_SERIES_VIEWER_STATUS.INIT_PRODUCT
  });
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    ...
    var _state$selection$opti = state.selection.options,
        selectedTimeStep = _state$selection$opti.timeStep,
        autoTimeStep = _state$selection$opti.autoTimeStep;
