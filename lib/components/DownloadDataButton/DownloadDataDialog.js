...
function DownloadDataDialog() {
  ...
  */
  ...
  var _DownloadDataContext$ = _DownloadDataContext2.default.useDownloadDataState(),
      ...
      fromExternalHost = _DownloadDataContext$3.fromExternalHost,
  ...
  */
  ...
  var _useState3 = (0, _react.useState)(false),
      ...
      externalLinksExpanded = _useState4[0],
      setExternalLinksExpanded = _useState4[1];
  ...
  */
  ...
  var handleDownload = function handleDownload() {
    if (fromAOPManifest) {
      return (0, _manifestUtil.downloadAopManifest)({
        productCode: productData.productCode,
        sites: sites.value,
        dateRange: dateRange.value,
        s3Files: s3Files.value.map(function (id) {
          return s3Files.urlsById[id];
        }),
  ...
  */
  var renderSizeEstimate = function renderSizeEstimate() {
    ...
    if (fromManifest && manifest.status === 'fetched' || fromAOPManifest && s3Files.isValid) {
      var bytes = (fromAOPManifest ? s3Files.totalSize : manifest.sizeEstimate) || 0;
  ...
  // This entire dialog component is launched but the Download Data Button.
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          fromManifest || fromAOPManifest ? 'Cancel' : 'Done'
        ),
        fromManifest || fromAOPManifest ? renderDownloadButton() : null
      ),
      (fromManifest || fromAOPManifest) && !allStepsComplete ? _react2.default.createElement(
        _Typography2.default,
  ...
  var renderExternalLinks = function renderExternalLinks() {
    if (!fromExternalHost) {
      return null;
    }
    var externalHost = _ExternalHost2.default.getByProductCode(productData.productCode);
    if (!externalHost || !externalHost.getProductLinks) {
      return null;
    }
    var externalGeneralLink = externalHost.renderLink();
    var externalProductLinks = externalHost.getProductLinks(productData.productCode);
    if (!externalProductLinks.length) {
      return null;
    }
    var expandTitle = (externalLinksExpanded ? 'hide' : 'show') + ' external links to additional product data';
    return _react2.default.createElement(
      'div',
      { 'data-selenium': 'download-data-dialog.external-links' },
        ...
        message: _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              'Additional data associated with this this product is available from an external host.'
            ),
            _react2.default.createElement(
              _IconButton2.default,
              {
                ...
                onClick: function onClick() {
                  return setExternalLinksExpanded(!externalLinksExpanded);
                }
              },
              externalLinksExpanded ? _react2.default.createElement(_ExpandLess2.default, null) : _react2.default.createElement(_ExpandMore2.default, null)
            )
          ),
          _react2.default.createElement(
            'div',
            { style: { width: '100%', display: externalLinksExpanded ? 'block' : 'none' } },
            _react2.default.createElement(_Divider2.default, { style: { margin: _Theme2.default.spacing(1.5, 0) } }),
            _react2.default.createElement(
              _Typography2.default,
              { variant: 'body2' },
              'Please use the links below to access associated data from the ',
              externalGeneralLink,
              '.'
            ),
            _react2.default.createElement(
              'ul',
              { className: classes.ulLinkList, style: { marginTop: _Theme2.default.spacing(2) } },
              externalProductLinks.map(function (link) {
                return _react2.default.createElement(
                  'li',
                  { key: link.key },
                  link.node
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_MobileStepper2.default, {
          ...
          backButton: _react2.default.createElement(
            _Button2.default,
            { size: 'small', onClick: handleBack, disabled: activeStepIndex === 0 },
          ...
          nextButton: _react2.default.createElement(
            _Button2.default,
            { size: 'small', onClick: handleNext, disabled: activeStepIndex === maxSteps - 1 },
            'Next',
