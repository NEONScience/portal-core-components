...
const LiferayNotifications = props => {
  ...
  const renderNotificationContent = () => /*#__PURE__*/_react.default.createElement("div", {
    ...
    if (notification.isReactNode === true) {
      ...
      }, notification.message), /*#__PURE__*/_react.default.createElement(_Divider.default, null));
    }
    return /*#__PURE__*/_react.default.createElement("div", {
      key: notification.id
    }, /*#__PURE__*/_react.default.createElement("div", {
...
LiferayNotifications.propTypes = {
  notifications: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    message: _propTypes.default.oneOfType([_propTypes.default.node, _propTypes.default.string]).isRequired,
