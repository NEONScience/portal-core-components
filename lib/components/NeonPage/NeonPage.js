...
var useStyles = (0, _styles.makeStyles)(function () {
  var _outerPageContainer, _pageContent, _sidebarContainer, _sidebarTitle, _sidebarSubtitle, _sidebarDivider;
  ...
  return {
    ...
    }, _defineProperty(_outerPageContainer, _Theme.default.breakpoints.up('md'), {
      display: 'table',
      tableLayout: 'fixed'
    }), _defineProperty(_outerPageContainer, _Theme.default.breakpoints.down('sm'), {
    ...
    backdropPaper: _defineProperty({
      ...
      textAlign: 'center',
      borderRadius: '4px',
      padding: _Theme.default.spacing(3, 3, 4, 3),
      position: 'sticky',
...
var NeonErrorPage = function NeonErrorPage(props) {
  ...
  var classes = useStyles(); // eslint-disable-next-line no-console
...
var NeonPage = function NeonPage(props) {
  ...
  */
  ...
  var _useState7 = (0, _react.useState)(_NeonContext.FETCH_STATUS.AWAITING_CALL),
      _useState8 = _slicedToArray(_useState7, 2),
      drupalCssStatus = _useState8[0],
      setDrupalCssStatus = _useState8[1];

  (0, _react.useEffect)(function () {
    if (useCoreHeader || drupalCssStatus !== _NeonContext.FETCH_STATUS.AWAITING_CALL) {
      return;
    }
  ...
  */
  ...
  var renderedPage = neonContextIsActive ? renderNeonPage() : /*#__PURE__*/_react.default.createElement(_NeonContext.default.Provider, {
    useCoreAuth: true,
    useCoreHeader: useCoreHeader
  }, renderNeonPage());
