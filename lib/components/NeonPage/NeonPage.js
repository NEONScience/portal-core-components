...
var NeonPage = function NeonPage(props) {
  ...
  */
  ...
  var sidebarLinksAsStandaloneChildren = sidebarLinksAsStandaloneChildrenProp ? sidebarLinks.every(function (link) {
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    var handleScroll = function handleScroll() {
      ...
      var currentScrolledHash = isAtMaxScroll() ? scrollBreaks[scrollBreaks.length - 1].hash : scrollBreaks.reduce(function (acc, curr) {
        return curr.y !== -1 && window.scrollY >= curr.y ? curr.hash : acc;
      }, '#');
  ...
  */
  ...
  var renderSidebarLinks = function renderSidebarLinks() {
    ...
    var sideBarTitle = !sidebarTitle && !title ? null : /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "h5",
      component: "h3",
      style: {
        fontWeight: 700
