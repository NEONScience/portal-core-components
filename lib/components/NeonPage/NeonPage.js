...
const NeonPage = (inProps)=>{
  ...
  */ useLayoutEffect(()=>{
        ...
        if (!sidebarUnsticky && hasSidebarLinks && sidebarLinksContainerRef.current && !sidebarDisableMaxHeight) {
    ...
    const renderNeonPage = ()=>{
        ...
        return /*#__PURE__*/ _jsxs(_Fragment, {
            children: [
                ...
                /*#__PURE__*/ _jsx(NotificationsManager, {
