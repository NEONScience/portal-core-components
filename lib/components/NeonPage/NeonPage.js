...
var NeonPage = function NeonPage(props) {
  ...
  var _useState = (0, _react.useState)(false),
      ...
      setOverlayDismissed = _useState2[1]; // Boolean - whether any Drupal assets are used; only false if both header and footer are custom
  ...
  */
  ...
  var _useState13 = (0, _react.useState)(initialNotifications),
      ...
      setNotifications = _useState14[1]; // Handle a successful response from the notifications endpoint
