...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  ...
  return {
    ...
    }, _defineProperty(_sidebarContainer, theme.breakpoints.up('md'), {
      height: '100%',
      position: 'absolute'
...
var NeonPage = function NeonPage(props) {
  var breadcrumbs = props.breadcrumbs,
      ...
      sidebarContentClassName = props.sidebarContentClassName,
  ...
  */
  ...
  var renderSidebar = function renderSidebar() {
    ...
    if (hasSidebarContent) {
      var sidebarClassName = sidebarContentClassName ? "".concat(classes.sidebarContainer, " ").concat(sidebarContentClassName) : classes.sidebarContainer;
    ...
    var sideBarTitle = !sidebarTitle && !title ? null : /*#__PURE__*/_react.default.createElement("div", {
      style: {
        minWidth: '0px',
        paddingRight: '8px'
      }
    ...
    var fullLinks = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      className: classes.sidebarInnerMostContainer
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: classes.sidebarInnerContainer
    }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  var renderNeonPage = function renderNeonPage() {
    ...
    var pageContainerStyle = !hasSidebar || belowMd ? {} : {
      width: "calc(100% - ".concat(sidebarWidth + 24, "px)"),
      marginLeft: "".concat(sidebarWidth + 24, "px")
    };
...
NeonPage.propTypes = {
  ...
  sidebarContentClassName: _propTypes.default.string,
