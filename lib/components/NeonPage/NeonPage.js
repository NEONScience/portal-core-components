...
var NeonPage = function NeonPage(props) {
  var breadcrumbs = props.breadcrumbs,
      ...
      noNeonContext = props.noNeonContext;
  var useStylesProps = {
  ...
  var renderBreadcrumbs = function renderBreadcrumbs() {
    return !breadcrumbs.length ? null : _react.default.createElement(_Breadcrumbs.default, {
      separator: "\u203A",
      ...
      return idx !== breadcrumbs.length - 1 ? _react.default.createElement(_Link.default, {
        key: (0, _uniq.default)(),
        color: "inherit",
        href: breadcrumb.href
      }, breadcrumb.name) : _react.default.createElement(_Typography.default, {
        key: "{idx}",
        color: "textPrimary"
      }, breadcrumb.name);
    }));
  ...
  var renderLoading = function renderLoading() {
    return !loading || error ? null : renderOverlay(_react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Typography.default, {
      variant: "h6",
      component: "h3",
      gutterBottom: true
    }, loading), progress === null ? _react.default.createElement(_CircularProgress.default, null) : _react.default.createElement(_CircularProgress.default, {
      variant: "static",
      value: progress
    })));
  };
  ...
  var renderError = function renderError() {
    return !error ? null : renderOverlay(_react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Warning.default, {
      fontSize: "large",
      color: "error"
  ...
  var renderNeonPage = function renderNeonPage() {
    return _react.default.createElement(_styles2.ThemeProvider, {
      theme: _Theme.default
    }, _react.default.createElement(_CssBaseline.default, null), _react.default.createElement(_NeonHeader.default, {
    ...
    }, renderBreadcrumbs(), renderTitle(), children), renderLoading(), renderError(), _react.default.createElement(_LiferayNotifications.default, {
      notifications: notifications,
      onHideNotifications: handleHideNotifications
    }), _react.default.createElement(_BrowserWarning.default, null)), _react.default.createElement(_NeonFooter.default, null));
  };

  return noNeonContext ? renderNeonPage() : _react.default.createElement(_NeonContext.default.Provider, null, renderNeonPage());
};
...
NeonPage.propTypes = {
  ...
  noNeonContext: _propTypes.default.bool,
...
var useNeonContextState = _NeonContext.default.useNeonContextState;
