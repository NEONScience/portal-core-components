...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  var _sidebarContainer, _sidebarSubtitle, _sidebarDivider, _pageContainer;
  ...
  return {
    ...
    sidebarContainerShort: _defineProperty({}, theme.breakpoints.up('md'), {
      height: '100%',
      position: 'absolute'
    }),
    sidebarContainerTall: _defineProperty({}, theme.breakpoints.up('md'), {
      position: 'sticky',
      top: '12px',
      marginBottom: '2px'
    }),
    ...
    sidebarInnernmostContainer: _defineProperty({}, theme.breakpoints.down('sm'), {
      overflowY: 'scroll',
      maxHeight: '200px'
    }),
...
var NeonPage = function NeonPage(props) {
  ...
  */
  ...
  var renderSidebar = function renderSidebar() {
    ...
    var sidebarWidthStyle = belowMd ? {} : {
      width: "".concat(sidebarWidth, "px")
    };

    var sidebarStyle = _extends({}, sidebarWidthStyle);

    if (sidebarUnsticky && !belowMd) {
    ...
    var sidebarClassName = "".concat(classes.sidebarContainer, " ").concat(classes.sidebarContainerTall);

    if (!hasSidebarContent) {
      sidebarClassName = "".concat(sidebarClassName, " ").concat(classes.sidebarContainerFlexColumn);
    }

    if (sidebarContainerClassNameProp) {
      sidebarClassName = "".concat(sidebarClassName, " ").concat(sidebarContainerClassNameProp);
    ...
    var tallSidebarBackfill = /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(classes.sidebarContainer, " ").concat(classes.sidebarContainerShort),
      style: sidebarWidthStyle
    }); // Arbitrary Content Sidebar (no automatic skeleton)


    if (hasSidebarContent) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !belowMd ? tallSidebarBackfill : null, /*#__PURE__*/_react.default.createElement("div", {
        ref: sidebarRef,
  ...
  var renderNeonPage = function renderNeonPage() {
    ...
    }, renderSidebar(), /*#__PURE__*/_react.default.createElement(_Container.default, {
