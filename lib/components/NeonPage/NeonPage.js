...
var SIDEBAR_WIDTH = 300; // NOTE: because these are defined outside the ThemeProvider any theme vars will come from
// MUI default, NOT the NeonTheme. Hence why some definitions use COLORS directly.

var useStyles = (0, _styles.makeStyles)(function (theme) {
  var _sidebarLinksContaine, _pageContainer;
  ...
  return {
    ...
    sidebarLinksContainer: (_sidebarLinksContaine = {
      // overflowY: 'scroll',
      backgroundColor: _Theme.COLORS.GREY[50],
      padding: theme.spacing(5, 4)
    }, _defineProperty(_sidebarLinksContaine, theme.breakpoints.up('md'), {
      height: '100%',
      width: "".concat(SIDEBAR_WIDTH, "px"),
      position: 'absolute'
    }), _defineProperty(_sidebarLinksContaine, theme.breakpoints.down('sm'), {
      width: '100%',
      padding: theme.spacing(2.5, 2),
      position: 'sticky',
      top: '0px',
      boxShadow: '0px 1px 3px rgba(0, 0, 0, 0.25), 0px 1px 1px rgba(0, 0, 0, 0.25)'
    }), _defineProperty(_sidebarLinksContaine, theme.breakpoints.down('xs'), {
      padding: theme.spacing(1.5)
    }), _sidebarLinksContaine),
    sidebarLinksInnerContainer: {
      position: 'sticky',
      top: theme.spacing(3)
    },
    sidebarLinksInnernmostContainer: _defineProperty({}, theme.breakpoints.down('sm'), {
      overflowY: 'scroll',
      maxHeight: '200px'
    }),
    ...
    sidebarDivider: _defineProperty({
      margin: '24px 0px'
    }, theme.breakpoints.down('sm'), {
      margin: '16px 0px'
    }),
    ...
    pageContainerWithSidebar: _defineProperty({}, theme.breakpoints.up('md'), {
      width: "calc(100% - ".concat(SIDEBAR_WIDTH + 24, "px)"),
      marginLeft: "".concat(SIDEBAR_WIDTH + 24, "px")
    }),
...
var NeonPage = function NeonPage(props) {
  ...
  */
  ...
  var hasSidebar = Array.isArray(sidebarLinks) && sidebarLinks.length > 0; // sidebarLinksAsStandaloneChildren can only be true if all sidebar links have a defined component

  var sidebarLinksAsStandaloneChildren = hasSidebar && sidebarLinksAsStandaloneChildrenProp ? sidebarLinks.every(function (link) {
    return link.component;
  }) : false;
  var sidebarHashMap = !hasSidebar ? {} : Object.fromEntries(sidebarLinks.map(function (link, idx) {
    return [link.hash || '#', idx];
  }));
  var initialCurrectSidebarHash = hasSidebar ? sidebarLinks[0].hash || '#' : '#';
  ...
  var getSidebarLinkScrollPosition = (0, _react.useCallback)(function (hash) {
    if (!hasSidebar || sidebarLinksAsStandaloneChildren || !contentRef.current) {
      return -1;
    }
  ...
  }, [hasSidebar, sidebarLinksAsStandaloneChildren, belowMd]); // For sidebarLinks pages, on successful load, if hash is present then update the current

  (0, _react.useLayoutEffect)(function () {
    if (error || loading || !hasSidebar) {
      return function () {};
  ...
  }, [error, loading, hasSidebar, sidebarLinks, sidebarHashMap, hashInitialized, setHashInitialized, currentSidebarHash, setCurrentSidebarHash, getSidebarLinkScrollPosition, sidebarLinksAsStandaloneChildren]);
  /**
     Drupal CSS Loading
  */
  ...
  var renderSidebarLinks = function renderSidebarLinks() {
    if (!hasSidebar) {
      return null;
    }
    ...
    var sideBarTitle = !sidebarTitle && !title ? null : /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "h5",
      component: "h3",
      style: {
        fontWeight: 700
    ...
    var fullLinks = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      className: classes.sidebarLinksInnerMostContainer
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: classes.sidebarLinksInnerContainer
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: classes.sidebarTitleContainer
    }, sideBarTitle, !belowMd ? null : /*#__PURE__*/_react.default.createElement(_IconButton.default, {
      size: "small",
  ...
  var renderNeonPage = function renderNeonPage() {
    ...
    var pageContainerClassName = hasSidebar ? "".concat(classes.pageContainer, " ").concat(classes.pageContainerWithSidebar) : classes.pageContainer;
    ...
    }, renderSidebarLinks(), /*#__PURE__*/_react.default.createElement(_Container.default, {
