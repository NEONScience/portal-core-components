...
var useStyles = function useStyles(enableDownloadButton) {
  return (0, _styles.makeStyles)(function (muiTheme) {
    var _listItem;
    ...
    return (0, _styles.createStyles)({
      ...
      }, _defineProperty(_listItem, muiTheme.breakpoints.down('xs'), {
        paddingRight: 'unset'
      }), _defineProperty(_listItem, '& p', {
...
var DocumentListItem = function DocumentListItem(props) {
  ...
  var classes = useStyles(enableDownloadButton === true)(_Theme.default);
  var atXs = (0, _useMediaQuery.default)(_Theme.default.breakpoints.down('xs')); // eslint-disable-next-line max-len
  ...
  var apiPath = _DocumentService.default.isQuickStartGuide(appliedDocument) ? "".concat(_NeonEnvironment.default.getFullApiPath('quickStartGuides'), "/").concat(appliedDocument.name) : "".concat(_NeonEnvironment.default.getFullApiPath('documents'), "/").concat(appliedDocument.name);
  ...
  var renderSecondaryItem = function renderSecondaryItem() {
    var typeAndSize = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderTypes(), !appliedDocument.size ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, spacer, /*#__PURE__*/_react.default.createElement("span", {
    ...
    return atXs ? /*#__PURE__*/_react.default.createElement("span", null, fileNumber, /*#__PURE__*/_react.default.createElement("br", null), typeAndSize) : /*#__PURE__*/_react.default.createElement("span", null, typeAndSize, spacer, fileNumber);
  };
  ...
  var renderAction = function renderAction() {
    ...
    var button = !hasAppliedVariants ? /*#__PURE__*/_react.default.createElement(_Button.default, {
      ...
      onClick: function onClick(option) {
        ...
        if ((0, _typeUtil.exists)(nextSelectedVariant)) {
          ...
          var downloadPath = _DocumentService.default.isQuickStartGuide(coercedDownloadVariant) ? "".concat(_NeonEnvironment.default.getFullApiPath('quickStartGuides'), "/").concat(coercedDownloadVariant.name) : "".concat(_NeonEnvironment.default.getFullApiPath('documents'), "/").concat(coercedDownloadVariant.name);
    ...
    return /*#__PURE__*/_react.default.createElement(_ListItemSecondaryAction.default, null, button);
  };
