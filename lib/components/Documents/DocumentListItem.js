...
var DocumentListItem = function DocumentListItem(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var variantObs = _NeonApi.default.getQuickStartGuideDetailObservable(coercedParsedName.matchedName, coercedParsedName.matchedVersion).pipe((0, _rxjs.map)(function (response) {
