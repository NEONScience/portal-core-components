...
var DocumentViewer = function DocumentViewer(props) {
  ...
  var dataUrl = "".concat(appliedUrlPath, "/").concat(document.name, "?inline=true&t=").concat(Date.now());
  var containerRef = (0, _react.useRef)();
  var objectRef = (0, _react.useRef)();
  ...
  var handleResizeCb = (0, _react.useCallback)(function () {
    ...
    var objectElement = objectRef.current; // Do nothing if either container or viz references fail ot point to a DOM node
    ...
    if (container.offsetParent === null || objectElement.offsetParent === null) {
      return;
    ...
    objectElement.setAttribute('width', "".concat(newWidth));
    objectElement.setAttribute('height', "".concat(calcAutoHeight(newWidth)));
  }, [containerRef, objectRef, viewerWidth, setViewerWidth]);
  (0, _react.useLayoutEffect)(function () {
    var element = objectRef.current;
