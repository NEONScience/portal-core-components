...
const DocumentViewer = inProps => {
  ...
  const iframeRef = (0, _react.useRef)(undefined);
  ...
  if (!isViewerDeviceSupported && isPdfViewerSupported) {
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_PdfDocumentViewer.default, {
      ...props
    });
  }
  const renderObject = () => {
    if (!_DocumentService.default.isViewerSupported(document)) {
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ErrorCard.default, {
