...
var AuthService = {
  ...
  logout: function logout(path, redirectUriPath) {
    ...
    var appliedRedirectUri = (0, _typeUtil.exists)(redirectUriPath) ? "".concat(env.getHost()).concat(redirectUriPath) : "".concat(env.getHost()).concat(env.route.getFullRoute(env.getRouterBaseHomePath()));
