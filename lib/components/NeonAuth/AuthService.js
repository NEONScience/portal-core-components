...
var AuthService = {
  ...
  login: function login(path, redirectUriPath) {
    ...
    var href = "".concat(rootPath, "?").concat(REDIRECT_URI, "=").concat(appliedRedirectUri);
  ...
  logout: function logout(path, redirectUriPath) {
    ...
    var appliedRedirectUri = (0, _typeUtil.exists)(redirectUriPath) ? "".concat(env.getApiHost()).concat(redirectUriPath) : "".concat(env.getApiHost()).concat(env.route.getFullRoute(env.getRouterBaseHomePath()));
    var href = "".concat(rootPath, "?").concat(REDIRECT_URI, "=").concat(appliedRedirectUri);
    window.location.href = href;
  },
