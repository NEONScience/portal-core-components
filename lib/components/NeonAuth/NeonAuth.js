...
var renderAuth = function renderAuth(props, classes, isAuthenticated, showAuthWorking, isAuthWsConnected, dispatch) {
  ...
  var handleLogout = function handleLogout() {
    ...
    var appPath = _NeonEnvironment.default.getRouterBaseHomePath() || '';

    if (_AuthService.LOGOUT_REDIRECT_PATHS.indexOf(appPath) >= 0) {
      appliedLogoutType = NeonAuthType.REDIRECT;
  ...
  switch (displayType) {
    ...
    default:
      ...
      if (showAuthWorking) {
        ...
        }, "Signing in..."), /*#__PURE__*/_react.default.createElement(_CircularProgress.default, {
          size: 20
        }));
