...
const dataLicenseLink = /*#__PURE__*/ _jsx(Link, {
    target: "_blank",
    href: DataLicenseService.getDataLicensePath(),
    "data-gtm": "download-data-dialog.data-license-link",
    children: DataLicenseService.getDataLicenseDisplayName()
});
...
const renderStepSummary = {
    ...
    s3Files: (classes, state)=>{
        ...
        const summary = `${files.length} file${files.length === 1 ? '' : 's'} ` + `(${formatBytes(totalSize)} uncompressed)`;
        return /*#__PURE__*/ _jsx(Typography, {
            variant: "body2",
            className: classes.summaryText,
            children: summary
...
const DownloadStepForm = (inProps)=>{
    ...
    const renderSitesAndDateRangeStep = ()=>/*#__PURE__*/ _jsx(DataProductAvailability, {
    ...
    const renderProvisionalDataStep = ()=>{
        ...
        return /*#__PURE__*/ _jsxs(Grid, {
            ...
            children: [
                !excludeProvisionalData ? null : /*#__PURE__*/ _jsx(Grid, {
                    size: {
                        xs: 12
                    },
                    children: /*#__PURE__*/ _jsx(InfoMessageCard, {
                        title: "Provisional Data",
                        messageContent: /*#__PURE__*/ _jsxs(Typography, {
                            variant: "body1",
                            children: [
                                "Provisional data are currently being excluded from the download package. To make those data available, include those data by selecting the ",
                                /*#__PURE__*/ _jsx("i", {
                                    children: "Include"
                                }),
                                " option."
    ...
    const renderS3FilesStep = ()=>{
        if (downloadStatus !== DownloadDataContext.DOWNLOAD_STATUS.ALLOW_DOWNLOAD) {
            return /*#__PURE__*/ _jsx(Typography, {
                ...
                children: "You must sign in or create and validate an account before proceeding."
            });
        }
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsx(ComponentErrorBoundary, {
                                    ...
                                    children: /*#__PURE__*/ _jsx("div", {
                                        className: `${classes.markdownWrapper} MuiTypography-root`,
        ...
        /* eslint-disable react/jsx-one-expression-per-line */ return /*#__PURE__*/ _jsxs("div", {
            ...
            children: [
                /*#__PURE__*/ _jsxs(Typography, {
                    ...
                    gutterBottom: true,
                    children: [
                        "These data are licensed under ",
                        dataLicenseLink,
                        ". Before downloading NEON data you must agree to the NEON ",
