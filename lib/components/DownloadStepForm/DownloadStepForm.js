...
var dataUsageAndCitationPoliciesLink = _react2.default.createElement(
  _Link2.default,
  {
    target: '_blank',
...
function DownloadStepForm(props) {
  ...
  var renderStepForm = {
    ...
    */
    documentation: function documentation() {
      var neonFaqLink = _react2.default.createElement(
        _Link2.default,
        { target: '_blank', href: 'http://data.neonscience.org/faq' },
        'NEON FAQ'
      );
      var knbLink = _ExternalHost2.default.renderExternalHostLink('https://eml.ecoinformatics.org', 'KNB', 'KNB', state.productData.productCode);
    ...
    */
    s3Files: function s3Files() {
      ...
      var postSizeError = estimatedPostSize >= _manifestUtil.MAX_POST_BODY_SIZE ? _react2.default.createElement(
        _Grid2.default,
        { item: true, xs: 12 },
        _react2.default.createElement(_SnackbarContent2.default, {
          className: classes.infoSnackbar,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'b',
                  null,
                  (0, _manifestUtil.formatBytes)(_manifestUtil.MAX_POST_BODY_SIZE)
                ),
    ...
    */
    summary: function summary() {
      ...
      var downloadAndExploreLink = _react2.default.createElement(
        _Link2.default,
        { target: '_blank', href: 'https://www.neonscience.org/download-explore-neon-data' },
      ...
      var fileNamingConventionsLink = _react2.default.createElement(
        _Link2.default,
        { target: '_blank', href: 'https://data.neonscience.org/file-naming-conventions' },
