...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  return {
    copyButton: {
      ...
      padding: _Theme.default.spacing(0.5, 2),
      backgroundColor: '#fff'
    },
    fileTable: {
      position: 'relative',
...
var dataUsageAndCitationPoliciesLink = _react.default.createElement(_Link.default, {
  target: "_blank",
...
function DownloadStepForm(props) {
  ...
  var renderStepSummary = {
    sitesAndDateRange: function sitesAndDateRange() {
      ...
      return _react.default.createElement(_SiteChip.default, {
        size: "large",
        variant: "default",
        label: siteChipLabel
      });
  ...
  var renderStepForm = {
    ...
    */
    sitesAndDateRange: function sitesAndDateRange() {
      return _react.default.createElement("div", null, _react.default.createElement(_DataProductAvailability.default, {
        ...
        message: _react.default.createElement("div", {
          ...
          style: {
            margin: 0,
            paddingLeft: _Theme.default.spacing(2.5)
          }
        }, _react.default.createElement("li", null, "Drag the grid above to pan across time"), _react.default.createElement("li", null, "Click rows in the grid above to select sites or states"), _react.default.createElement("li", null, "Drag the sides of the selection to adjust the date range")))))
      }));
    },
    ...
    */
    documentation: function documentation() {
      var neonFaqLink = _react.default.createElement(_Link.default, {
        target: "_blank",
      ...
      return _react.default.createElement(_Grid.default, {
        ...
        label: _react.default.createElement("div", {
          ...
          variant: "h6"
        }, "Include"), _react.default.createElement(_Typography.default, {
          variant: "body2"
        ...
        label: _react.default.createElement("div", {
          ...
          variant: "h6"
        }, "Exclude"), _react.default.createElement(_Typography.default, {
          variant: "body2"
    ...
    */
    s3Files: function s3Files() {
      ...
      var postSizeError = estimatedPostSize >= _manifestUtil.MAX_POST_BODY_SIZE ? _react.default.createElement(_Grid.default, {
        item: true,
        xs: 12
      }, _react.default.createElement(_SnackbarContent.default, {
        className: classes.infoSnackbar,
        ...
        message: _react.default.createElement("div", {
          ...
          variant: "body1"
        }, "Too many files requested! Current selection will make an estimated ", _react.default.createElement("b", null, (0, _manifestUtil.formatBytes)(estimatedPostSize)), " request; max size is ", _react.default.createElement("b", null, (0, _manifestUtil.formatBytes)(_manifestUtil.MAX_POST_BODY_SIZE)), ". Please select fewer files in order to proceed.")))
      })) : null;
      var components = {
        ...
        Toolbar: function Toolbar(toolbarProps) {
          return _react.default.createElement(_Grid.default, {
            ...
            disabled: true
          }, "Show Columns:"), _react.default.createElement(_ToggleButton.default, {
            value: "site"
          }, "Site"), _react.default.createElement(_ToggleButton.default, {
            value: "visit"
          }, "Visit"), _react.default.createElement(_ToggleButton.default, {
            value: "date"
          }, "Date"), _react.default.createElement(_ToggleButton.default, {
            value: "name"
          }, "Name"), _react.default.createElement(_ToggleButton.default, {
            value: "type"
          ...
          }), "Select All (", isLoading ? '…' : validValues.length, ")"), _react.default.createElement(_Button.default, {
          ...
          }), "Select None")), _react.default.createElement("div", null, _react.default.createElement(_Button.default, {
          ...
          }), "Select Filtered", noFiltersApplied ? '' : " (".concat(isLoading ? '…' : filteredFileCount, ")")), _react.default.createElement(_Button.default, {
          ...
          }, _react.default.createElement(_DeleteSweep.default, {
            fontSize: "small",
            style: {
              marginRight: _Theme.default.spacing(1)
            }
          }), "Clear Filters"))), _react.default.createElement(_Grid.default, {
            item: true,
            xs: 12,
            md: 6
          }, _react.default.createElement(_materialTable.MTableToolbar, _extends({}, toolbarProps, {
            style: {
        ...
        FilterRow: function FilterRow(filterRowProps) {
          return _react.default.createElement(_materialTable.MTableFilterRow, _extends({}, filterRowProps, {
      ...
      return validValues.length || isLoading ? _react.default.createElement("div", {
      ...
      }, "Loading files (".concat(Math.floor(s3FileFetchProgress || 0), "%)...")), _react.default.createElement(_CircularProgress.default, {
        variant: "static",
    ...
    packageType: function packageType() {
      ...
      return _react.default.createElement(_FormControl.default, {
        ...
        label: _react.default.createElement("div", {
          ...
          variant: "h6"
        }, "Basic"), _react.default.createElement(_Typography.default, {
          variant: "body2"
        ...
        label: _react.default.createElement("div", {
          ...
          variant: "h6"
        }, "Expanded"), _react.default.createElement(_Typography.default, {
          variant: "body2"
    ...
    */
    externalExclusive: function externalExclusive() {
      ...
      }), _react.default.createElement(_ExternalHostProductSpecificLinks.default, {
    ...
    */
    policies: function policies() {
      ...
      return _react.default.createElement("div", {
        ...
        variant: "subtitle1",
        gutterBottom: true
      }, "In order to proceed to download NEON data you must agree to the ", dataUsageAndCitationPoliciesLink, "."), _react.default.createElement(_FormControlLabel.default, {
        control: checkbox,
    ...
    */
    summary: function summary() {
      var stepSummary = _react.default.createElement("div", {
        ...
        }, _DownloadDataContext.default.ALL_STEPS[step.key].label)), _react.default.createElement("div", {
          className: classes.stepSummaryContent
        }, isComplete ? renderStepSummary[step.key]() : _react.default.createElement(_Typography.default, {
          variant: "body2",
      ...
      var downloadAndExploreLink = _react.default.createElement(_Link.default, {
        target: "_blank",
      ...
      var downloadAndExploreSnackbar = _react.default.createElement("div", {
      ...
      var fileNamingConventionsLink = _react.default.createElement(_Link.default, {
        target: "_blank",
      ...
      var fileNamingSnackbar = _react.default.createElement("div", {
        "data-selenium": "download-data-dialog.step-form.summary.file-naming"
      }, _react.default.createElement(_SnackbarContent.default, {
        className: classes.infoSnackbar,
        style: {
      ...
      var citationSnackbar = _react.default.createElement("div", {
        ...
        message: _react.default.createElement("div", null, _react.default.createElement("div", {
          className: classes.startFlex
        }, _react.default.createElement(_FormatQuote.default, {
          fontSize: "large",
          className: classes.infoSnackbarIcon
        }), _react.default.createElement(_Typography.default, {
          variant: "subtitle2",
        ...
        }, "Please use this citation in your publications. See ", dataUsageAndCitationPoliciesLink, " for more info."), _react.default.createElement(_reactCopyToClipboard.CopyToClipboard, {
          text: citationText
        }, _react.default.createElement(_Button.default, {
          color: "primary",
          variant: "outlined",
        ...
        }, _react.default.createElement(_Assignment.default, {
          fontSize: "small",
          style: {
            marginRight: _Theme.default.spacing(1)
          }
        }), "Copy"))), _react.default.createElement(_Divider.default, {
          style: {
      ...
      return _react.default.createElement(_Grid.default, {
        ...
        xs: 12,
        md: 6
      }, stepSummary), _react.default.createElement(_Grid.default, {
        item: true,
        xs: 12,
        md: 6
      }, downloadAndExploreSnackbar, fileNamingSnackbar, citationSnackbar));
    }
  };
