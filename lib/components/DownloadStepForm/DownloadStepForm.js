...
var _DataLicenseService = _interopRequireDefault(require("../../service/DataLicenseService"));
...
const dataLicenseLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
  target: "_blank",
  href: _DataLicenseService.default.getDataLicensePath(),
  "data-gtm": "download-data-dialog.data-license-link"
}, _DataLicenseService.default.getDataLicenseDisplayName());
...
const DownloadStepForm = props => {
  ...
  const renderSitesAndDateRangeStep = () => /*#__PURE__*/_react.default.createElement(_DataProductAvailability.default, {
  ...
  const renderProvisionalDataStep = () => {
    ...
    return /*#__PURE__*/_react.default.createElement(_Grid.default, {
    ...
    }, !excludeProvisionalData ? null : /*#__PURE__*/_react.default.createElement(_Grid.default, {
      item: true,
      xs: 12
      ...
      messageContent: /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "body1"
      }, "Provisional data are currently being excluded from the download package. To make those data available, include those data by selecting the ", /*#__PURE__*/_react.default.createElement("i", null, "Include"), " option.")
    })), /*#__PURE__*/_react.default.createElement(_Grid.default, {
      item: true,
      xs: 12,
      md: 6
  ...
  const renderS3FilesStep = () => {
    if (downloadStatus !== _DownloadDataContext.default.DOWNLOAD_STATUS.ALLOW_DOWNLOAD) {
      return /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "subtitle1",
        style: {
  ...
  const renderPoliciesStep = () => {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      variant: "subtitle1",
      gutterBottom: true
    }, "These data are licensed under ", dataLicenseLink, ". Before downloading NEON data you must agree to the NEON ", dataUsageAndCitationPoliciesLink, "."), /*#__PURE__*/_react.default.createElement(_FormControlLabel.default, {
      control: checkbox,
