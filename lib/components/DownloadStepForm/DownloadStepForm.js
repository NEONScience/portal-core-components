...
function DownloadStepForm(props) {
  ...
  var renderStepSummary = {
    ...
    options: function options() {
      ...
      var bundledProducts = state.bundledProducts.value;
      var bundledProductsLabel = 'Exclude the site management and event reporting data product';

      if (Array.isArray(bundledProducts) && bundledProducts.length > 0) {
        var hasProduct = bundledProducts.includes(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE);
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("ul", null, /*#__PURE__*/_react.default.createElement("li", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "body2",
        className: classes.summaryText
      }, "".concat(documentation.charAt(0).toUpperCase()).concat(documentation.substring(1), " Documentation"))), /*#__PURE__*/_react.default.createElement("li", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "body2",
        className: classes.summaryText
  ...
  var renderStepForm = {
    ...
    */
    options: function options() {
      ...
      var siteManagementAndReportingLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
        target: "_blank",
        href: _RouteService.default.getProductDetailPath(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE),
        "data-gtm": "download-data-dialog.neon-faq-link"
      ...
      var bundledProductsValue = state.bundledProducts.value;
      var bundledProductDefaultValue = bundledProductsValue.includes(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE) || false;
      return /*#__PURE__*/_react.default.createElement(_Grid.default, {
        ...
        variant: "h6"
      }, "Do you want to include documentation?")), /*#__PURE__*/_react.default.createElement(_Grid.default, {
        item: true,
        xs: 12,
        md: 6
        ...
        variant: "body1"
      }, "EML files for this Data Product are included in all downloads. Learn more about EML files in the ", neonFaqLink, " and at ", knbLink, ".")))), /*#__PURE__*/_react.default.createElement(_Grid.default, {
        item: true,
        xs: 12
        ...
        variant: "h6"
      }, "Do you want to include the ", siteManagementAndReportingLink, " data product?")), /*#__PURE__*/_react.default.createElement(_Grid.default, {
        item: true,
        xs: 12,
        md: 6
      }, /*#__PURE__*/_react.default.createElement(_FormControl.default, {
        ...
        onChange: function onChange(e) {
          var selectedValue = e.target.value === 'true';

          var nextbundledProductsValue = _toConsumableArray(bundledProductsValue);

          var hasProduct = nextbundledProductsValue.includes(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE);

          if (selectedValue === true) {
            if (!hasProduct) {
              nextbundledProductsValue.push(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE);
            }
          } else if (hasProduct) {
            var idx = nextbundledProductsValue.indexOf(_DownloadDataContext.default.SITE_MANAGEMENT_DATA_PRODUCT_CODE);
        ...
        className: classes.radio // eslint-disable-next-line react/jsx-boolean-value
        ,
        value: true,
        control: /*#__PURE__*/_react.default.createElement(_Radio.default, null),
        label: /*#__PURE__*/_react.default.createElement("div", {
        ...
        variant: "body1"
      }, "For information about disturbances, land management activities, and other incidents that may impact data at NEON sites, include the ", siteManagementAndReportingLink, " data product in the download package.")))));
    },
