...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } /* eslint-disable react/no-unstable-nested-components */
...
var renderStepSummary = {
  sitesAndDateRange: function sitesAndDateRange(classes, state) {
    ...
    var startDateRange = "".concat(getYearMonthMoment(dateRange[0]).format('MMM YYYY'));
    var endDateRange = "".concat(getYearMonthMoment(dateRange[1]).format('MMM YYYY'));
    var humanDateRange = "".concat(startDateRange, " - ").concat(endDateRange);
  ...
  documentation: function documentation(classes, state) {
  ...
  packageType: function packageType(classes, state) {
  ...
  provisionalData: function provisionalData(classes, state) {
    var provisionalData = state.provisionalData.value;
    return /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      className: classes.summaryText
    }, "".concat(provisionalData.charAt(0).toUpperCase()).concat(provisionalData.substring(1)));
  },
  s3Files: function s3Files(classes, state) {
...
var DownloadStepForm = function DownloadStepForm(props) {
  ...
  var delineateAvaRelease = _ReleaseService.default.determineDelineateAvaRelease(release.value);
  ...
  var renderSitesAndDateRangeStep = function renderSitesAndDateRangeStep() {
    var requiredSteps = state.requiredSteps,
      provisionalData = state.provisionalData;
    var hasProvisionalDataStep = requiredSteps.some(function (step) {
      return step.key === 'provisionalData';
    });
    var excludeProvisionalData = hasProvisionalDataStep && provisionalData.value === 'exclude';
  ...
  var renderDocumentationStep = function renderDocumentationStep() {
  ...
  var renderProvisionalDataStep = function renderProvisionalDataStep() {
    var neonDataRevisionReleaseLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_blank",
    ...
    var _state$provisionalDat = state.provisionalData,
      value = _state$provisionalDat.value,
      validValues = _state$provisionalDat.validValues;
    return /*#__PURE__*/_react.default.createElement(_Grid.default, {
      container: true,
      spacing: 2,
      alignItems: "flex-start",
  ...
  var renderS3FilesStep = function renderS3FilesStep() {
    ...
    var _state$s3Files2 = state.s3Files,
      ...
      maxNumFilesSelected = _state$s3Files2.maxNumFilesSelected;
    ...
    var excludeProvisionalData = hasProvisionalDataStep && provisionalData.value === 'exclude';
    var appliedValidValues = validValues;
    var areProvDataExcluded = false;
    if (excludeProvisionalData) {
      appliedValidValues = appliedValidValues.filter(function (value) {
        var includeValue = (0, _typeUtil.isStringNonEmpty)(value.release) && !_ReleaseService.default.isNonRelease(value.release);
        if (!includeValue) {
    ...
    var allowSelectAll = appliedValidValues.length <= maxNumFilesSelected;
    var allowSelectFiltered = filteredFileCount <= maxNumFilesSelected;
    var columns = [{
      title: 'Site',
      field: 'site',
    ...
    /* eslint-disable react/jsx-one-expression-per-line */
    var tooManyFilesWarning = !allowSelectAll && !allowSelectFiltered ? /*#__PURE__*/_react.default.createElement(_Grid.default, {
      item: true,
      xs: 12
    }, /*#__PURE__*/_react.default.createElement(_Card.default, {
      style: {
    ...
    var filterButtonLoadingLabel = " (".concat(isLoading ? '…' : filteredFileCount, ")");
    var filterButtonLabel = noFiltersApplied ? '' : filterButtonLoadingLabel;
    var components = {
      ...
      Toolbar: function Toolbar(toolbarProps) {
        return /*#__PURE__*/_react.default.createElement(_Grid.default, {
          ...
          xs: 12,
          md: 6
        }, /*#__PURE__*/_react.default.createElement(_materialTable.MTableToolbar, toolbarProps)), postSizeError, tooManyFilesWarning);
      },
      FilterRow: function FilterRow(filterRowProps) {
        return /*#__PURE__*/_react.default.createElement(_materialTable.MTableFilterRow, _extends({}, filterRowProps, {
          onFilterChanged: function onFilterChanged(columnId, value) {
            var onFilterChanged = filterRowProps.onFilterChanged;
    ...
    }))) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !excludeProvisionalData || !areProvDataExcluded ? null : /*#__PURE__*/_react.default.createElement(_InfoMessageCard.default, {
      title: "Provisional Data",
      messageContent: /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "body1"
  ...
  var renderPackageTypeStep = function renderPackageTypeStep() {
  ...
  var renderExternalExclusiveStep = function renderExternalExclusiveStep() {
  ...
  var renderPoliciesStep = function renderPoliciesStep() {
  ...
  var renderSummaryStep = function renderSummaryStep() {
  ...
  var renderStepForm = function renderStepForm() {
    switch (stepKey) {
