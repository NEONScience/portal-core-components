...
var externalHosts = {
  AERONET: {
    ...
    getSiteLink: function getSiteLink() {
      ...
      var productCode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'n/a';
      ...
      var text = "".concat(siteCode, " - ").concat(_sites.default[siteCode].description);
  ...
  PHENOCAM: {
    ...
    getSiteLink: function getSiteLink() {
      ...
      var hrefSite = "".concat(_sites.default[siteCode].domainCode, ".").concat(siteCode, ".").concat(productCode.split('.').slice(0, 2).join('.'));
      var text = "".concat(siteCode, " - ").concat(_sites.default[siteCode].description);
