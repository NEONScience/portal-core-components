...
var externalProducts = {
  ...
  'DP1.10107.001': {
    ...
    projects: [{
      id: 'mgp13948',
      title: 'NEON Soil Metagenomes'
    }, {
      id: 'mgp3546',
      title: 'NEON Soils (Prototype Data)'
    }]
  },
  'DP1.10108.001': {
    host: 'MGRAST',
  ...
  'DP1.20126.001': {
    ...
    projects: [{
      id: 'mgp84670',
      title: 'NEON Macroinvertebrate DNA Barcodes - 2017'
    }]
  },
  'DP1.20279.001': {
    host: 'MGRAST',
  ...
  'DP1.20282.001': {
    ...
    projects: [{
      id: 'mgp84669',
      title: 'NEON Surface Water Microbe Marker Gene Sequences - 2014'
    }]
  },
  'DP1.20221.001': {
    host: 'MGRAST',
    projects: [{
      id: 'mgp84672',
      title: 'NEON Zooplankton DNA Barcodes - 2017'
    }]
  },
  'DP4.00002.001': {
    host: 'AMERIFLUX'
...
var renderExternalHostLink = function renderExternalHostLink() {
  ...
  var productCode = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'n/a';
...
var externalHosts = {
  AERONET: {
    ...
    getSiteLink: function getSiteLink() {
      var allSites = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var siteCode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var productCode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'n/a';
      var hrefBase = 'https://aeronet.gsfc.nasa.gov/cgi-bin/data_display_aod_v3?site=';
      ...
      var hrefSite = Object.keys(nonStandardSites).includes(siteCode) ? nonStandardSites[siteCode] : "NEON_".concat(siteCode);
      var description = Object.keys(allSites).length ? " - ".concat(allSites[siteCode].description) : '';
      var text = "".concat(siteCode).concat(description);
  ...
  MGRAST: {
    ...
    getProductLinks: function getProductLinks() {
      ...
      return externalProducts[productCode].projects.map(function (project) {
        return {
          key: project.id,
          node: renderExternalHostLink("https://www.mg-rast.org/mgmain.html?mgpage=project&project=".concat(project.id), project.title, 'MGRAST', productCode)
        };
      });
    }
  },
  ...
  PHENOCAM: {
    ...
    getSiteLink: function getSiteLink() {
      var allSites = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var siteCode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var productCode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
...
Object.keys(externalHosts).forEach(function (hostId) {
  externalHosts[hostId].renderLink = function () {
    var productCode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'n/a';
