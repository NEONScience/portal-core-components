...
const NeonFooter = (inProps)=>{
    ...
    const [{ isActive: neonContextIsActive, fetches: { [DRUPAL_FOOTER_HTML]: footerFetch }, html: { [DRUPAL_FOOTER_HTML]: footerHTML } }] = NeonContext.useNeonContextState();
    ...
    const renderFallback = ()=>/*#__PURE__*/ _jsx("footer", {
            id: "footer",
            className: classes.footerContainer,
            children: HTMLReactParser(DRUPAL_FOOTER_HTML_FALLBACK)
        });
    switch(renderMode){
        case 'loading':
            if (!showSkeleton) {
        ...
        case 'drupal':
            return /*#__PURE__*/ _jsx("footer", {
                id: "footer",
                children: HTMLReactParser(footerHTML)
            });
