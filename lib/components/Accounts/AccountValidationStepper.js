    ...
    getContents: completed => {
      if (!completed) {
        return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
          variant: "body2"
        }, "Sign in or create an account before proceeding"), /*#__PURE__*/_react.default.createElement(_NeonSignInButton.default, null));
      }
...
const AccountValidationStepper = props => {
  ...
  const renderVerticalStepContents = () => {
    ...
    const stepContents = (0, _typeUtil.exists)(VALIDATION_STEPS[activeStep]) ? VALIDATION_STEPS[activeStep].getContents(stepCompleted) : activeStep;
  ...
  const renderValidationSteps = steps => steps.map(step => {
    const stepDisplayLabel = (0, _typeUtil.exists)(VALIDATION_STEPS[step.step]) ? VALIDATION_STEPS[step.step].displayLabel : step.step;
  ...
  const renderValidation = () => {
    ...
    }, "Information on account validation link."), /*#__PURE__*/_react.default.createElement(_Stepper.default, {
      nonLinear: true,
    ...
    }, renderValidationSteps(appliedSteps)), renderHorizontalStepContents());
  };
