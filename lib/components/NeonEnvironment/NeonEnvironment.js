...
const optionalEnvironmentVars = exports.optionalEnvironmentVars = ['REACT_APP_NEON_PATH_LD_API', 'REACT_APP_NEON_PATH_DOWNLOAD_API', 'REACT_APP_NEON_AUTH_DISABLE_WS', 'REACT_APP_NEON_USE_GRAPHQL', 'REACT_APP_NEON_SHOW_AOP_VIEWER', 'REACT_APP_NEON_AOP_GEE_DATA_VIEWER_DESKTOP', 'REACT_APP_NEON_AOP_GEE_DATA_VIEWER_MOBILE', 'REACT_APP_NEON_VISUS_PRODUCTS_BASE_URL', 'REACT_APP_NEON_VISUS_IFRAME_BASE_URL', 'REACT_APP_NEON_API_HOST_OVERRIDE', 'REACT_APP_BIOREPO_HOST_OVERRIDE', 'REACT_APP_NEON_WEB_HOST_OVERRIDE', 'REACT_APP_NEON_WS_HOST_OVERRIDE', 'REACT_APP_NEON_FETCH_DRUPAL_ASSETS'];
const EnvType = {
  DEV: 'development',
  PROD: 'production'
};
const NeonEnvironment = {
  ...
  getAopGEEMobileUrl: () => process.env.REACT_APP_NEON_VISUS_IFRAME_BASE_URL,
