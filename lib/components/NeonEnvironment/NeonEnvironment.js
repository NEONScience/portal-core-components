...
const optionalEnvironmentVars = exports.optionalEnvironmentVars = ['NEXT_PUBLIC_NEON_PATH_LD_API', 'NEXT_PUBLIC_NEON_PATH_DOWNLOAD_API', 'NEXT_PUBLIC_NEON_AUTH_DISABLE_WS', 'NEXT_PUBLIC_NEON_USE_GRAPHQL', 'NEXT_PUBLIC_NEON_SHOW_AOP_VIEWER', 'NEXT_PUBLIC_NEON_VISUS_PRODUCTS_BASE_URL', 'NEXT_PUBLIC_NEON_VISUS_IFRAME_BASE_URL', 'NEXT_PUBLIC_NEON_API_HOST_OVERRIDE', 'NEXT_PUBLIC_BIOREPO_HOST_OVERRIDE', 'NEXT_PUBLIC_NEON_WEB_HOST_OVERRIDE', 'NEXT_PUBLIC_NEON_WS_HOST_OVERRIDE', 'NEXT_PUBLIC_NEON_FETCH_DRUPAL_ASSETS'];
const EnvType = {
  DEV: 'development',
  PROD: 'production'
};
