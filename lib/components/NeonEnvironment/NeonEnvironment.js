...
var requiredEnvironmentVars = exports.requiredEnvironmentVars = ['REACT_APP_NEON_API_NAME', 'REACT_APP_NEON_API_VERSION', 'REACT_APP_NEON_AUTH_LOGIN', 'REACT_APP_NEON_AUTH_LOGOUT', 'REACT_APP_NEON_AUTH_USERINFO', 'REACT_APP_NEON_PATH_MENU_API', 'REACT_APP_NEON_PATH_PUBLIC_GRAPHQL', 'REACT_APP_NEON_ROUTER_BASE', 'REACT_APP_NEON_ROUTER_BASE_HOME', 'REACT_APP_NEON_USE_GRAPHQL'];
...
var NeonEnvironment = {
  ...
  getRootApiPath: function getRootApiPath() {
    return '/' + process.env.REACT_APP_NEON_API_NAME + '/' + process.env.REACT_APP_NEON_API_VERSION;
  },
...
NeonEnvironment.getHost = function () {
  return NeonEnvironment.isDevEnv && NeonEnvironment.getHostOverride() ? NeonEnvironment.getHostOverride() : window.location.protocol + '//' + window.location.host;
};
...
NeonEnvironment.getFullPagePath = function () {
  ...
  var host = NeonEnvironment.getHost();
  return NeonEnvironment.getPagePath[path] ? '' + host + NeonEnvironment.getPagePath[path]() : '' + host;
};
...
exports.default = NeonEnvironment;