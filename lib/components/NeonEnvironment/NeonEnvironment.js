...
var optionalEnvironmentVars = ['REACT_APP_NEON_PATH_LD_API', 'REACT_APP_NEON_PATH_LD_REPO_API', 'REACT_APP_NEON_PATH_AOP_DOWNLOAD_API', 'REACT_APP_NEON_PATH_DATA_API', 'REACT_APP_NEON_PATH_DOCUMENTS_API', 'REACT_APP_NEON_PATH_DOWNLOAD_API', 'REACT_APP_NEON_PATH_MANIFEST_API', 'REACT_APP_NEON_PATH_PRODUCTS_API', 'REACT_APP_NEON_PATH_SITES_API', 'REACT_APP_NEON_PATH_LOCATIONS_API', 'REACT_APP_NEON_PATH_FILE_NAMING_CONVENTIONS', 'REACT_APP_NEON_SHOW_AOP_VIEWER', 'REACT_APP_NEON_VISUS_PRODUCTS_BASE_URL', 'REACT_APP_NEON_VISUS_IFRAME_BASE_URL', 'REACT_APP_NEON_HOST_OVERRIDE', 'REACT_APP_NEON_WS_HOST_OVERRIDE', 'REACT_APP_FOREIGN_LOCATION', 'REACT_APP_NEON_AUTH_DISABLE_WS']; // Temporary paths that shouldn't need to propogate to environment files until made more permanent
...
var NeonEnvironment = {
  ...
  route: {
    ...
    getFullRoute: function getFullRoute(route) {
      return "".concat(NeonEnvironment.getRouterBasePath()).concat(route);
    },
    buildRouteFromHost: function buildRouteFromHost(route) {
      return "".concat(NeonEnvironment.getHost()).concat(NeonEnvironment.getFullRoute(route));
    },
  ...
  getAuthSilentType: function getAuthSilentType() {
    ...
    return _core.AuthSilentType.PREVENT_BROWSER;
  },
