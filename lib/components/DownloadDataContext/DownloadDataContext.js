...
var Provider = function Provider(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (manifestConfigError) {
      ...
      var manifestURL = (0, _manifestUtil.buildManifestRequestUrl)(manifestURLConfig, true);
      var manifestBody = (0, _manifestUtil.buildManifestRequestBody)(manifestURLConfig);
