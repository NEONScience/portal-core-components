...
var getInitialStateFromProps = function getInitialStateFromProps(props) {
  ...
  var allowProvisional = !hasRelease || _ReleaseService.default.isLatestNonProv(release);
...
var Provider = function Provider(props) {
  ...
  manifestRequest$.subscribe(function (request) {
    return getManifestAjaxObservable(request).pipe((0, _rxjs.switchMap)(function (resp) {
      return (0, _rxjs.of)(request.body ? resp.response : resp);
    }), (0, _rxjs.takeUntil)(manifestCancelation$)).subscribe({
  ...
  var handleFetchS3Files = function handleFetchS3Files(currentState) {
    ...
    var observable = (0, _rxUtil.forkJoinWithProgress)(keys.map(function (key) {
      ...
      return _NeonApi.default.getJsonObservable((0, _manifestUtil.buildS3FilesRequestUrl)(productCode, site, yearMonth, release)).pipe((0, _rxjs.map)(function (response) {
        return {
          status: 'fetched',
    ...
    observable.pipe((0, _rxjs.mergeMap)(function (_ref) {
