...
var _signInButtonState = require("../DownloadDataDialog/signInButtonState");
...
var wrappedReducer = function wrappedReducer(state, action) {
  var newState = reducer(state, action); // console.log('ACTION', action, newState);
...
var signInButtonObservable = (0, _signInButtonState.getSignInButtonObservable)();
/**
...
var Provider = function Provider(props) {
  ...
  var initialState = (0, _StatePersistence.readState)() ? (0, _StatePersistence.readState)() : getInitialStateFromProps(props);
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    var subscription = signInButtonObservable.subscribe(function () {
      (0, _StatePersistence.persistState)(state);
