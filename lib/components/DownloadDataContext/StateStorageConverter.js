 ...
 */ const convertStateForStorage = (state)=>{
    if (state.fromAOPManifest) {
        ...
        return {
            ...state,
            s3FileFetches: {
                ...DownloadDataContext.DEFAULT_STATE.s3FileFetches
            },
            s3FileFetchProgress: DownloadDataContext.DEFAULT_STATE.s3FileFetchProgress,
            s3Files: {
                ...DownloadDataContext.DEFAULT_STATE.s3Files
            },
            manifest: {
                ...DownloadDataContext.DEFAULT_STATE.manifest
            },
            allStepsComplete: DownloadDataContext.DEFAULT_STATE.allStepsComplete,
            sites: {
                ...state.sites,
                value: [
                    ...DownloadDataContext.DEFAULT_STATE.sites.value
                ]
            }
        };
    }
