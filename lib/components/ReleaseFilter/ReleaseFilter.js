...
const ReleaseFilter = props => {
  ...
  const selectNode = /*#__PURE__*/_react.default.createElement(_Select.default, {
    ...
    display: "block"
  }, UNSPECIFIED_NAME), /*#__PURE__*/_react.default.createElement(_Typography.default, menuItemSubtitleProps, UNSPECIFIED_DESCRIPTION), !showProductCount || nullReleaseProductCount === null ? null : /*#__PURE__*/_react.default.createElement(_Typography.default, menuItemSubtitleProps, `${nullReleaseProductCount} data products`))), releases.map(entry => {
    const {
      release,
      generationDate
    } = entry;
    ...
    return /*#__PURE__*/_react.default.createElement(_MenuItem.default, {
      ...
      display: "block"
    }, release), !showGenerationDate ? null : /*#__PURE__*/_react.default.createElement(_Typography.default, menuItemSubtitleProps, `Generated: ${formatGenerationDate(generationDate)}`), !showProductCount ? null : /*#__PURE__*/_react.default.createElement(_Typography.default, menuItemSubtitleProps, productCountSubtitle)));
  }));
