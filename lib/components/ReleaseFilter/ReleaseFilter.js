...
var ReleaseFilter = function ReleaseFilter(props) {
  ...
  var excludeNullRelease = props.excludeNullRelease,
      ...
      title = props.title,
      otherProps = _objectWithoutProperties(props, ["excludeNullRelease", "maxWidth", "nullReleaseProductCount", "onChange", "releases", "selected", "showDoi", "showGenerationDate", "showProductCount", "skeleton", "title"]);
  ...
  })), unspecifiedNode, generationDateNode, productCountNode, doiNode);
};
