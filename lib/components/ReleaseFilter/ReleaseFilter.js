...
var _excluded = ["excludeNullRelease", "horizontal", "maxWidth", "nullReleaseProductCount", "onChange", "releases", "selected", "showDoi", "showGenerationDate", "showProductCount", "showReleaseLink", "skeleton", "title"];
...
var ReleaseFilter = function ReleaseFilter(props) {
  ...
  if (showReleaseLink && selectedRelease !== null) {
    var releaseLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      href: _RouteService.default.getReleaseDetailPath(selectedRelease),
      target: "_blank",
