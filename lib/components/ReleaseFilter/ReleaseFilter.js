...
var ReleaseFilter = function ReleaseFilter(props) {
  ...
  if (showReleaseLink && selectedRelease !== null && !_ReleaseService.default.isLatestNonProv(selectedRelease)) {
    var releaseLinkTooltip = 'Click to view general information about all data products in the ' + "".concat(selectedRelease, " release");
