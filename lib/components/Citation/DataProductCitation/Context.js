...
var verifyProductReleaseDoiResponse = function verifyProductReleaseDoiResponse(response) {
  return (0, _typeUtil.exists)(response) && (0, _typeUtil.exists)(response.data) && (0, _typeUtil.exists)(response.data.status);
};
...
var Provider = function Provider(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (_Service.default.fetchIsAwaitingCall(fetches.product)) {
      ...
      var queryProductCode = productCode; // eslint-disable-next-line max-len
      ...
      _NeonGraphQL.default.getGraphqlQuery(buildProductQuery(queryProductCode)).subscribe({
        ...
        error: function error(_error) {
          dispatch(_Actions.default.fetchProductFailed(_error));
        }
      });
    ...
    Object.keys(fetches.productReleases).filter(function (fetchRelease) {
      ...
      var query = buildProductQuery(queryProductCode, fetchRelease); // eslint-disable-next-line max-len
      ...
      _NeonGraphQL.default.getGraphqlQuery(query).subscribe({
        ...
        error: function error(_error2) {
          dispatch(_Actions.default.fetchProductReleaseFailed(fetchRelease, _error2));
        }
      });
    }); // Product release doi fetches

    Object.keys(fetches.productReleaseDois).filter(function (fetchRelease) {
      return _Service.default.fetchIsAwaitingCall(fetches.productReleaseDois[fetchRelease]);
    }).forEach(function (fetchRelease) {
    ...
    Object.keys(fetches.bundleParents).filter(function (bundleParent) {
      ...
      dispatch(_Actions.default.fetchBundleParentStarted(bundleParent)); // eslint-disable-next-line max-len
      ...
      _NeonGraphQL.default.getGraphqlQuery(buildProductQuery(bundleParent)).subscribe({
        ...
        error: function error(_error4) {
          dispatch(_Actions.default.fetchBundleParentFailed(bundleParent, _error4));
        }
      });
    ...
    Object.keys(fetches.bundleParentReleases).forEach(function (bundleParent) {
      Object.keys(fetches.bundleParentReleases[bundleParent]).filter(function (fetchRelease) {
        ...
        var query = buildProductQuery(bundleParent, fetchRelease); // eslint-disable-next-line max-len
        ...
        _NeonGraphQL.default.getGraphqlQuery(query).subscribe({
          ...
          error: function error(_error5) {
            dispatch(_Actions.default.fetchBundleParentReleaseFailed(bundleParent, fetchRelease, _error5));
          }
        });
      });
    });
