...
var StateContext = /*#__PURE__*/(0, _react.createContext)(_State.DEFAULT_STATE);
...
var useDataProductCitationContextState = function useDataProductCitationContextState() {
  ...
  if (!(0, _typeUtil.exists)(state)) {
    state = (0, _cloneDeep.default)(_State.DEFAULT_STATE);
  }
...
var Provider = function Provider(props) {
  ...
  var initialState = _extends({}, (0, _cloneDeep.default)(_State.DEFAULT_STATE), {
  ...
  (0, _react.useEffect)(function () {
    if (status !== _State.CONTEXT_STATUS.INITIALIZING) {
      return;
    }
  ...
  (0, _react.useEffect)(function () {
    ...
    if (status !== _State.CONTEXT_STATUS.READY) {
      return;
    }

    if (productCode !== propsProductCode || release !== propsRelease) {
      dispatch(_Actions.default.reinitialize(propsProductCode, propsRelease));
    }
  ...
  (0, _react.useEffect)(function () {
    ...
    if (status !== _State.CONTEXT_STATUS.HAS_FETCHES_TO_TRIGGER) {
      return;
    } // Base product fetch
    ...
    if (_Service.default.fetchIsAwaitingCall(fetches.product)) {
      ...
      _NeonGraphQL.default.getGraphqlQuery(buildProductQuery(productCode)).subscribe(function (response) {
    ...
    Object.keys(fetches.productReleases).filter(function (fetchRelease) {
      ...
      var query = buildProductQuery(productCode, fetchRelease);
...
var DataProductCitationContext = {
  ...
  DEFAULT_STATE: _State.DEFAULT_STATE
};
