...
var useViewState = function useViewState(state, props) {
  ...
  var hideAppliedReleaseCitation = (0, _typeUtil.exists)(appliedReleaseObject) && appliedReleaseObject.showCitation === false; // Identify whether or not viewing a bundled product with applicable DOI
