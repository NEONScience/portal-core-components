...
var ActionCreator = {
  ...
  fetchProductReleaseDoiStarted: function fetchProductReleaseDoiStarted(release) {
    return {
      type: ActionTypes.FETCH_PRODUCT_RELEASE_DOI_STARTED,
      release: release
    };
  },
  fetchProductReleaseDoiFailed: function fetchProductReleaseDoiFailed(release, error) {
    return {
