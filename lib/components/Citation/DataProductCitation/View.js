...
var DataProductCitationView = function DataProductCitationView(props) {
  ...
  var renderBundleParentsCard = function renderBundleParentsCard() {
    ...
    var titleContent = _BundleContentBuilder.default.buildDefaultSplitTitleContent(isReleaseDisplay, bundleNoteTerminalChar);
    ...
    var subTitleContent = !showManyParents ? undefined : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Use either or both citations as appropriate.");
