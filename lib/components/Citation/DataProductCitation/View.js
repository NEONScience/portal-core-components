...
var DataProductCitationView = function DataProductCitationView(props) {
  ...
  var renderBundleParentsCard = function renderBundleParentsCard() {
    ...
    var bundleParentLink = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "subtitle2"
    }, "This data product has been split and bundled into more than one parent data product:"), /*#__PURE__*/_react.default.createElement("ul", {
      style: {
    ...
    var bundleIcon = showTextOnly ? null : /*#__PURE__*/_react.default.createElement(_Archive.default, {
      fontSize: "medium",
    ...
    }, bundleIcon, /*#__PURE__*/_react.default.createElement("div", {
      style: {
        flexGrow: 1
      }
    }, bundleParentLink, /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      color: "textSecondary",
      className: classes.bundleParentBlurb
    }, "The citations below may refer to these parent products when applicable as this sub-product is not directly citable."))));
  };
