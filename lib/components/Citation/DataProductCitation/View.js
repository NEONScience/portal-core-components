...
var DataProductCitationView = function DataProductCitationView(props) {
  ...
  var hasCitationDownloadStatus = function hasCitationDownloadStatus(provisionalCb, statusCb) {
  ...
  var handleCitationDownloadCb = (0, _react.useCallback)(function (citationProduct, releaseCb, formatCb) {
    ...
    var key = buildCitationDownloadKey(citationProduct, releaseCb, formatCb, provisionalCb);
  ...
  var renderCitationCard = function renderCitationCard(release) {
    ...
    var isSectionDownloading = hasCitationDownloadStatus(provisional, _State.FetchStatus.FETCHING);
    var downloadStatus;

    if (hasCitationDownloadStatus(provisional, _State.FetchStatus.ERROR)) {
      downloadStatus = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Alert.default, {
        severity: "error",
        onClose: function onClose() {
          return handleResetCitationDownloadsCb(provisional);
        }
      }, "Citation download encountered a problem"));
    } else if (hasCitationDownloadStatus(provisional, _State.FetchStatus.SUCCESS)) {
      downloadStatus = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Alert.default, {
        severity: "success",
        onClose: function onClose() {
          return handleResetCitationDownloadsCb(provisional);
    ...
    return /*#__PURE__*/_react.default.createElement(_Card.default, {
      ...
      var key = buildCitationDownloadKey(citationProduct, release, format.shortName, provisional);
