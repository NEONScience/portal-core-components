...
var DataProductCitationView = function DataProductCitationView(props) {
  ...
  var renderBundleParentsCard = function renderBundleParentsCard() {
    ...
    var titleContent = _BundleContentBuilder.default.buildDefaultSplitTitleContent(bundleNoteTerminalChar);
    var detailContent = !showManyParents ? undefined : /*#__PURE__*/_react.default.createElement("ul", {
      style: {
