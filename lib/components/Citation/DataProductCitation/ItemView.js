...
var DataProductCitationItemView = function DataProductCitationItemView(props) {
  ...
  var renderBundleParentLink = function renderBundleParentLink() {
    ...
    if (hasManyParents) {
      var bundleParentLink = (0, _DataProductBundleCard.getParentProductLink)(dataProductLike, appliedRelease);
      subTitleContent = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "The ", isReleaseDisplay ? 'citation below refers ' : 'citations below refer ', "to ", bundleParentLink);
    } else {
      if (isReleaseDisplay) {
        titleContent = (0, _DataProductBundleCard.buildDefaultTitleContent)(dataProductLike, appliedRelease);
      } else {
        titleContent = (0, _DataProductBundleCard.buildDefaultTitleContent)(dataProductLike);
      }
      subTitleContent = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "The ", isReleaseDisplay ? 'citation below refers' : 'citations below refer', " to that data product as this sub-product is not directly citable.");
    }
