...
var DataProductCitationItemView = function DataProductCitationItemView(props) {
  ...
  var renderBundleParentLink = function renderBundleParentLink() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Card.default, {
      ...
      variant: "subtitle2"
    }, "This data product is bundled into ", bundleParentLink), /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      className: classes.bundleParentBlurb
    }, "The ", isReleaseDisplay ? 'citation below refers' : 'citations below refer', " to that data product as this sub-product is not directly citable.")));
  };
