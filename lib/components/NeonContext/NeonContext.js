...
var reducer = function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'fetchSitesSucceeded':
      ...
      newState.isFinal = !newState.auth.useCore || newState.fetches.auth.status === FETCH_STATUS.SUCCESS || newState.fetches.auth.status === FETCH_STATUS.ERROR;
    ...
    case 'fetchAuthSucceeded':
      ...
      newState.isFinal = newState.fetches.sites.status === FETCH_STATUS.SUCCESS || newState.fetches.sites.status === FETCH_STATUS.ERROR;
      return newState;
