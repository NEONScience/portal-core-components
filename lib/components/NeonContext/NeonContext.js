...
var Provider = function Provider(props) {
  ...
  var _useReducer = (0, _react.useReducer)(reducer, initialState),
      ...
      dispatch = _useReducer2[1]; // Method to sanitize partial HTML. As delivered presently there are some markup issues that
  ...
  var fetchPartialHTML = function fetchPartialHTML(part) {
  ...
  var fetchMethods = {
    ...
    header: function header() {
      return fetchPartialHTML('header');
    },
    footer: function footer() {
      return fetchPartialHTML('footer');
    }
