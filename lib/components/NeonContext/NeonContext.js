...
var _DataProductBundleParser = _interopRequireDefault(require("../../parser/DataProductBundleParser"));
...
var Provider = function Provider(props) {
  ...
  var fetchMethods = (_fetchMethods = {
    ...
    bundles: function bundles() {
      _NeonApi.default.getProductBundlesObservable().pipe((0, _operators.map)(function (response) {
        var bundles = _DataProductBundleParser.default.parseBundlesResponse(response);
        ...
        var context = _DataProductBundleParser.default.parseContext(bundles);
