...
var Transition = (0, _react.forwardRef)(function (props, ref) {
  return /*#__PURE__*/_react.default.createElement(_Fade.default, _extends({
    ref: ref
  }, props, {
    timeout: 0
  }));
...
var DialogBase = function DialogBase(props) {
  ...
  var open = props.open,
      ...
      style = props.style,
      other = _objectWithoutProperties(props, ["open", "onClose", "title", "toolbarChildren", "children", "closeButtonProps", "nopaper", "style"]);
