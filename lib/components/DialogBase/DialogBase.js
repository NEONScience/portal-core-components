...
var DialogBase = function DialogBase(props) {
  ...
  }, other), _react.default.createElement(_AppBar.default, null, _react.default.createElement(_Toolbar.default, null, _react.default.createElement(_IconButton.default, _extends({
    "data-selenium": "dialog-close-button",
    edge: "start",
    color: "inherit",
    onClick: onClose,
    "aria-label": "cancel"
  }, closeButtonProps), _react.default.createElement(_Close.default, null)), _react.default.createElement(_Typography.default, {
    variant: "h5",
    className: classes.dialogTitle,
    noWrap: true
  }, title), toolbarChildren)), _react.default.createElement(_Paper.default, {
