...
const SplitButton = props => {
  ...
  const widthStyle = (0, _typeUtil.exists)(isFullWidth) ? classes.fullWidth : classes.noChange;
  const iconWidthStyle = (0, _typeUtil.exists)(isFullWidth) ? classes.fitContent : classes.noChange;
  const customStyles = (0, _typeUtil.exists)(styleOverrides) ? styleOverrides : {};
