...
declare namespace NeonApi {
    ...
    function getJsonAjaxObservable(url: string, headers?: Object | undefined, includeToken?: boolean): import("rxjs").Observable<import("rxjs/ajax").AjaxResponse<any>> | import("rxjs").Observable<null>;
