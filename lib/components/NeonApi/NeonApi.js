 ...
 */ const getJsonAjaxRequest = (url, headers = undefined, includeToken = true, withCredentials = undefined)=>{
    let appliedHeaders = headers || {};
    if (includeToken) {
 ...
 */ const getJsonAjaxObservable = (url, headers = undefined, includeToken = true, withCredentials = undefined)=>{
 ...
 * @param {boolean} withCredentials Option to include credentials with a CORS request
 * @return The RxJS Ajax Observable
 */ const getJsonObservable = (url, headers = undefined, includeToken = true, withCredentials = undefined)=>mapResponse(getJsonAjaxObservable(url, headers, includeToken, withCredentials));
/**
 ...
 */ const headJsonAjaxRequest = (url, headers = undefined, includeToken = true, withCredentials = undefined)=>{
    let appliedHeaders = headers || {};
    if (includeToken) {
        appliedHeaders = getApiTokenHeader(appliedHeaders);
    }
 ...
 * @param {boolean} withCredentials Option to include credentials with a CORS request
 * @return The RxJS Ajax Observable
 */ const headJsonObservable = (url, headers = undefined, includeToken = true, withCredentials = undefined)=>{
    if (typeof url !== 'string' || !url.length) {
        return of(null);
    }
 ...
 * @param {boolean} withCredentials Option to include credentials with a CORS request
 * @return The RxJS Ajax Observable
 */ const postJsonObservable = (url, body, headers = undefined, includeToken = true, withCredentials = undefined)=>{
    if (typeof url !== 'string' || !url.length) {
        return of(null);
    }
    let appliedHeaders = headers || {};
 ...
 */ const NeonApi = {
   ...
   * @param {boolean} includeToken Option to include the API token in the request
   * @return The RxJS Ajax Observable
   */ getJsonAjaxObservable: (url, headers = undefined, includeToken = true)=>getJsonAjaxObservable(url, headers, includeToken),
    /**
   * Gets the RxJS observable for making an API request to the specified URL
   * with optional headers.
   * @param {string} url The URL to make the API request to
   ...
   * @param {boolean} includeToken Option to include the API token in the request
   * @return The RxJS Ajax Observable
   */ getJsonObservable: (url, headers = undefined, includeToken = true)=>getJsonObservable(url, headers, includeToken),
    /**
   * Gets the RxJS observable for making a POST API request to the specified URL
   * with body and optional headers.
   * @param {string} url The URL to make the API request to
   ...
   * @param {boolean} includeToken Option to include the API token in the request
   * @return The RxJS Ajax Observable
   */ postJsonObservable: (url, body, headers = undefined, includeToken = true)=>postJsonObservable(url, body, headers, includeToken),
    /**
   ...
   * @param {boolean} includeToken Option to include the API token in the request
   * @return The RxJS Ajax Observable
   */ headJsonObservable: (url, headers = undefined, includeToken = true)=>headJsonObservable(url, headers, includeToken),
    /**
   ...
   */ getJson: (url, callback, errorCallback, cancellationSubject$, headers = undefined)=>getJson(url, callback, errorCallback, cancellationSubject$, getApiTokenHeader(headers)),
    /**
   ...
   */ getProductBundlesObservable: (release = null)=>{
        ...
        const path = isStringNonEmpty(release) ? `${root}?release=${release}` : `${root}`;
        return getJsonObservable(path);
    },
    /**
   * Gets the prototype data endpoint RxJS Observable.
   * @return The RxJS Ajax Observable
   */ getPrototypeDatasetsObservable: ()=>getJsonObservable(`${NeonEnvironment.getFullApiPath('prototype')}/datasets`),
    getPrototypeDatasetObservable: (uuid)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('prototype')}/datasets/${uuid}`),
    getPrototypeManifestRollupObservable: (uuid)=>getJsonObservable(`${NeonEnvironment.getFullDownloadApiPath('prototypeManifestRollup')}?uuid=${uuid}`),
    getPrototypeDataFileObservable: (uuid, fileName)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('prototype')}/data/${uuid}/${fileName}`),
    /**
   ...
   * @return The RxJS Ajax Observable
   */ getReleaseObservable: (release)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('releases')}/${release}`),
    /**
   ...
   * @return The RxJS Ajax Observable
   */ getSiteJsonObservable: (siteCode)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('sites')}/${siteCode}`),
    /**
   ...
   * @return The RxJS Ajax Observable
   */ getSiteLocationHierarchyObservable: (siteCode)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('locations')}/${siteCode}?hierarchy=true`),
    /**
   ...
   * @return The RxJS Ajax Observable
   */ getLocationObservable: (location)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('locations')}/${location}`),
    /**
   * Gets the RxJS Observable for the ArcGIS asset endpoint for a given feature / site code combo
   * @param {string} feature
   * @param {string} siteCode
   * @return The RxJS Ajax Observable
   */ getArcgisAssetObservable: (feature, siteCode)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('arcgisAssets')}/${feature}/${siteCode}`, undefined, true, false),
    /**
   * Gets the RxJS Observable for the document HEAD endpoint for a given name
   * @param {string} name The document name
   * @return The RxJS Ajax Observable
   */ headDocumentObservable: (name)=>headJsonObservable(`${NeonEnvironment.getFullApiPath('documents')}/${name}`),
    /**
   ...
   * @return The RxJS Ajax Observable
   */ getQuickStartGuideDetailObservable: (name, version)=>getJsonObservable(`${NeonEnvironment.getFullApiPath('quickStartGuides')}/details/${name}/${version}`),
    /**
   * Gets the RxJS Observable for the quick start guides HEAD endpoint for a given name
   * @param {string} name The document name
   * @return The RxJS Ajax Observable
   */ headQuickStartGuideObservable: (name)=>headJsonObservable(`${NeonEnvironment.getFullApiPath('quickStartGuides')}/${name}`)
};
