...
var NeonApi = {
  ...
  getPrototypeManifestObservable: function getPrototypeManifestObservable(uuid) {
    return (// eslint-disable-next-line max-len
      _getJsonObservable("".concat(_NeonEnvironment.default.getFullApiPath('manifest'), "/prototype/manifest?uuid=").concat(uuid))
    );
  },
