...
var NeonApi = {
   ...
   * @return The RxJS Ajax Observable
   */
  getProductTombstoneAvailabilityObservable: function getProductTombstoneAvailabilityObservable(productCode, release) {
    var root = _NeonEnvironment.default.getFullApiPath('products');
    var path = "".concat(root, "/").concat(productCode, "/").concat(release, "/tombstone-data-availability");
    return _getJsonObservable(path);
  },
  /**
   ...
   * @return The RxJS Ajax Observable
   */
  getProductDoisObservable: function getProductDoisObservable(productCode, release) {
    var root = _NeonEnvironment.default.getFullApiPath('products');
    var path = "".concat(root, "/").concat(productCode, "/dois/").concat(release);
    return _getJsonObservable(path);
  },
  /**
