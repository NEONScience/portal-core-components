...
var NeonMenu = /*#__PURE__*/function (_Component) {
  _inherits(NeonMenu, _Component);

  var _super = _createSuper(NeonMenu);
  ...
  _createClass(NeonMenu, [{
    ...
    value: function componentDidMount() {
      _NeonApi.default.getJson(_NeonEnvironment.default.getFullApiPath('menu'), this.menuFromResponse, this.menuErrorCallback, this.cancellationSubject$);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onShowNotifications = _this$props.onShowNotifications;
      ...
      var authContent = /*#__PURE__*/_react.default.createElement(_Button.default, {
        href: loginPath,
        size: "small",
        variant: "outlined",
      ...
      }, notificationsContent, authContent);
      ...
      if (fetched) {
        ...
        }, /*#__PURE__*/_react.default.createElement(_Home.default, null))), (menuItems.length ? menuItems : defaultStaticMenuItems).map(generateRCMenuItem));
      }
