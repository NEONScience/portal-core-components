...
var menuItemIconMap = {
  Home: _react.default.createElement(_HomeOutlined.default, null),
  About: _react.default.createElement(_InfoOutlined.default, null),
  'Download Data': _react.default.createElement(_CloudDownloadOutlined.default, null),
  Resources: _react.default.createElement(_ListAltOutlined.default, null),
  'Contact Us': _react.default.createElement(_LiveHelpOutlined.default, null),
  'My Datasets': _react.default.createElement(_PersonOutline.default, null)
};
...
var NeonDrawerMenu = function NeonDrawerMenu(props) {
  ...
  var renderMenuItem = function renderMenuItem(item) {
    ...
    var listItemIcon = menuItemIconMap[item.name] ? _react.default.createElement(_ListItemIcon.default, {
    ...
    if (item.children.length) {
      ...
      expandIcon = open[id] ? _react.default.createElement(_ExpandLess.default, null) : _react.default.createElement(_ExpandMore.default, null);
      collapse = _react.default.createElement(_Collapse.default, {
        in: open[id],
        timeout: "auto",
        unmountOnExit: true
    ...
    }, listItemProps), listItemIcon, _react.default.createElement(_ListItemText.default, {
