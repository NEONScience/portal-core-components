...
/* eslint-disable max-len, @stylistic/max-len */ const useStyles = (customize)=>{
...
/* eslint-enable max-len, @stylistic/max-len */ const buildSearchAction = (action)=>{
...
const NeonHeader = (inProps)=>{
    ...
    const { ref: headerRef, drupalCssLoaded, unstickyDrupalHeader, showSkeleton, customizeAuthContainer } = props;
    const { classes } = useStyles(customizeAuthContainer)();
    const belowLg = useMediaQuery(Theme.breakpoints.down('lg'));
    const [{ isActive: neonContextIsActive, fetches: { [DRUPAL_HEADER_HTML]: headerFetch }, html: { [DRUPAL_HEADER_HTML]: headerHTML }, auth }] = NeonContext.useNeonContextState();
    ...
    useLayoutEffect(()=>{
        ...
        if (!renderMode.includes('drupal') || headerJsStatus !== FETCH_STATUS.AWAITING_CALL || !headerRenderDelayed || !drupalCssLoaded) {
            return;
        }
        ...
        replace: (domNode)=>{
            ...
            if (name === 'form' && attribs.id === 'search-api-form') {
                ...
                return /*#__PURE__*/ _jsx("form", {
                    ...
                    children: domToReact(domNode.children, injectAuth)
                });
            }
            ...
            return /*#__PURE__*/ _jsx("div", {
                ...
                children: /*#__PURE__*/ _jsx(NeonAuth, {
                    ...
                    displayType: customizeAuthContainer ? NeonAuthDisplayType.MENU_CUSTOM : NeonAuthDisplayType.MENU
                })
            });
        }
    };
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsx("header", {
                ...
                children: HTMLReactParser(html, injectAuth)
            }),
            /*#__PURE__*/ _jsx(ApplicationMenu, {})
        ]
    });
};
