...
const useStyles = customize => {
  ...
  return (0, _styles.makeStyles)(theme => ({
    skeletonHeader: {
    ...
    headerContainerFallback: {
      '& li.siteSearch > a': {
        background: `url('${_headerSearch.default.src}') center center no-repeat !important`
      },
      '& li.siteSearch > a:hover': {
        background: `url('${_headerSearchHover.default.src}') center center no-repeat !important`
      }
    },
...
const NeonHeader = /*#__PURE__*/(0, _react.forwardRef)((inProps, headerRef) => {
  ...
  const classes = useStyles(customizeAuthContainer)(_Theme.default);
    ...
    replace: domNode => {
      ...
      if (name === 'form' && attribs.id === 'search-api-form') {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsx)("form", {
          ...
          children: (0, _htmlReactParser.domToReact)(domNode.children, injectAuth)
        });
      }
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_NeonAuth.default, {
          ...
          displayType: customizeAuthContainer ? _NeonAuth.NeonAuthDisplayType.MENU_CUSTOM : _NeonAuth.NeonAuthDisplayType.MENU
        })
      });
    }
  };
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("header", {
      ...
      children: (0, _htmlReactParser.default)(html, injectAuth)
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_ApplicationMenu.default, {})]
  });
});
NeonHeader.propTypes = {
  ...
  customizeAuthContainer: _propTypes.default.bool
};
