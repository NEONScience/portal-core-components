...
var _remoteAssetsMap = _interopRequireDefault(require("../../remoteAssetsMap"));
...
var DRUPAL_HEADER_HTML_FALLBACK = require('../../remoteAssets/drupal-header.html');

var DRUPAL_HEADER_HTML = _remoteAssetsMap.default.DRUPAL_HEADER_HTML.KEY; // const DRUPAL_HEADER_JS = REMOTE_ASSETS.DRUPAL_HEADER_JS.KEY;
...
var NeonHeader = /*#__PURE__*/(0, _react.forwardRef)(function (props, headerRef) {
  ...
  (0, _react.useLayoutEffect)(function () {
    if (!['drupal', 'drupal-fallback'].includes(renderMode) || headerJsLoaded || !headerRenderDelayed || !drupalCssLoaded) {
      return;
    }
  ...
  if (renderMode === 'drupal' || renderMode === 'drupal-fallback') {
    ...
    var html = renderMode === 'drupal' ? headerHTML : DRUPAL_HEADER_HTML_FALLBACK;
    return /*#__PURE__*/_react.default.createElement("header", {
      ref: headerRef,
      id: "header",
