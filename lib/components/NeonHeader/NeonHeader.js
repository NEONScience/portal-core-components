...
var buildSearchAction = function buildSearchAction(action) {
  var root = 'https://www.neonscience.org';
...
var NeonHeader = /*#__PURE__*/(0, _react.forwardRef)(function (props, headerRef) {
  ...
  var _NeonContext$useNeonC = _NeonContext.default.useNeonContextState(),
      ...
      auth = _NeonContext$useNeonC3.auth; // Only do the delay effect if not in test
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    script.onerror = function () {
      setHeaderJsStatus(_NeonContext.FETCH_STATUS.ERROR); // eslint-disable-next-line no-unused-expressions
    ...
    document.body.appendChild(script); // TODO: verify header.js loaded and if not load the fallback
  }, [headerJsStatus, drupalCssLoaded, headerRenderDelayed, setHeaderJsStatus, renderMode]); // Delay the rendering of the drupal header one render cycle to allow the CSS to propogate into
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    return function () {};
  }, [neonContextIsActive, headerHTML, drupalCssLoaded, headerRenderDelayed]); // Render Loading
