...
var HEADER_JS_URL = 'https://master-7rqtwti-di4alr4iwbwyg.us-2.platformsh.site/themes/custom/neon/build/components/header/header.js';
...
var NeonHeader = function NeonHeader(props) {
  var useCoreHeader = props.useCoreHeader,
  ...
  var _NeonContext$useNeonC = _NeonContext.default.useNeonContextState(),
      ...
      isActive = _NeonContext$useNeonC3.isActive,
  ...
  if (!useCoreHeader && isActive) {
    if (headerFetch.status === _NeonContext.FETCH_STATUS.SUCCESS && headerHTML) {
      renderMode = 'drupal';
    }

    if ([_NeonContext.FETCH_STATUS.AWAITING_CALL, _NeonContext.FETCH_STATUS.FETCHING].includes(headerFetch.status)) {
      renderMode = 'loading';
    }
  } // Load header.js
  ...
  (0, _react.useEffect)(function () {
    if (headerJsLoaded || renderMode !== 'drupal') {
      return;
    }
  ...
  }, [headerJsLoaded, setHeaderJsLoaded, renderMode]); // Render Loading
  ...
  if (renderMode === 'drupal') {
    ...
    }, (0, _htmlReactParser.default)(headerHTML.replace(/ value=""/g, ' initialValue=""')));
  } // Render Legacy


  return /*#__PURE__*/_react.default.createElement(_NeonLegacyHeader.default, props);
};

NeonHeader.propTypes = _extends(_extends({}, _NeonLegacyHeader.default.propTypes), {}, {
  useCoreHeader: _propTypes.default.bool,
  unstickyDrupalHeader: _propTypes.default.bool
});
NeonHeader.defaultProps = _extends(_extends({}, _NeonLegacyHeader.default.defaultProps), {}, {
  useCoreHeader: false,
