...
const ExternalHostInfo = props => {
  ...
  if (externalHost.hostType === _ExternalHost.default.HOST_TYPES.REFORMATTED_DATA) {
    blurb = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, `${dataVariety} for this product are available in other formats from`, "\xA0", externalGeneralLink);
  }
  if (externalHost.hostType === _ExternalHost.default.HOST_TYPES.EXCLUSIVE_DATA || allowNoLinks) {
    blurb = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, `${dataVariety} for this product are only available from`, "\xA0", externalGeneralLink);
  }
  ...
  if (!blurb) {
    ...
    blurb = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, `${dataVariety} associated with this product ${are} available from`, "\xA0", externalGeneralLink);
  }
