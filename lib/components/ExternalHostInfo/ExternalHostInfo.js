...
var ExternalHostInfo = function ExternalHostInfo(props) {
  ...
  if (externalHost.hostType === _ExternalHost.default.HOST_TYPES.REFORMATTED_DATA) {
    blurb = _react.default.createElement(_react.default.Fragment, null, "".concat(dataVariety, " for this product are available in other formats from"), "\xA0", externalGeneralLink);
  }

  if (externalHost.hostType === _ExternalHost.default.HOST_TYPES.EXCLUSIVE_DATA) {
    blurb = _react.default.createElement(_react.default.Fragment, null, "".concat(dataVariety, " for this product are only available from"), "\xA0", externalGeneralLink);
  ...
  if (!blurb) {
    ...
    blurb = _react.default.createElement(_react.default.Fragment, null, "".concat(dataVariety, " associated with this product ").concat(are, " available from"), "\xA0", externalGeneralLink);
  }

  var content = _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
  ...
  }, blurb), hasSpecificLinks && expandable ? _react.default.createElement(_IconButton.default, {
    title: expandTitle,
  ...
  }, expanded ? _react.default.createElement(_ExpandLess.default, null) : _react.default.createElement(_ExpandMore.default, null)) : null), _react.default.createElement("div", {
    style: {
      width: '100%',
  ...
  return _react.default.createElement("div", rootProps, _react.default.createElement(_SnackbarContent.default, {
