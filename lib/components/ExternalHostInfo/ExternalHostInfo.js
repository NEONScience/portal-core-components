...
var ExternalHostInfo = function ExternalHostInfo(props) {
  ...
  var externalGeneralShortLink = externalHost.renderShortLink();
  ...
  var blurb = null;
  var blurbLink = hasSpecificLinks ? externalGeneralShortLink : _react2.default.createElement(
  ...
  if (externalHost.hostType === _ExternalHost2.default.HOST_TYPES.REFORMATTED_DATA) {
    blurb = _react2.default.createElement(
      _react2.default.Fragment,
      null,
      'Data for this product are available in other formats from\xA0',
      blurbLink
    );
  }
  if (externalHost.hostType === _ExternalHost2.default.HOST_TYPES.EXCLUSIVE_DATA) {
    blurb = _react2.default.createElement(
      _react2.default.Fragment,
      null,
      'Data for this product are only available from\xA0',
      blurbLink
    );
  }
  // Default: ExternalHost.HOST_TYPES.ADDITIONAL_DATA:
  if (!blurb) {
    var data = externalHost.additionalDataType || 'Additional data';
  ...
  var content = _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        'Use the links below to access data from the ',
        externalGeneralLink,
        '.'
      ),
