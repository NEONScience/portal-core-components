...
const getQueryBody = function () {
  ...
  switch (type) {
    ...
    case TYPES.DEMO_DATA_PRODUCTS:
      if (dimensionality === DIMENSIONALITIES.ONE) {
        const availableReleases = getAvailableReleaseClause(args);
        query = "query Products {\n          product: demoProduct (productCode: \"".concat(args.productCode, "\") {\n            productCode\n            productName\n            productDescription\n            productScienceTeam\n            productHasExpanded\n            productBasicDescription\n            productExpandedDescription\n            productPublicationFormatType\n            keywords\n            themes\n            siteCodes {\n              siteCode\n              availableMonths\n              ").concat(availableReleases, "\n            }\n            releases {\n              release\n              generationDate\n              url\n            }\n          }\n        }");
      }
      break;
    case TYPES.SITES:
      if (dimensionality === DIMENSIONALITIES.ONE) {
...
const NeonGraphQL = {
  ...
  getDemoDataProductByCode: function (productCode) {
    let includeAvailableReleases = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return getObservableWith(TYPES.DEMO_DATA_PRODUCTS, DIMENSIONALITIES.ONE, {
      productCode,
      includeAvailableReleases
    });
  },
