...
const NeonGraphQL = {
    getDataProductByCode: (productCode, release, includeAvailableReleases = false)=>getObservableWith(TYPES.DATA_PRODUCTS, DIMENSIONALITIES.ONE, {
            productCode,
            release,
            includeAvailableReleases
        }),
    getDemoDataProductByCode: (productCode, includeAvailableReleases = false)=>getObservableWith(TYPES.DEMO_DATA_PRODUCTS, DIMENSIONALITIES.ONE, {
            productCode,
            includeAvailableReleases
        }),
    getAllDataProducts: (release, includeAvailableReleases = false)=>getObservableWith(TYPES.DATA_PRODUCTS, DIMENSIONALITIES.MANY, {
            release,
            includeAvailableReleases
        }),
