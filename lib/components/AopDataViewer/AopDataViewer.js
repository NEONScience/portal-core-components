...
*/ /* eslint-disable no-param-reassign, function-paren-newline */ const parseFetchResponse = (response)=>response.data.siteCodes.reduce((obj, site)=>{
...
*/ const AopDataViewer = (inProps)=>{
    ...
    const { productCode, showTitle, fillContainer, showOpenInNewWindow } = props;
  ...
  */ const handleFetchProductByCode = useCallback(()=>ajax({
    ...
    const renderSiteSelect = ()=>{
        ...
        const menuItems = Object.keys(sitesByStateName).sort().flatMap((stateName)=>[
            ...
            ].concat(sitesByStateName[stateName].map((site)=>/*#__PURE__*/ _jsx(MenuItem, {
                    value: site,
        ...
        return /*#__PURE__*/ _jsxs("div", {
            ...
            children: [
                /*#__PURE__*/ _jsx(MapSelectionButton, {
                    selection: "SITES",
                    selectionLimit: 1,
                    selectedItems: currentSelection.site ? [
            ...
            children: [
                /*#__PURE__*/ _jsx("div", {
                    ...
                    children: /*#__PURE__*/ _jsx(IconButton, {
                        ...
                        children: /*#__PURE__*/ _jsx(BackYearIcon, {})
                    })
                }),
                /*#__PURE__*/ _jsx("div", {
                    style: {
                ...
                /*#__PURE__*/ _jsx("div", {
                    ...
                    children: /*#__PURE__*/ _jsx(IconButton, {
                        ...
                        children: /*#__PURE__*/ _jsx(ForwardYearIcon, {})
                    })
                })
            ]
        });
    ...
    const renderFlightSelect = ()=>{
        ...
        const getFlightLabel = (flightNumber, month)=>`${flightNumber}/${total} (${moment(new Date(`2000-${month}-02`)).format('MMMM')})`;
        return /*#__PURE__*/ _jsx(Select, {
            ...
            disabled: total === 1,
            children: data[site][year].map((f, idx)=>/*#__PURE__*/ _jsx(MenuItem, {
                    value: idx + 1,
                    children: getFlightLabel(idx + 1, f.month)
                }, `${f.url}`))
        });
    };
    const renderInputLabel = (input, tooltip = null)=>/*#__PURE__*/ _jsxs(Typography, {
    ...
    const visusLink = /*#__PURE__*/ _jsx(Link, {
    ...
    const renderSelectionForm = ()=>/*#__PURE__*/ _jsxs("form", {
            className: classes.selectionForm,
            autoComplete: "off",
            children: [
                showTitle ? /*#__PURE__*/ _jsx(Typography, {
                    variant: "h5",
                    gutterBottom: true,
                ...
                belowSm ? /*#__PURE__*/ _jsxs(_Fragment, {
                    children: [
                        /*#__PURE__*/ _jsxs(Grid, {
                            container: true,
                            spacing: 2,
    ...
    return /*#__PURE__*/ _jsxs(FullWidthVisualization, {
        ...
        children: [
            ...
            !showOpenInNewWindow ? null : /*#__PURE__*/ _jsxs(Link, {
                href: srcUrl,
                target: "_blank",
                rel: "noopener noreferrer",
...
const WrappedAopDataViewer = Theme.getWrappedComponent(NeonContext.getWrappedComponent(AopDataViewer));
