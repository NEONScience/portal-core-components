...
var getSiteDescription = function getSiteDescription(site) {
  ...
  if (_sites.default[site]) {
    var state = includeState ? ", ".concat(_sites.default[site].stateCode) : '';
    return "".concat(_sites.default[site].description).concat(state);
  }
  ...
  */
  ...
  var renderSiteSelect = function renderSiteSelect() {
    ...
    Object.keys(data).forEach(function (site) {
      var stateName = _states.default[_sites.default[site].stateCode].name;
  ...
  }, renderTopForm(), _react.default.createElement("iframe", {
