...
const AopDataViewer = props => {
  ...
  */
  ...
  const getDataSetTitle = (selection, data) => {
    ...
    const parts = {
      ...
      date: (0, _dateformat.default)(new Date(`${year}-${data[site][year][flightIdx].month}-02`), 'mmmm yyyy'),
  ...
  */
  ...
  const renderFlightSelect = () => {
    ...
    const getFlightLabel = (flightNumber, month) => `${flightNumber}/${total} (${(0, _dateformat.default)(new Date(`2000-${month}-02`), 'mmmm')})`;
  ...
  const renderInputLabel = function (input) {
    ...
    return /*#__PURE__*/_react.default.createElement(_Typography.default, {
      ...
      id: `${input}-label`
    }, `${input.substr(0, 1).toUpperCase()}${input.substr(1)}`, tooltip ? /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
      placement: "right",
      title: tooltip
    }, /*#__PURE__*/_react.default.createElement(_IconButton.default, {
      size: "small",
