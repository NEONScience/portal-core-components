...
var DataProductAvailability = function DataProductAvailability(props) {
  var enhancedSites = props.sites,
      basicSiteCodes = props.siteCodes,
      other = _objectWithoutProperties(props, _excluded); // Favor enhanced view if we have the enhanced prop
