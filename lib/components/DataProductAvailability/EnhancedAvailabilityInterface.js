...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); } /* eslint-disable no-unused-vars */
const preStyle = {
  width: '100%',
  height: '50vh',
  overflowY: 'scroll',
...
const EnhancedAvailabilityInterface = props => {
  ...
  */
  const renderSortOptions = () => /*#__PURE__*/_react.default.createElement("div", {
    ...
    key: method,
    value: method
  }, `${method.substr(0, 1).toUpperCase()}${method.substr(1)}`)))), /*#__PURE__*/_react.default.createElement(_ToggleButtonGroup.default, {
    exclusive: true,
    size: "small",
