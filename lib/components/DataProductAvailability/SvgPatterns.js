...
var svgPatternsSrc = {
  horizontalStripeSecondaryBlue2: {
    dim: 8,
    node: _react.default.createElement("svg", {
      ...
      width: "8",
      height: "8",
      fill: _Theme.COLORS.SECONDARY_BLUE[100]
    }), _react.default.createElement("rect", {
      x: "0",
      y: "0",
      width: "8",
...
function SvgPatterns() {
  return _react.default.createElement(_react.default.Fragment, null, Object.keys(svgPatternsSrc).map(function (pattern) {
    ...
    return _react.default.createElement("pattern", {
      id: pattern,
      key: pattern,
