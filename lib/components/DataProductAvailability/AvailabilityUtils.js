...
const calcRollupStatus = (statuses = []) => {
...
const TIME = exports.TIME = {
  getYearMonthMoment: yearMonth => (0, _moment.default)(`${yearMonth}-01`),
  getNextMonth: month => _moment.default.utc(`${month}-15T00:00:00Z`).add(1, 'month').format('YYYY-MM'),
  getPreviousMonth: month => _moment.default.utc(`${month}-15T00:00:00Z`).subtract(1, 'month').format('YYYY-MM'),
