 ...
 */ export default function BasicAvailabilityGrid(config) {
  ...
  */ const rowLabelsG = svg.append('g').attr('class', 'rowLabelsG');
    rowKeys.forEach((rowKey, rowIdx)=>{
        ...
        const text = rowLabelG.append('text').attr('x', labelX).attr('y', SVG.LABEL_FONT_SIZE - SVG.CELL_PADDING / 2).attr('fill', fill).text(data.getLabel.text(rowKey));
