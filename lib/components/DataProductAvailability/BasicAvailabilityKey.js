...
var VERTICAL_STATUS_TYPES = ['tombstoned'];
...
function BasicAvailabilityKey(props) {
  ...
  */
  var renderVerticalCellLegend = function renderVerticalCellLegend() {
    var totalRows = delineateRelease ? 4 : 2;
    var totalWidth = delineateRelease || VERTICAL_STATUS_TYPES.includes(availabilityStatusType) ? 180 : 90;
    ...
    var renderAvailabilityStatusCell = function renderAvailabilityStatusCell() {
      var tombstonedCell = _AvailabilitySvgComponents.CELL_ATTRS.tombstoned;
    ...
    var renderMixedAvaProvisionalCell = function renderMixedAvaProvisionalCell() {
      if (!delineateRelease) {
        return null;
      }
      var provCell = _AvailabilitySvgComponents.CELL_ATTRS['mixed-available-provisional'];
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("rect", {
        x: 0.75,
        y: rowY(2),
        width: _AvailabilityUtils.SVG.CELL_WIDTH,
    ...
    return /*#__PURE__*/_react.default.createElement("svg", {
    ...
    }, renderAvailabilityStatusCell(), renderMixedAvaProvisionalCell(), renderProvisionalCell(), /*#__PURE__*/_react.default.createElement("rect", {
      x: 0.75,
      y: rowY(delineateRelease ? 3 : 1),
      width: _AvailabilityUtils.SVG.CELL_WIDTH,
      height: _AvailabilityUtils.SVG.CELL_HEIGHT,
      rx: _AvailabilityUtils.SVG.CELL_RX,
      ...
      className: classes.legendText,
      x: cellOffset,
      y: rowLabelY(delineateRelease ? 3 : 1)
    }, "No data"));
  ...
  */
  var renderHorizontalCellLegend = function renderHorizontalCellLegend() {
    var totalColumns = delineateRelease ? 4 : 2;
    ...
    return /*#__PURE__*/_react.default.createElement("svg", {
      ...
      x: columnX(delineateRelease ? 3 : 1),
      y: 0,
      width: _AvailabilityUtils.SVG.CELL_WIDTH,
      height: _AvailabilityUtils.SVG.CELL_HEIGHT,
      rx: _AvailabilityUtils.SVG.CELL_RX,
      ...
      className: classes.legendText,
      x: columnX(delineateRelease ? 3 : 1) + cellOffset,
      y: rowLabelY
    }, "No data"));
    /* eslint-enable max-len */
  };
  ...
  /**
     Render: Cell Legend
  */
  var renderCellLegend = function renderCellLegend(appliedOrientation) {
    var resultingOrientation = orientation === '' ? appliedOrientation : orientation;
  ...
  */
  ...
  var renderVerticalLegend = selectionEnabled || delineateRelease || VERTICAL_STATUS_TYPES.includes(availabilityStatusType);
  return renderVerticalLegend ? /*#__PURE__*/_react.default.createElement("div", {
    className: classes.legendContainer
  }, renderCellLegend('vertical'), selectionEnabled ? renderSelectionLegend() : null) : /*#__PURE__*/_react.default.createElement("div", {
    className: classes.legendContainer
