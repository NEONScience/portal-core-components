...
function EnhancedAvailabilityKey(props) {
  ...
  var statusLabelX = _AvailabilityUtils.SVG.CELL_WIDTH + 2 * _AvailabilityUtils.SVG.CELL_PADDING; // Let each element in the key be clickable to open the help dialog.
