...
const DiagHalfAndHalfPattern = (inProps)=>{
    ...
    const { id, color, diagColor, diagColorFillOpacity, secondaryDiagColor } = props;
    ...
    return /*#__PURE__*/ _jsxs("pattern", {
        ...
        children: [
            ...
            coords.map((coord, idx)=>/*#__PURE__*/ _jsx("line", {
                    x1: coord.x1,
                    y1: coord.y1,
                    x2: coord.x2,
                    y2: coord.y2,
                ...
                }, `DiagHalfAndHalfPatternKey-${coord.x1}-${coord.y1}-${coord.x2}-${coord.y2}-${idx}`)),
            /*#__PURE__*/ _jsx("polygon", {
...
export const SvgDefs = ()=>/*#__PURE__*/ _jsx("svg", {
        width: "0px",
        height: "0px",
        children: /*#__PURE__*/ _jsxs("defs", {
            children: [
                /*#__PURE__*/ _jsx(DiagLinesPattern, {
                    id: "availableProvisionalPattern",
                    color: COLORS.NEON_BLUE[700],
                    secondaryColor: COLORS.NEON_BLUE[50]
                }),
                /*#__PURE__*/ _jsx(DiagHalfAndHalfPattern, {
                ...
                /*#__PURE__*/ _jsx(HalfAndHalfPattern, {
