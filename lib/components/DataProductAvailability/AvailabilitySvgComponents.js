...
var DiagHalfAndHalfPattern = function DiagHalfAndHalfPattern(props) {
  ...
  var diagLength = Math.sqrt(Math.pow(cellW, 2) + Math.pow(cellH, 2)) - (initDist + trailingDist);
  // Distance between parallel lines
  var diagLineGap = diagLength / numLines;
  var diagLineStrokeWidth = 1;
  ...
  return /*#__PURE__*/_react.default.createElement("pattern", {
    ...
    points: "0,".concat(cellH, " ").concat(cellW, ",0 ").concat(cellW, ",").concat(cellH),
    fill: secondaryDiagColor
  }), coords.map(function (coord) {
    return /*#__PURE__*/_react.default.createElement("line", {
      key: "DiagHalfAndHalfPatternKey-".concat(coord.x1, "-").concat(coord.y1, "-").concat(coord.x2, "-").concat(coord.y2),
      x1: coord.x1,
      y1: coord.y1,
      x2: coord.x2,
      y2: coord.y2,
    ...
    points: "0,0 ".concat(cellW - nudgeDiagFill, ",0 0,").concat(cellH - nudgeDiagFill),
    fill: color
  }));
};
