...
const DiagLinesPattern = inProps => {
  const props = (0, _defaultProps.resolveProps)(diagLinesPatternDefaultProps, inProps);
  const {
    id,
    color,
    secondaryColor
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("pattern", {
    id: id,
    width: width,
    height: height,
...
const HalfAndHalfPattern = inProps => {
  const props = (0, _defaultProps.resolveProps)(halfAndHalfPatternDefaultProps, inProps);
  const {
    id,
    color,
    secondaryColor
...
const DiagHalfAndHalfPattern = inProps => {
  const props = (0, _defaultProps.resolveProps)(diagHalfAndHalfPatternDefaultProps, inProps);
  const {
    id,
    color,
    diagColor,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("pattern", {
    ...
    }), coords.map((coord, idx) => /*#__PURE__*/(0, _jsxRuntime.jsx)("line", {
      x1: coord.x1,
      y1: coord.y1,
      x2: coord.x2,
      y2: coord.y2,
    ...
    }, `DiagHalfAndHalfPatternKey-${coord.x1}-${coord.y1}-${coord.x2}-${coord.y2}-${idx}`)), /*#__PURE__*/(0, _jsxRuntime.jsx)("polygon", {
      points: `0,0 ${cellW - nudgeDiagFill},0 ${0},${cellH}`,
      fill: color
    })]
  });
};
...
const SvgDefs = () => /*#__PURE__*/(0, _jsxRuntime.jsx)("svg", {
  width: "0px",
  height: "0px",
  children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("defs", {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(DiagLinesPattern, {
      id: "availableProvisionalPattern",
      color: _Theme.COLORS.NEON_BLUE[700],
      secondaryColor: _Theme.COLORS.NEON_BLUE[50]
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(DiagHalfAndHalfPattern, {
    ...
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(DiagLinesPattern, {
    ...
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(HalfAndHalfPattern, {
...
const thinStrokeAttrs = {
  strokeWidth: '0.8px',
  width: `${_AvailabilityUtils.SVG.CELL_WIDTH - 0.8}px`,
  height: `${_AvailabilityUtils.SVG.CELL_HEIGHT - 0.8}px`,
  rx: `${_AvailabilityUtils.SVG.CELL_RX * 1.5}px`,
  nudge: 0.4
};
const midStrokeAttrs = {
  strokeWidth: '1.15px',
  width: `${_AvailabilityUtils.SVG.CELL_WIDTH - 1.15}px`,
  height: `${_AvailabilityUtils.SVG.CELL_HEIGHT - 1.15}px`,
  rx: `${_AvailabilityUtils.SVG.CELL_RX * 1.25}px`,
  nudge: 0.60
};
const fatStrokeAttrs = {
  strokeWidth: '1.5px',
  width: `${_AvailabilityUtils.SVG.CELL_WIDTH - 1.5}px`,
  height: `${_AvailabilityUtils.SVG.CELL_HEIGHT - 1.5}px`,
  rx: `${_AvailabilityUtils.SVG.CELL_RX}px`,
  nudge: 0.75
};
const noStrokeAttrs = {
  stroke: null,
  strokeWidth: null,
  width: `${_AvailabilityUtils.SVG.CELL_WIDTH}px`,
  height: `${_AvailabilityUtils.SVG.CELL_HEIGHT}px`,
  rx: `${_AvailabilityUtils.SVG.CELL_RX * 2}px`,
  nudge: 0
};
...
const jsxCellDefaultProps = {
  x: 0,
  y: 0
};
const JsxCell = inProps => {
  const props = (0, _defaultProps.resolveProps)(jsxCellDefaultProps, inProps);
  const {
    status,
    x,
    y
