...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  return {
    ...
    legendText: {
      ...
      fontWeight: 400,
      fontSize: "".concat(_AvailabilityGrid.SVG.LABEL_FONT_SIZE, "px"),
  ...
  */
  ...
  var renderVerticalCellLegend = function renderVerticalCellLegend() {
    ...
    return _react.default.createElement("svg", {
      ...
      x: cellOffset,
      y: rowLabelY(0)
    }, "Available"), _react.default.createElement("rect", {
      x: 0,
      y: rowY(1),
      width: _AvailabilityGrid.SVG.CELL_WIDTH,
      height: _AvailabilityGrid.SVG.CELL_HEIGHT,
      rx: _AvailabilityGrid.SVG.CELL_RX,
      fill: _Theme.default.palette.grey[100]
    }), _react.default.createElement("text", {
      className: classes.legendText,
      x: cellOffset,
      y: rowLabelY(1)
  ...
  */
  ...
  var renderSelectionLegend = function renderSelectionLegend() {
    ...
    return _react.default.createElement("svg", {
      ...
      x: 0.5,
      y: rowY(0) + 0.5
    }, handleAttribs)), _react.default.createElement("rect", _extends({
      x: selectionWidth - _AvailabilityGrid.SVG.DATE_RANGE_HANDLE_WIDTH,
      y: rowY(0) + 0.5
    }, handleAttribs)), _react.default.createElement("text", {
      className: classes.legendText,
      x: selectionLabelOffset,
      y: rowLabelY(0)
    }, "All sites selected"), _react.default.createElement("rect", {
      x: 0.5,
      y: rowY(1) + 1.5,
      width: selectionWidth,
      height: _AvailabilityGrid.SVG.CELL_HEIGHT - 2,
  ...
  }, renderVerticalCellLegend(), renderSelectionLegend()) : _react.default.createElement("div", {
    className: classes.legendContainer
