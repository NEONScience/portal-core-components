...
// MUI5+ now includes the unit in the spacing value,
...
/* eslint-disable max-len, @stylistic/max-len */ const baseTheme = createTheme({
    breakpoints: {
        values: {
            xs: 0,
            sm: 600,
...
/* eslint-enable max-len, @stylistic/max-len */ const theme = responsiveFontSizes(baseTheme);
