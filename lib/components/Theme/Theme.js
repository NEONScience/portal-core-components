...
const baseTheme = (0, _styles.createTheme)((0, _styles.adaptV4Theme)({
  breakpoints: {
    values: {
      xs: 0,
      sm: 600,
  ...
  overrides: {
    ...
    MuiSlider: {
      root: {
        '&.Mui-disabled': {
          ...
          [`& .${_Slider.sliderClasses.mark}`]: {
            backgroundColor: COLORS.GREY[300]
          },
          [`& .${_Slider.sliderClasses.markLabel}`]: {
            color: `${COLORS.GREY[300]} !important`
          },
          [`& .${_Slider.sliderClasses.markActive}`]: {
            color: `${COLORS.GREY[300]} !important`
          }
        }
      },
    ...
    MuiTablePagination: {
      toolbar: {
        [`& .${_IconButton.iconButtonClasses.root}`]: {
          borderRadius: '2px',
          padding: '4px',
          '& svg': {
            fontSize: '1.4rem'
        ...
        [`& .${_Typography.typographyClasses.caption}`]: {
          margin: '0px 8px'
        }
      }
    },
...
const theme = (0, _styles.responsiveFontSizes)(baseTheme);
  ...
  if ((!currentTheme || !currentTheme.isNeonTheme) && !isJsdom) {
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.StyledEngineProvider, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_styles.ThemeProvider, {
        theme: theme,
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_CssBaseline.default, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)(Component, {
          ...props
        })]
      })
    });
