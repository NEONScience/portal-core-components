...
require("@fontsource/inter/latin.css");
...
var COLOR_TEXT_PRIMARY = 'rgba(0, 0, 0, 0.9)'; // See all customizable Material UI theme keys here:
// https://material-ui.com/customization/default-theme/#explore

var baseTheme = (0, _styles2.createTheme)({
  breakpoints: {
    values: {
      xs: 0,
      sm: 600,
