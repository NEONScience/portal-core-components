...
var SelectSitesButton = function SelectSitesButton(props) {
  ...
  if (typeof selectionLimit === 'number') {
    selectSitesTitle = selectionLimit === 1 ? 'Select a site' : "Select ".concat(selectionLimit.toString(), " sites");
  }

  if (Array.isArray(selectionLimit)) {
    var min = selectionLimit[0],
        max = selectionLimit[1];
    selectSitesTitle = min === 1 ? "Select up to ".concat(max.toString(), " sites") : "Select ".concat(min.toString(), "-").concat(max.toString(), " sites");
  }
  ...
  }), label, icon ? /*#__PURE__*/_react.default.createElement(_Language.default, {
    className: classes.buttonIcon,
    fontSize: "small"
  }) : null)), /*#__PURE__*/_react.default.createElement(_Dialog.default, {
    fullScreen: true,
    open: dialogOpen,
  ...
  }, dialogTitle || selectSitesTitle), /*#__PURE__*/_react.default.createElement(_Tooltip.default, _extends({
