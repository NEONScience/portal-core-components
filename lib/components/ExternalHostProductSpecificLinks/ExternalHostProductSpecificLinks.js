...
function ExternalHostProductSpecificLinks(inProps) {
  ...
  const belowMd = (0, _useMediaQuery.default)(_Theme.default.breakpoints.down('ms'));
  ...
  const renderLinksByProduct = () => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("ul", {
      ...
      children: (externalHost.getProductLinks(productCode) || []).map(link => /*#__PURE__*/(0, _jsxRuntime.jsx)("li", {
        children: link.node
      }, link.key))
    });
  };
  const renderLinksBySite = () => {
    ...
    if (filterByAvailability) {
      availableSites = Object.fromEntries(siteCodes.map(siteCode => [siteCode, allSites[siteCode]]));
    }
      ...
      children: Object.keys(sitesByStateName).sort().map(stateName => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
            variant: "subtitle2",
            children: stateName
          }, stateName), /*#__PURE__*/(0, _jsxRuntime.jsx)("ul", {
            className: classes.ulLinkList,
            children: links.map(entry => /*#__PURE__*/(0, _jsxRuntime.jsx)("li", {
              children: entry.link
            }, entry.siteCode))
          })]
        }, stateName);
