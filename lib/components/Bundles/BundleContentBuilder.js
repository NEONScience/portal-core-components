...
var BundleContentBuilder = {
  ...
  buildDefaultTitleContent: function buildDefaultTitleContent(dataProduct, release) {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "This data product ", isRelease ? 'release ' : '', "is bundled into ", bundleParentLink);
  },
  buildDefaultSplitTitleContent: function buildDefaultSplitTitleContent(isRelease, terminalChar) {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "This data product ", isRelease ? 'release ' : '', "is a sub-product of the following data product", isRelease ? ' releases' : 's', "".concat(terminalChar));
  },
