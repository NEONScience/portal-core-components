...
const SiteMapFeature = props => {
  ...
  */
  const renderSite = function (siteCode) {
    ...
    return selectionActive ? /*#__PURE__*/_react.default.createElement("div", _extends({
      key: siteCode
    }, containerProps), internal) : /*#__PURE__*/_react.default.createElement(_Link.default, _extends({
      key: siteCode,
      variant: "caption",
      component: "button",
  ...
  */
  const renderPlotSize = function () {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      variant: "caption"
    }, loc.plotDimensions, !Number.isFinite(loc.plotSize) ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("br", null), `(${loc.plotSize.toFixed(0)}m\u00b2)`)));
  };
  ...
  */
  const renderPlotSamplingModules = function () {
    ...
    return /*#__PURE__*/_react.default.createElement(_Grid.default, {
      ...
      variant: "subtitle2"
    }, `Potential Sampling Modules${count}`), /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "caption"
  ...
  */
  const renderChildSites = boundaryKey => {
    ...
    return /*#__PURE__*/_react.default.createElement(_Grid.default, {
      ...
      variant: "subtitle2",
      gutterBottom: true
    }, `NEON Sites (${sites.size}${selectable || ''}):`), /*#__PURE__*/_react.default.createElement("div", null, [...sites].map(siteCode => renderSite(siteCode, selectionType === _SiteMapUtils.FEATURE_TYPES.SITES.KEY)))));
  };
  ...
  */
  const renderSitePopup = siteCode => {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactLeaflet.Popup, popupProps, renderPopupTitle(`${site.description} (${site.siteCode})`, false), selectionActive ? null : /*#__PURE__*/_react.default.createElement(_Link.default, {
      variant: "caption",
      component: "button",
      onClick: () => jumpTo(site.siteCode),
      style: {
      ...
      "data-selenium": "sitemap-map-popup-siteLink"
    }, markerIcon, `Jump to ${site.siteCode} on the map`), /*#__PURE__*/_react.default.createElement(_Grid.default, {
      container: true,
      spacing: 1,
      style: {
      ...
      variant: "caption"
    }, `${site.domainCode} - ${domain.name}`) : /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
      title: `Jump to ${site.domainCode} on the map`
    }, /*#__PURE__*/_react.default.createElement(_Link.default, {
      variant: "caption",
      component: "button",
      ...
      onClick: () => jumpTo(site.domainCode),
      "data-selenium": "sitemap-map-popup-domainLink"
    }, markerIcon, `${site.domainCode} - ${domain.name}`)))), renderActions());
  };
  ...
  */
  const renderDecommissionedSitePopup = siteCode => {
    ...
    const stateFieldTitle = site.stateCode === 'PR' ? 'Territory' : 'State';
    return /*#__PURE__*/_react.default.createElement(_reactLeaflet.Popup, popupProps, renderPopupTitle(`${site.siteName} (${site.siteCode})`, false), /*#__PURE__*/_react.default.createElement(_Link.default, {
      variant: "caption",
      component: "button",
      onClick: () => jumpTo(site.siteCode),
      style: {
      ...
      variant: "caption"
    }, `${site.domain} - ${domain.name}`) : /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
      ...
      "data-selenium": "sitemap-map-popup-domainLink"
    }, markerIcon, `${site.domain} - ${domain.name}`)))));
  };
  ...
  */
  ...
  const renderPopupFunctions = {
    ...
    DOMAINS: domainCode => {
      const title = !featureData[domainCode] ? null : /*#__PURE__*/_react.default.createElement("span", null, `NEON Domain ${domainCode.replace('D', '')} - ${featureData[domainCode].name}`);
      const jumpLink = selectionActive ? null : /*#__PURE__*/_react.default.createElement(_Link.default, {
        ...
        "data-selenium": "sitemap-map-popup-domainLink"
      }, markerIcon, `Jump to ${domainCode} on the map`);
    ...
    POUR_POINTS: siteCode => /*#__PURE__*/_react.default.createElement(_reactLeaflet.Popup, popupProps, renderPopupTitle(`${siteCode} Watershed Pour Point`), /*#__PURE__*/_react.default.createElement(_Grid.default, {
      container: true,
      spacing: 1
    ...
    STATES: stateCode => {
      const jumpLink = selectionActive ? null : /*#__PURE__*/_react.default.createElement(_Link.default, {
        ...
        "data-selenium": "sitemap-map-popup-stateLink"
      }, markerIcon, `Jump to ${stateCode} on the map`);
