...
var SiteMapFeature = function SiteMapFeature(props) {
  ...
  */
  ...
  var renderSitePopup = function renderSitePopup(siteCode) {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactLeaflet.Popup, popupProps, renderPopupTitle("".concat(site.description, " (").concat(site.siteCode, ")"), false), /*#__PURE__*/_react.default.createElement(_Link.default, {
      variant: "caption",
      component: "button",
      onClick: function onClick() {
        return jumpTo(site.siteCode);
  ...
  */
  ...
  var renderPopupFunctions = {
    ...
    DOMAINS: function DOMAINS(domainCode) {
      ...
      var jumpLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
        key: "jumpLink",
        variant: "caption",
        component: "button",
        onClick: function onClick() {
    ...
    STATES: function STATES(stateCode) {
      ...
      return renderBoundaryPopup(stateCode, featureData[stateCode] ? featureData[stateCode].name : stateCode, [jumpLink, renderChildSites]);
    },
