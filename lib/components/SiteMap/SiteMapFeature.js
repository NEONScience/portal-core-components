...
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); } /* eslint-disable no-underscore-dangle, jsx-a11y/anchor-is-valid */
...
const positionsArrayIsValid = function (positions) {
  ...
  return positions.every(p => Array.isArray(p) && (p.length === 2 && p.every(c => Number.isFinite(c)) || positionsArrayIsValid(p)));
};
