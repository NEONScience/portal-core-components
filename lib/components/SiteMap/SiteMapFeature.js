...
var SiteMapFeature = function SiteMapFeature(props) {
  ...
  */
  ...
  var renderPlotSize = function renderPlotSize() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      variant: "caption"
    }, loc.plotDimensions, !Number.isFinite(loc.plotSize) ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("br", null), "(".concat(loc.plotSize.toFixed(0), "m\xC2\xB2)"))));
  };
  /**
     Render: Plot Slope
  */
  ...
  var renderPlotSlope = function renderPlotSlope() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      variant: "subtitle2"
    }, "Plot Slope"), renderNumericalValue(loc.slopeAspect, 'Aspect', 'Â°', 2, 'Slope Aspect', right), renderNumericalValue(loc.slopeGradient, 'Gradient', '%', 2, 'Slope Gradient', right));
  };
  /**
  ...
  */
  ...
  var renderBoundaryArea = function renderBoundaryArea() {
    ...
    }, renderNumericalValue(areaKm2, null, 'kmÂ²', 2, 'Area (kmÂ²)'), areaAcres === null ? null : /*#__PURE__*/_react.default.createElement("div", {
      style: {
