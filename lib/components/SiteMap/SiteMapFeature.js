...
*/
const positionPopup = function (map) {
  let target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  let latlng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  let hideCloseButton = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  let isOpening = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  let isOverlay = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
