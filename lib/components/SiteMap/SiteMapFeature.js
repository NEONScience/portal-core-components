...
/* eslint-disable no-underscore-dangle, jsx-a11y/anchor-is-valid */ import React from 'react';
...
import { CircleMarker, FeatureGroup, Marker, Polygon, Polyline, Popup, useMap } from 'react-leaflet';
import SiteMapContext from './SiteMapContext';
import { getHref, isCoord, calculateLocationsInBounds, FEATURES, FEATURE_TYPES, NLCD_CLASSES, KM2_TO_ACRES, MAP_MOUSE_MODES, MANUAL_LOCATION_TYPES, HIGHLIGHT_STATUS, SELECTION_STATUS, SELECTION_PORTIONS, PLOT_SAMPLING_MODULES, UNSELECTABLE_MARKER_FILTER } from './SiteMapUtils';
...
*/ const positionPopup = (map, target = null, latlng = null, hideCloseButton = false, isOpening = false, isOverlay = false)=>{
    ...
    window.setTimeout(()=>{
        window.requestAnimationFrame(()=>{
            ...
            const { _container: containerNode, _containerLeft: containerLeft, _containerBottom: containerBottom, _tipContainer: tipNode } = popup;
...
const SiteMapFeature = (props)=>{
    ...
    const { name, nameSingular, type: featureType, description, style: featureStyle, featureShape, iconSvg, primaryIdOnly = false, amplifyHighlighted = false, parentDataFeatureKey } = feature;
    ...
    if (featureType === FEATURE_TYPES.GROUP.KEY) {
        return null;
    }
    /**
     Extract feature data from SiteMapContext state
  */ const { neonContextHydrated, manualLocationData, map: { bounds: mapBounds }, focusLocation: { current: focusLocation }, featureData: { [parentFeature ? parentFeature.type : featureType]: { [parentFeature ? parentFeature.KEY : featureKey]: featureData } } } = state;
    if (!neonContextHydrated || !featureData || !Object.keys(featureData)) {
        return null;
    }
    // Whether this feature can affect selection of items in the map
    const { active: selectableFeatureType, set: selectedItems, validSet: validItems, limit: selectionLimit, hideUnselectable } = state.selection;
    ...
    const markerIcon = /*#__PURE__*/ _jsx(MarkerIcon, {
        className: classes.markerIcon
    });
    /**
     Render: Popup Title with Feature Icon
  */ const renderPopupTitle = (title, withFeatureName = true)=>{
        const renderedTitle = withFeatureName ? /*#__PURE__*/ _jsxs("span", {
            children: [
                featureName,
                /*#__PURE__*/ _jsx("br", {}),
                title
  ...
  */ const renderNumericalValue = (value, label = null, unit = '', precision = 0, aria = null, right = false, parens = false)=>{
        ...
        const visibleValue = /*#__PURE__*/ _jsx(Typography, {
            variant: "caption",
        ...
        return !label ? visibleValue : /*#__PURE__*/ _jsxs("div", {
  ...
  */ const renderSite = (siteCode, ghostUnselectable = false)=>{
        ...
        if (selectionActive && selectionType === FEATURE_TYPES.SITES.KEY) {
            if (validItems && !validItems.has(siteCode)) {
                selectedIcon = /*#__PURE__*/ _jsx(UnselectableIcon, {
                    color: "disabled",
                    style: {
                        padding: '4px'
                    },
                ...
                selectedIcon = isSelected ? /*#__PURE__*/ _jsx(SelectedIcon, {
                    className: classes.popupSiteSelectedIcon,
                    color: "primary"
                }) : /*#__PURE__*/ _jsx(UnselectedIcon, {
                    className: classes.popupSiteSelectedIcon,
                    color: "disabled"
                });
            }
        }
        const internal = /*#__PURE__*/ _jsxs(_Fragment, {
            children: [
                selectedIcon,
                /*#__PURE__*/ _jsx("img", {
                    src: siteIcon,
        ...
        return selectionActive ? /*#__PURE__*/ _jsx("div", {
            ...containerProps,
            children: internal
        }, siteCode) : /*#__PURE__*/ _jsx(Link, {
            variant: "caption",
            component: "button",
  ...
  */ const renderLatLon = (latitude, longitude, right = false, renderSubtitle = false)=>{
        ...
        const coords = Number.isFinite(latitude) && Number.isFinite(longitude) ? /*#__PURE__*/ _jsxs("div", {
            className: classes[right ? 'endFlex' : 'startFlex'],
            "data-selenium": "sitemap-map-popup-coordinates",
            children: [
                /*#__PURE__*/ _jsx(CopyToClipboard, {
                    text: `${latitude.toFixed(5)} ${longitude.toFixed(5)}`,
                    children: selectionActive ? /*#__PURE__*/ _jsx(IconButton, {
                        ...iconButtonProps,
        ...
        return !renderSubtitle ? coords : /*#__PURE__*/ _jsxs("div", {
            style: {
  ...
  */ const renderElevation = (loc = {}, right = false)=>{
    ...
    /**
     Render: Plot Size
  */ const renderPlotSize = (loc = {})=>/*#__PURE__*/ _jsxs("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ _jsxs(Typography, {
                    ...
                    children: [
                        loc.plotDimensions,
                        !Number.isFinite(loc.plotSize) ? null : /*#__PURE__*/ _jsxs(_Fragment, {
                            children: [
                                /*#__PURE__*/ _jsx("br", {}),
    ...
    /**
     Render: Plot Slope
  */ const renderPlotSlope = (loc = {}, right = false)=>/*#__PURE__*/ _jsxs("div", {
            style: {
                textAlign: right ? 'right' : 'left'
            },
  ...
  */ const renderPlotSamplingModules = (loc = {})=>{
        ...
        return /*#__PURE__*/ _jsxs(Grid, {
            ...
            children: [
                ...
                /*#__PURE__*/ _jsx(Typography, {
                    variant: "caption",
                    children: !loc.samplingModules.length ? /*#__PURE__*/ _jsx("i", {
                        children: "none"
            ...
            children: [
                ...
                /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        ...
                        areaAcres === null ? null : /*#__PURE__*/ _jsx("div", {
                            style: {
  ...
  */ const renderChildSites = (boundaryKey)=>{
        ...
        let selectable = null;
        if (selectionActive && selectionType === FEATURE_TYPES.SITES.KEY) {
            const selectableSites = new Set([
                ...sites
            ].filter((siteCode)=>!validItems || validItems.has(siteCode)));
        ...
        return /*#__PURE__*/ _jsx(Grid, {
            ...
            children: !sites.size ? /*#__PURE__*/ _jsxs(_Fragment, {
                children: [
                    /*#__PURE__*/ _jsx(Typography, {
                        variant: "subtitle2",
                        gutterBottom: true,
                ...
                children: [
                    ...
                    /*#__PURE__*/ _jsx("div", {
                        children: [
                            ...sites
                        ].map((siteCode)=>renderSite(siteCode, selectionType === FEATURE_TYPES.SITES.KEY))
                    })
                ]
            })
        }, "childSites");
  ...
  */ const renderPlotSizeAndSlope = (loc)=>/*#__PURE__*/ _jsxs(React.Fragment, {
            children: [
                /*#__PURE__*/ _jsx(Grid, {
                    size: {
                        xs: 6
  ...
  */ const renderTowerDetails = (loc)=>/*#__PURE__*/ _jsxs(Grid, {
            size: {
                xs: 12
            },
                ...
                nlcd = /*#__PURE__*/ _jsxs(_Fragment, {
                    children: [
                        ...
                        /*#__PURE__*/ _jsx("div", {
                            ...
                            style: {
                                backgroundColor: NLCD_CLASSES[loc.nlcdClass].color
                            }
                        }),
                        /*#__PURE__*/ _jsx(Tooltip, {
                            title: tooltip,
            ...
            children: [
                ...
                /*#__PURE__*/ _jsxs(Grid, {
                    ...
                    children: [
                        ...
                        Array.isArray(additionalRows) ? additionalRows.map((row)=>typeof row === 'function' ? row(key) : row) : null,
  ...
  */ const renderRegionSelectionAction = (boundaryFeatureKey, boundaryKey)=>{
        ...
        const selectableSites = !validItems ? boundarySites : new Set([
            ...boundarySites
        ].filter((siteCode)=>validItems.has(siteCode)));
        ...
        const snackbarIconClassName = selectableCount ? 'addToSelectionSnackbarIcon' : 'unselectableSnackbarIcon';
        ...
        if (selectableCount) {
            ...
            actionText = /*#__PURE__*/ _jsxs(_Fragment, {
                children: [
                    "Click to ",
                    /*#__PURE__*/ _jsx("b", {
                        children: action
  ...
  */ const renderItemSelectionActionSnackbar = (item)=>{
        ...
        if (isSelectable) {
            ...
            if (selectionLimit === 1) {
                ...
                action = isSelected ? /*#__PURE__*/ _jsx("b", {
                    children: "Selected"
                }) : /*#__PURE__*/ _jsxs(_Fragment, {
                    children: [
                        "Click to ",
  ...
  */ const renderSitePopup = (siteCode)=>{
        ...
        const { [site.stateCode]: usState = {} } = state.featureData[FEATURE_TYPES.STATES.KEY][FEATURES.STATES.KEY];
        const { [site.domainCode]: domain = {} } = state.featureData[FEATURE_TYPES.DOMAINS.KEY][FEATURES.DOMAINS.KEY];
        ...
        return /*#__PURE__*/ _jsxs(Popup, {
            ...
            children: [
                ...
                selectionActive ? null : /*#__PURE__*/ _jsxs(Link, {
                    variant: "caption",
                    component: "button",
                    onClick: ()=>jumpTo(site.siteCode),
                    style: {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsxs(Grid, {
                            ...
                            children: [
                                ...
                                selectionActive ? /*#__PURE__*/ _jsx(Typography, {
                                    variant: "caption",
  ...
  */ const renderDecommissionedSitePopup = (siteCode)=>{
        const site = featureData[siteCode] || {};
        const { [site.state]: usState = {} } = state.featureData[FEATURE_TYPES.STATES.KEY][FEATURES.STATES.KEY];
        const { [site.domain]: domain = {} } = state.featureData[FEATURE_TYPES.DOMAINS.KEY][FEATURES.DOMAINS.KEY];
        const stateFieldTitle = site.stateCode === 'PR' ? 'Territory' : 'State';
        return /*#__PURE__*/ _jsxs(Popup, {
            ...popupProps,
            children: [
  ...
  */ const renderLocationPopupWithPlotSizeAndSlope = (siteCode, location)=>renderLocationPopup(siteCode, location, [
    ...
    const renderPopupFunctions = {
        ...
        DOMAINS: (domainCode)=>{
            const title = !featureData[domainCode] ? null : /*#__PURE__*/ _jsx("span", {
                children: `NEON Domain ${domainCode.replace('D', '')} - ${featureData[domainCode].name}`
            });
            const jumpLink = selectionActive ? null : /*#__PURE__*/ _jsxs(Link, {
                variant: "caption",
                component: "button",
            ...
            return renderBoundaryPopup(domainCode, title, [
                jumpLink,
                renderChildSites,
                selectingCurrentFeatureType ? renderItemSelectionActionSnackbar(domainCode) : renderRegionSelectionAction(FEATURES.DOMAINS.KEY, domainCode)
            ]);
        },
        ...
        POUR_POINTS: (siteCode)=>/*#__PURE__*/ _jsxs(Popup, {
                ...popupProps,
                children: [
        ...
        STATES: (stateCode)=>{
            ...
            return renderBoundaryPopup(stateCode, featureData[stateCode] ? featureData[stateCode].name : stateCode, [
                jumpLink,
                renderChildSites,
                selectingCurrentFeatureType ? renderItemSelectionActionSnackbar(stateCode) : renderRegionSelectionAction(FEATURES.DOMAINS.KEY, stateCode)
            ]);
        },
    ...
    const renderShape = (primaryId, secondaryId = null)=>{
        ...
        if (shapeData.geometry && shapeData.geometry.coordinates) {
            ...
            if (featureShape === 'Polygon') {
                ...
                if (isHighlighted) {
                    ...
                    const amplifyFeatureKeys = Object.keys(FEATURES).filter((k)=>FEATURES[k].amplifyHighlighted && FEATURES[k].matchLocationType);
                    const isFocusAmplifiable = amplifyFeatureKeys.find((amplifyFeatureKey)=>{
                        if (exists(state.focusLocation) && exists(state.focusLocation.data) && exists(state.focusLocation.data.type)) {
                            return new RegExp(FEATURES[amplifyFeatureKey].matchLocationType).test(state.focusLocation.data.type);
                        }
                        return false;
                    });
        ...
        if (featureShape === 'Marker' && isPoint(shapeData)) {
            ...
            if (state.map.zoomedIcons[featureKey] !== null) {
                ...
                const selection = isSelectable && isSelected && exists(baseIcon) && exists(baseIcon[SELECTION_STATUS.SELECTED]) ? SELECTION_STATUS.SELECTED : SELECTION_STATUS.UNSELECTED;
        ...
        switch(featureShape){
            case 'Marker':
                return marker;
            case 'Circle':
                return /*#__PURE__*/ _jsx(CircleMarker, {
                    title: key,
                    center: position,
            ...
            case 'Polygon':
                ...
                return state.map.mouseMode === MAP_MOUSE_MODES.AREA_SELECT ? /*#__PURE__*/ _jsx(Polygon, {
                    positions: positions,
                    ...shapeProps
                }, `${key}-polygon`) : /*#__PURE__*/ _jsx(Polygon, {
                    positions: positions,
                    ...shapeProps,
                    children: renderedPopup
                }, `${key}-polygon`);
  ...
  */ let renderableKeys = Object.keys(featureData);
    if (Array.isArray(manualLocationData) && manualLocationData.length) {
        const hasPrototypeSites = manualLocationData.some((ml)=>ml.manualLocationType === MANUAL_LOCATION_TYPES.PROTOTYPE_SITE);
        if (hasPrototypeSites && featureType === FEATURE_TYPES.SITES.KEY) {
            const allKeys = Object.keys(featureData);
            renderableKeys = manualLocationData.filter((ml)=>ml.manualLocationType === MANUAL_LOCATION_TYPES.PROTOTYPE_SITE && allKeys.includes(ml.siteCode)).map((ml)=>ml.siteCode);
        }
    }
    return /*#__PURE__*/ _jsx(FeatureGroup, {
        children: renderableKeys// Valid items should render above unselecatbles
        .sort((a)=>{
            if (!validItems) {
                return 0;
            }
        ...
        .sort((a)=>a === state.focusLocation.current ? 1 : -1).flatMap((keyA)=>{
            if ([
                ...
                FEATURE_TYPES.SAMPLING_POINTS.KEY
