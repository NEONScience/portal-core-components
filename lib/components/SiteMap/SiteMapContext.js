...
/** Context and Hook */
const Context = /*#__PURE__*/(0, _react.createContext)(_SiteMapUtils.DEFAULT_STATE);
const useSiteMapContext = () => {
  const hookResponse = (0, _react.useContext)(Context);
  if (hookResponse.length !== 2) {
    return [(0, _cloneDeep.default)(_SiteMapUtils.DEFAULT_STATE), () => {}];
  }
  return hookResponse;
};
...
const Provider = props => {
  ...
  */
  ...
  let initialState = (0, _cloneDeep.default)(_SiteMapUtils.DEFAULT_STATE);
