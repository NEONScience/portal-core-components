...
var deriveBoundarySelections = function deriveBoundarySelections(state) {
  ...
  var derive = function derive(featureKey) {
    ...
    Object.keys(state.featureData[_SiteMapUtils.FEATURE_TYPES.BOUNDARIES][featureKey]).forEach(function (boundaryCode) {
      ...
      selectedBoundarys[boundaryCode] = intersection.length === boundarySitesSet.size ? _SiteMapUtils.SELECTION_PORTIONS.TOTAL : _SiteMapUtils.SELECTION_PORTIONS.PARTIAL;
    });
...
var reducer = function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'updateSitesSelection':
      ...
      newState.selection[_SiteMapUtils.SELECTABLE_FEATURE_TYPES.SITES] = action.selection;
