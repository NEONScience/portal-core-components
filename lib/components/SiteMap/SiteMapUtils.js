...
exports.deriveFullObservatoryZoomLevel = exports.calculateLocationsInBounds = exports.boundsAreValid = exports.getDynamicAspectRatio = exports.hydrateNeonContextData = exports.getMapStateForManualLocationData = exports.findCentroid = exports.getMapStateForFocusLocation = exports.mapIsAtFocusLocation = exports.getZoomedIcons = exports.getZoomedIcon = exports.SITE_MAP_DEFAULT_PROPS = exports.SITE_MAP_PROP_TYPES = exports.DEFAULT_STATE = exports.OVERLAYS = exports.OVERLAY_GROUPS_BY_TITLE = exports.OVERLAY_GROUPS = exports.BASE_LAYERS_BY_TITLE = exports.BASE_LAYERS = exports.getHref = exports.calculateFeatureAvailability = exports.BOUNDARY_COLORS = exports.GRAPHQL_LOCATIONS_API_CONSTANTS = exports.FEATURES = exports.LOCATION_ICON_SVG_SHAPES = exports.NLCD_CLASSES = exports.PLOT_SAMPLING_MODULES = exports.FETCH_STATUS = exports.MAP_MOUSE_MODES = exports.VIEWS = exports.HIGHLIGHT_STATUS = exports.UNSELECTABLE_MARKER_FILTER = exports.SELECTION_STATUS = exports.SELECTION_PORTIONS = exports.FEATURE_DATA_SOURCES = exports.FEATURE_TYPES = exports.MANUAL_LOCATION_TYPES = exports.SITE_TERRAINS = exports.SORT_DIRECTIONS = exports.SITE_LOCATION_HIERARCHIES_MIN_ZOOM = exports.KM2_TO_ACRES = exports.MIN_TABLE_MAX_BODY_HEIGHT = exports.MIN_CONTAINER_HEIGHT = exports.OBSERVATORY_CENTER = exports.MAP_ZOOM_RANGE = void 0;
...
var getHref = function getHref(key) {
  ...
  switch (key) {
    ...
    case 'SITE_DETAILS':
      return "https://www.neonscience.org/field-sites/".concat(arg);
...
var getZoomedIcon = function getZoomedIcon() {
  ...
  var round = function round(x) {
    return Number.parseFloat(x.toFixed(3), 10);
  };
...
var getPhantomLeafletMap = function getPhantomLeafletMap(state) {
  ...
  var map = new PhantomMapClass(element, {
  ...
  if (Array.isArray(state.manualLocationData) && state.manualLocationData.length) {
    state.manualLocationData.forEach(function (manualLocation) {
      ...
      if (manualLocation.manualLocationType === MANUAL_LOCATION_TYPES.PROTOTYPE_SITE && siteCode && !newState.sites[siteCode]) {
        ...
        newState.featureData[featureType][featureKey][siteCode].domainCode = manualLocation.domain; // eslint-disable-next-line max-len
