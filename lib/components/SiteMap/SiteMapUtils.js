...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // SVGs for all map icons
...
var KM2_TO_ACRES = 247.10538146717;
...
var LOCATION_BOUNDS_SAMPLING_MAX = 10000;
...
var UNSELECTABLE_MARKER_FILTER = 'sepia(0.8) contrast(0.3) brightness(1.35)';
...
var calculateFeatureAvailability = function calculateFeatureAvailability(state) {
  var featureIsAvailable = function featureIsAvailable(feature) {
    ...
    var hasMaxZoom = typeof feature.maxZoom === 'number';
