...
exports.zoomIsValid = exports.parseManualLocationFeatureData = exports.mapIsAtFocusLocation = exports.isCoord = exports.hydrateNeonContextData = exports.getZoomedIcons = exports.getZoomedIcon = exports.getPhantomLeafletMap = exports.getMapStateForManualLocationData = exports.getMapStateForFocusLocation = exports.getHref = exports.getDynamicAspectRatio = exports.getDefaultState = exports.findCentroid = exports.determineMapStatus = exports.deriveFullObservatoryZoomLevel = exports.centerIsValid = exports.calculateLocationsInBounds = exports.calculateFeatureAvailability = exports.boundsAreValid = exports.VIEWS = exports.UNSELECTABLE_MARKER_FILTER = exports.SORT_DIRECTIONS = exports.SITE_TERRAINS = exports.SITE_MAP_PROP_TYPES = exports.SITE_MAP_DEFAULT_PROPS = exports.SITE_LOCATION_HIERARCHIES_MIN_ZOOM = exports.SELECTION_STATUS = exports.SELECTION_PORTIONS = exports.PLOT_SAMPLING_MODULES = exports.OVERLAY_GROUPS_BY_TITLE = exports.OVERLAY_GROUPS = exports.OVERLAYS = exports.OBSERVATORY_CENTER = exports.NLCD_CLASSES = exports.MIN_TABLE_MAX_BODY_HEIGHT = exports.MIN_CONTAINER_HEIGHT = exports.MAP_ZOOM_RANGE = exports.MAP_ZOOM_DEFAULT = exports.MAP_STATE_STATUS_TYPE = exports.MAP_MOUSE_MODES = exports.MANUAL_LOCATION_TYPES = exports.LOCATION_ICON_SVG_SHAPES = exports.LOCATION_BOUNDS_SAMPLING_MAX = exports.LEAFLET_ATTR_PREFIX = exports.KM2_TO_ACRES = exports.HIGHLIGHT_STATUS = exports.GRAPHQL_LOCATIONS_API_CONSTANTS = exports.FETCH_STATUS = exports.FEATURE_TYPES = exports.FEATURE_DATA_SOURCES = exports.FEATURES = exports.BOUNDARY_COLORS = exports.BASE_LAYERS_BY_TITLE = exports.BASE_LAYERS = void 0;
...
const MAP_ZOOM_DEFAULT = exports.MAP_ZOOM_DEFAULT = 2;
...
const LOCATION_BOUNDS_SAMPLING_MAX = exports.LOCATION_BOUNDS_SAMPLING_MAX = 10_000;
...
const LEAFLET_ATTR_PREFIX = exports.LEAFLET_ATTR_PREFIX = `
...
const LOCATION_ICON_SVG_SHAPES = exports.LOCATION_ICON_SVG_SHAPES = {
  CIRCLE: {
    ...
    shadow: {
      [HIGHLIGHT_STATUS.NONE]: {
        svg: _iconShapeCircleShadow.default.src,
        size: [100, 100],
        anchor: [50, 50]
      },
      [HIGHLIGHT_STATUS.HIGHLIGHT]: {
        svg: _iconShapeCircleHighlight.default.src,
        size: [120, 120],
        anchor: [60, 60]
      },
      [HIGHLIGHT_STATUS.SELECT]: {
        svg: _iconShapeCircleSelect.default.src,
        size: [120, 120],
        anchor: [60, 60]
      }
    }
  ...
  DIAMOND: {
    ...
    shadow: {
      [HIGHLIGHT_STATUS.NONE]: {
        svg: _iconShapeDiamondShadow.default.src,
        size: [124, 124],
        anchor: [62, 62]
      },
      [HIGHLIGHT_STATUS.HIGHLIGHT]: {
        svg: _iconShapeDiamondHighlight.default.src,
        size: [144, 144],
        anchor: [72, 72]
      },
      [HIGHLIGHT_STATUS.SELECT]: {
        svg: _iconShapeDiamondSelect.default.src,
        size: [144, 144],
        anchor: [72, 72]
      }
    }
  ...
  HOMEPLATE: {
    ...
    shadow: {
      [HIGHLIGHT_STATUS.NONE]: {
        svg: _iconShapeHomeplateShadow.default.src,
        size: [101, 111],
        anchor: [50.5, 55.5]
      },
      [HIGHLIGHT_STATUS.HIGHLIGHT]: {
        svg: _iconShapeHomeplateHighlight.default.src,
        size: [121, 131],
        anchor: [60.5, 65.5]
      },
      [HIGHLIGHT_STATUS.SELECT]: {
        svg: _iconShapeHomeplateSelect.default.src,
        size: [121, 131],
        anchor: [60.5, 65.5]
      }
    }
  ...
  SQUARE: {
    ...
    shadow: {
      [HIGHLIGHT_STATUS.NONE]: {
        svg: _iconShapeSquareShadow.default.src,
        size: [94, 94],
        anchor: [47, 47]
      },
      [HIGHLIGHT_STATUS.HIGHLIGHT]: {
        svg: _iconShapeSquareHighlight.default.src,
        size: [114, 114],
        anchor: [57, 57]
      },
      [HIGHLIGHT_STATUS.SELECT]: {
        svg: _iconShapeSquareSelect.default.src,
        size: [114, 114],
        anchor: [57, 57]
      }
    }
...
const FEATURES = exports.FEATURES = {
  ...
  POUR_POINTS: {
    ...
    parent: 'AQUATIC_WATERSHEDS',
    featureShape: 'Marker',
    iconSvg: _iconPourPoint.default.src,
  ...
  TOWERS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.8,
    iconSvg: _iconTower.default.src,
  ...
  MEGAPITS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.8,
    iconSvg: _iconMegapit.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.DIAMOND.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  // TOWER_PLOTS Group
  ...
  TOWER_PHENOLOGY_PLOTS: {
    ...
    focusZoom: 16,
    iconScale: 1.5,
    iconSvg: _iconTowerPhenologyPlot.default.src,
  ...
  TOWER_BASE_PLOTS: {
    ...
    minZoom: 14,
    focusZoom: 18,
    iconSvg: _iconTowerBasePlot.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  TOWER_SOIL_PLOTS: {
    ...
    focusZoom: 18,
    iconScale: 0.7,
    iconSvg: _iconTowerSoilPlot.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  ...
  DISTRIBUTED_BIRD_GRIDS: {
    ...
    iconScale: 1.8,
    focusZoom: 16,
    iconSvg: _iconDistributedBirdGrid.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  DISTRIBUTED_MAMMAL_GRIDS: {
    ...
    iconScale: 1.4,
    focusZoom: 17,
    iconSvg: _iconDistributedMammalGrid.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  DISTRIBUTED_BASE_PLOTS: {
    ...
    iconScale: 1.2,
    focusZoom: 17,
    iconSvg: _iconDistributedBasePlot.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  DISTRIBUTED_TICK_PLOTS: {
    ...
    iconScale: 1.2,
    focusZoom: 17,
    iconSvg: _iconDistributedTickPlot.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  },
  DISTRIBUTED_MOSQUITO_POINTS: {
    ...
    iconSvg: _iconDistributedMosquitoPoint.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    featureShape: 'Marker',
    focusZoom: 18,
    siteTerrain: SITE_TERRAINS.TERRESTRIAL
  ...
  AQUATIC_BENCHMARKS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.3,
    iconSvg: _iconBenchmark.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.DIAMOND.KEY,
  ...
  AQUATIC_RIPARIAN_ASSESSMENTS: {
    ...
    featureShape: 'Marker',
    iconSvg: _iconRiparianAssessment.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_WET_DEPOSITION_POINTS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.2,
    iconSvg: _iconWetDepositionPoint.default.src,
  ...
  AQUATIC_GROUNDWATER_WELLS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.2,
    iconSvg: _iconGroundwaterWell.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_METEOROLOGICAL_STATIONS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.5,
    iconSvg: _iconMeteorologicalStation.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_DISCHARGE_POINTS: {
    ...
    parent: 'AQUATIC_OBSERVATIONAL_SAMPLING',
    featureShape: 'Marker',
    iconSvg: _iconDischargePoint.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_FISH_POINTS: {
    ...
    parent: 'AQUATIC_OBSERVATIONAL_SAMPLING',
    featureShape: 'Marker',
    iconSvg: _iconFishPoint.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_PLANT_TRANSECTS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.3,
    iconSvg: _iconPlantTransect.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_SEDIMENT_POINTS: {
    ...
    parent: 'AQUATIC_OBSERVATIONAL_SAMPLING',
    featureShape: 'Marker',
    iconSvg: _iconSedimentPoint.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_STAFF_GAUGES: {
    ...
    parent: 'AQUATIC_AUTOMATED_INSTRUMENTS',
    featureShape: 'Marker',
    iconSvg: _iconStaffGauge.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_SENSOR_STATIONS: {
    ...
    featureShape: 'Marker',
    iconScale: 1.1,
    iconSvg: _iconSensorStation.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    siteTerrain: SITE_TERRAINS.AQUATIC
  },
  AQUATIC_BUOYS: {
  ...
  TERRESTRIAL_CORE_SITES: {
    ...
    featureShape: 'Marker',
    iconScale: 1,
    iconSvg: _iconSiteCoreTerrestrial.default.src,
    iconSelectedSvg: _iconSiteCoreTerrestrialSelected.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    maxZoom: 9
  },
  TERRESTRIAL_GRADIENT_SITES: {
    ...
    featureShape: 'Marker',
    iconScale: 1,
    iconSvg: _iconSiteGradientTerrestrial.default.src,
    iconSelectedSvg: _iconSiteGradientTerrestrialSelected.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    maxZoom: 9
  },
  AQUATIC_CORE_SITES: {
    ...
    featureShape: 'Marker',
    iconScale: 1,
    iconSvg: _iconSiteCoreAquatic.default.src,
    iconSelectedSvg: _iconSiteCoreAquaticSelected.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.SQUARE.KEY,
    maxZoom: 9
  },
  AQUATIC_GRADIENT_SITES: {
    ...
    featureShape: 'Marker',
    iconScale: 1,
    iconSvg: _iconSiteGradientAquatic.default.src,
    iconSelectedSvg: _iconSiteGradientAquaticSelected.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    maxZoom: 9
  },
  DECOMMISSIONED_SITES: {
    ...
    featureShape: 'Marker',
    iconScale: 1,
    iconSvg: _iconSiteDecommissioned.default.src,
    iconSelectedSvg: _iconSiteDecommissioned.default.src,
    iconShape: LOCATION_ICON_SVG_SHAPES.CIRCLE.KEY,
    maxZoom: 19
  }
};
...
const getHref = (key, arg = null) => {
  ...
  switch (key) {
    case 'EXPLORE_SAMPLE_PRODUCTS_BY_SITE':
      return `${EXPLORE_SAMPLE_PRODUCTS_BASE}?datasetid=${_biorepoDatasets.default.datasets.find(item => item.name === String(arg))?.datasetID || ''}`;
...
const MAP_STATE_STATUS_TYPE = exports.MAP_STATE_STATUS_TYPE = {
  INIT: 'INIT',
  READY: 'READY'
};
const DEFAULT_STATE = {
...
DEFAULT_STATE.filters.features.available = {
  ...availabilityState.filters.features.available
};
...
const SelectionLimitPropType = (props, propName) => {
  ...
  if (typeof prop === 'number') {
    if (!Number.isInteger(prop) || prop < 1) {
      return new Error(`When setting ${propName} as a number it must be an integer greater than 0`);
    }
    return null;
  }
  if (Array.isArray(prop)) {
    if (prop.length !== 2 || !prop.every(x => Number.isInteger(x) && x > 0) || prop[0] >= prop[1]) {
      return new Error(`When setting ${propName} as an array it must contain exactly two distinct non-zero positive integers in ascending order (e.g. [2, 5])`);
    }
    return null;
  }
  return new Error(`${propName} must be null, a positive non-zero integer, or an array of two ascending non-zero positive integers.`);
};
...
const zoomIsValid = zoom => Number.isInteger(zoom) && zoom >= MAP_ZOOM_RANGE[0] && zoom <= MAP_ZOOM_RANGE[1];
exports.zoomIsValid = zoomIsValid;
const centerIsValid = center => Array.isArray(center) && center.length === 2 && center.every(v => typeof v === 'number' && !Number.isNaN(v));
exports.centerIsValid = centerIsValid;
...
const determineMapStatus = state => {
  if (!state.map) {
    return false;
  }
  const isMapReady = zoomIsValid(state.map.zoom) && centerIsValid(state.map.center) && boundsAreValid(state.map.bounds);
  return isMapReady ? MAP_STATE_STATUS_TYPE.READY : MAP_STATE_STATUS_TYPE.INIT;
};
...
exports.determineMapStatus = determineMapStatus;
const getZoomedIcon = (featureKey = null, zoom = 3, highlight = HIGHLIGHT_STATUS.NONE, selection = SELECTION_STATUS.UNSELECTED) => {
  const feature = FEATURES[featureKey] || {};
  const featureHasIcon = feature && feature.iconSvg && feature.iconShape && LOCATION_ICON_SVG_SHAPES[feature.iconShape];
  let iconUrl = featureHasIcon ? feature.iconSvg : _iconPlaceholder.default.src;
...
const hydrateNeonContextData = (state, neonContextData) => {
  ...
  Object.keys(neonContextData.sites).forEach(siteCode => {
    newState.sites[siteCode] = {
      ...neonContextData.sites[siteCode]
    };
...
const getDynamicAspectRatio = (unusableVerticalSpace = 0) => {
...
const calculateLocationsInBounds = (locations,
// Keyed object of locations (e.g. sites)
bounds = null,
// Leaflet LatLngBounds object
extendMap = false,
// Boolean, whether or not to extend the map bounds by 50% on each dimension
...
const deriveFullObservatoryZoomLevel = map => {
