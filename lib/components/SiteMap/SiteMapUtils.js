...
var _iconPlaceholder = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-placeholder.svg"));

var _iconShapeCircleShadow = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-shadow.svg"));

var _iconShapeCircleSelect = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-select.svg"));

var _iconShapeCircleHighlight = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-highlight.svg"));

var _iconShapeDiamondShadow = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-shadow.svg"));

var _iconShapeDiamondSelect = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-select.svg"));

var _iconShapeDiamondHighlight = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-highlight.svg"));

var _iconShapeHomeplateShadow = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-shadow.svg"));

var _iconShapeHomeplateSelect = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-select.svg"));

var _iconShapeHomeplateHighlight = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-highlight.svg"));

var _iconShapeSquareShadow = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-shadow.svg"));

var _iconShapeSquareSelect = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-select.svg"));

var _iconShapeSquareHighlight = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-highlight.svg"));

var _iconSiteCoreTerrestrial = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-terrestrial.svg"));

var _iconSiteCoreTerrestrialSelected = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-terrestrial-selected.svg"));

var _iconSiteCoreAquatic = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-aquatic.svg"));

var _iconSiteCoreAquaticSelected = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-aquatic-selected.svg"));

var _iconSiteGradientTerrestrial = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-terrestrial.svg"));

var _iconSiteGradientTerrestrialSelected = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-terrestrial-selected.svg"));

var _iconSiteGradientAquatic = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-aquatic.svg"));

var _iconSiteGradientAquaticSelected = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-aquatic-selected.svg"));

var _iconSiteDecommissioned = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-decommissioned.svg"));

var _iconBenchmark = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-benchmark.svg"));

var _iconBuoy = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-buoy.svg"));

var _iconDischargePoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-discharge-point.svg"));

var _iconDistributedBasePlot = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-base-plot.svg"));

var _iconDistributedBirdGrid = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-bird-grid.svg"));

var _iconDistributedMammalGrid = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-mammal-grid.svg"));

var _iconDistributedMosquitoPoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-mosquito-point.svg"));

var _iconDistributedTickPlot = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-tick-plot.svg"));

var _iconFishPoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-fish-point.svg"));

var _iconGroundwaterWell = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-groundwater-well.svg"));

var _iconHut = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-hut.svg"));

var _iconPourPoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-pour-point.svg"));

var _iconMegapit = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-megapit.svg"));

var _iconMeteorologicalStation = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-meteorological-station.svg"));

var _iconPlantTransect = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-plant-transect.svg"));

var _iconRiparianAssessment = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-riparian-assessment.svg"));

var _iconSedimentPoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-sediment-point.svg"));

var _iconSensorStation = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-sensor-station.svg"));

var _iconStaffGauge = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-staff-gauge.svg"));

var _iconTower = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower.svg"));

var _iconTowerBasePlot = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-base-plot.svg"));

var _iconTowerPhenologyPlot = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-phenology-plot.svg"));

var _iconTowerSoilPlot = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-soil-plot.svg"));

var _iconWetDepositionPoint = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-wet-deposition-point.svg"));
...
var _shadow, _shadow2, _shadow3, _shadow4, _initialized, _availableFeatureType, _derived;
...
var round = function round(x) {
  return Number.parseFloat(x.toFixed(4), 10);
};
...
exports.MANUAL_LOCATION_TYPES = MANUAL_LOCATION_TYPES;
var FEATURE_TYPES = {
  SITES: {
    unit: 'site',
    units: 'sites',
...
Object.keys(FEATURE_TYPES).forEach(function (key) {
...
var calculateFeatureAvailability = function calculateFeatureAvailability(state) {
  var featureIsAvailable = function featureIsAvailable(feature) {
    ...
    var hasDecomissionedSites = !!(state.manualLocationData || []).filter(function (manualLocation) {
      return manualLocation.manualLocationType === MANUAL_LOCATION_TYPES.PROTOTYPE_SITE && !state.sites[manualLocation.siteCode];
    }).length;
...
var getHref = function getHref(key) {
  ...
  var EXPLORE_DATA_PRODUCTS_BASE = _RouteService.default.getDataProductExplorePath();
...
var DEFAULT_STATE = {
  view: {
    current: null,
    initialized: (_initialized = {}, _defineProperty(_initialized, VIEWS.MAP, false), _defineProperty(_initialized, VIEWS.TABLE, false), _initialized)
  },
  ...
  table: {
    ...
    availableFeatureTypes: (_availableFeatureType = {}, _defineProperty(_availableFeatureType, FEATURE_TYPES.SITES.KEY, false), _defineProperty(_availableFeatureType, FEATURE_TYPES.LOCATIONS.KEY, false), _availableFeatureType),
    fullHeight: false,
    maxBodyHeight: null,
  ...
  featureData: Object.fromEntries(Object.keys(FEATURE_TYPES).filter(function (featureType) {
    return featureType !== FEATURE_TYPES.SAMPLING_POINTS.KEY;
...
DEFAULT_STATE.featureDataFetches[FEATURE_DATA_SOURCES.REST_LOCATIONS_API][FEATURE_TYPES.SITE_LOCATION_HIERARCHIES.KEY] = {}; // Initialize feature availability
...
var SITE_MAP_PROP_TYPES = {
  ...
  // Selection props
  selection: _propTypes.default.oneOf(Object.keys(FEATURE_TYPES).filter(function (k) {
    return FEATURE_TYPES[k].selectable;
  })),
...
var getZoomedIcon = function getZoomedIcon() {
  ...
  var _ref = shadow[highlight] || {},
      shadowUrl = _ref.svg;

  var _ref2 = shadow[highlight] || {},
      shadowSize = _ref2.size,
      shadowAnchor = _ref2.anchor; // Adjust icon, size, and anchor if selected (and a different "selected" icon is available)
  ...
  var scale = Math.max((minScale + baseScale * (maxScale - minScale)) * iconScale, minScale);
  var iconProps = {
    iconUrl: iconUrl,
...
var getZoomedIcons = function getZoomedIcons(zoom) {
  var featureTypes = [FEATURE_TYPES.LOCATIONS.KEY, FEATURE_TYPES.SITES.KEY, FEATURE_TYPES.OTHER.KEY];
  var icons = {};
...
var getPhantomLeafletMap = function getPhantomLeafletMap(state) {
  ...
  var x = widthReference || 400;
  var y = widthReference * aspectRatio || 300;

  var PhantomMapClass = _leaflet.default.Map.extend({
    includes: {
      getSize: function getSize() {
        return new _leaflet.default.Point(x, y);
      }
    }
  });
...
var mapIsAtFocusLocation = function mapIsAtFocusLocation() {
...
var getMapStateForFocusLocation = function getMapStateForFocusLocation() {
  ...
  var _ref3 = focusLocation.data || {},
      _ref3$type = _ref3.type,
      type = _ref3$type === void 0 ? '' : _ref3$type,
      latitude = _ref3.latitude,
      longitude = _ref3.longitude; // No latitude/longitude: previous map state
  ...
  newState.map.zoom = null; // Everything else (valid location with a center)
  ...
  if (type === 'SITE') {
    ...
    var domainsData = state.featureData[FEATURE_TYPES.DOMAINS.KEY][FEATURES.DOMAINS.KEY];
    newState.map.zoom = (domainsData[current] || {}).zoom || null;
  } else if (type === 'STATE') {
    var statesData = state.featureData[FEATURE_TYPES.STATES.KEY][FEATURES.STATES.KEY];
...
var findCentroid = function findCentroid() {
  ...
  if (coords.length === 1) {
    return _toConsumableArray(coords[0]);
  }
  ...
  coords.forEach(function (coord) {
    var rLat = coord[0] * (Math.PI / 180);
    var rLng = coord[1] * (Math.PI / 180);
  ...
  c.y /= coords.length;
  c.z /= coords.length;
  var cLng = Math.atan2(c.y, c.x);
  var cHyp = Math.sqrt(Math.pow(c.x, 2) + Math.pow(c.y, 2));
  var cLat = Math.atan2(c.z, cHyp);
  return [round(cLat * (180 / Math.PI)), round(cLng * (180 / Math.PI))];
};

exports.findCentroid = findCentroid;

var getMapStateForManualLocationData = function getMapStateForManualLocationData(state) {
  var previousMapState = state.map,
  ...
  var locationCenters = manualLocationData.reduce(function (acc, cur) {
  ...
  if (locationCenters.length === 1) {
    newState.map.center = _toConsumableArray(locationCenters[0]);
    newState.map.zoom = 6;
  } else {
    newState.map.center = findCentroid(locationCenters);
    var phantomZoomMap = getPhantomLeafletMap(newState);
...
var parseManualLocationFeatureData = function parseManualLocationFeatureData(state) {
  ...
  state.manualLocationData.forEach(function (manualLocation) {
    var siteCode = manualLocation.siteCode;

    if (manualLocation.manualLocationType === MANUAL_LOCATION_TYPES.PROTOTYPE_SITE && siteCode && !newState.sites[siteCode]) {
      var featureType = FEATURE_TYPES.SITES.KEY;
      var featureKey = FEATURES.DECOMMISSIONED_SITES.KEY;
      newState.featureData[featureType][featureKey][siteCode] = manualLocation; // Harmonize some values
...
var hydrateNeonContextData = function hydrateNeonContextData(state, neonContextData) {
  ...
  Object.keys(neonContextData.sites).forEach(function (siteCode) {
    ...
    var featureKey = Object.keys(FEATURES).filter(function (key) {
      return FEATURES[key].type === FEATURE_TYPES.SITES.KEY;
    }).find(function (key) {
...
var calculateLocationsInBounds = function calculateLocationsInBounds(locations) {
...
var deriveFullObservatoryZoomLevel = function deriveFullObservatoryZoomLevel(mapRef) {
  ...
  if (_typeof(mapRef) !== 'object' || mapRef === null || !mapRef.current) {
