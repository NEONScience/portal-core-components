...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  return {
    ...
    areaSelection: {
      position: 'absolute',
      pointerEvents: 'none',
      border: "3px dotted ".concat(theme.colors.LIGHT_BLUE[500]),
...
var SiteMapLeaflet = function SiteMapLeaflet() {
  ...
  var _useId = (0, _reactIdGenerator.useId)(),
      ...
      mapInstanceId = _useId2[0]; // State, Dispatch, and other stuff from SiteMapContext
  ...
  */
  ...
  (0, _react.useLayoutEffect)(function () {
    var timeout = window.setTimeout(function () {
      if (!mapRef.current || !mapRef.current.leafletElement || !mapRef.current.leafletElement._panes || !mapRef.current.leafletElement._layers || !state.selection.active || !state.selection.validSet || state.view.current !== _SiteMapUtils.VIEWS.MAP || state.selection.active !== _SiteMapUtils.FEATURE_TYPES.SITES.KEY) {
        return;
      }
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    if (!mapRef || !mapRef.current || !mapRef.current.leafletElement || state.view.current !== _SiteMapUtils.VIEWS.MAP) {
      return;
    }
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    window.setTimeout(function () {
      ...
      paths.filter(function (path) {
        ...
        path.setAttributeNS(null, 'mask', "url(".concat(baseId, ")")); // React Leaflet Polygon doesn't afford arbitrary styling and we use the className for
