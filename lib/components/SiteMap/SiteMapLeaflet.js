...
const useStyles = (0, _styles.makeStyles)(theme => ({
  map: {
    ...
    '& div.rlglc-wrap': {
      ...
      '& .rlglc-active': {
        border: `1px solid ${_Theme.default.palette.grey[300]}`
      },
...
const SiteMapLeaflet = () => {
  ...
  */
  ...
  const renderGroupedLayerControl = () => {
    ...
    return /*#__PURE__*/_react.default.createElement(_LeafletGroupedLayerControl.default, {
      position: "topleft",
  ...
  */
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactLeaflet.MapContainer, _extends({
    ...
    tap: false
  }, mouseModeProps), /*#__PURE__*/_react.default.createElement(LeafletMapManager, null), /*#__PURE__*/_react.default.createElement(_reactLeaflet.ScaleControl, {
    imperial: true,
    metric: true,
    updateWhenIdle: true
  }), renderBaseLayer(), Array.from(state.map.overlays).map(renderOverlay), renderGroupedLayerControl(), Object.keys(_SiteMapUtils.FEATURES).filter(key => state.filters.features.available[key]).filter(key => state.filters.features.visible[key]).map(key => /*#__PURE__*/_react.default.createElement(_SiteMapFeature.default, {
    key: key,
    featureKey: key
