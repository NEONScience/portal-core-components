...
exports.default = exports.parseLocationHierarchy = void 0;
...
var domainIsValid = function domainIsValid(domainString) {
  ...
  var domainNumber = Number.parseInt(domainTest[1]);
...
var fetchHierarchy = function fetchHierarchy(event) {
...
self.addEventListener("message", fetchHierarchy); // Must have a default export for production build

var _default = fetchHierarchy;
