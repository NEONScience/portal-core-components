  ...
  const commonColumns = {
    site: {
      ...
      render: row => {
        ...
        }, renderFeatureIcon(featureKey, unselectable), /*#__PURE__*/_react.default.createElement("span", null, `${description || 'Unnamed Site'} (${siteCode})`)), /*#__PURE__*/_react.default.createElement("div", {
  ...
  if (focus === _SiteMapUtils.FEATURE_TYPES.LOCATIONS.KEY) {
    columns = [{
      ...
      render: row => {
        ...
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderCaptionString(`${plotDimensions}`, 'Plot Size (Dimensions)'), Number.isFinite(plotSize) ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("br", null), renderCaptionString(`(${plotSize.toFixed(0)}m\u00b2)`, 'Plot Size (Area)')) : null);
      },
      csvRender: row => {
        const {
          plotDimensions,
