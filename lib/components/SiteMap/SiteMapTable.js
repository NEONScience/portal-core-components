...
var SiteMapTable = function SiteMapTable() {
  ...
  */
  ...
  var initialRows = (0, _SiteMapUtils.calculateLocationsInMap)(locations, state.map.bounds);
  ...
  var commonColumns = {
    site: {
      ...
      render: function render(row) {
        ...
        }, renderFeatureIcon(featureKey, unselectable), /*#__PURE__*/_react.default.createElement("span", null, "".concat(site.description, " (").concat(site.siteCode, ")"))), /*#__PURE__*/_react.default.createElement("div", {
