...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  ...
  return {
    ...
    toolbarContainer: (_toolbarContainer = {
      ...
      backgroundColor: theme.palette.grey[50]
    }), _defineProperty(_toolbarContainer, '& div.MuiToolbar-root > div:not(:nth-last-child(-n+2))', {
      display: 'none'
      ...
      render: function render(row) {
        ...
        return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Link.default, {
          ...
          onClick: function onClick() {
            return jumpTo(row.siteCode);
          },
          title: "Click to view ".concat(row.siteCode, " on the map")
        }, renderFeatureIcon(featureKey, unselectable), /*#__PURE__*/_react.default.createElement("span", null, "".concat(site.description || 'Unnamed Site', " (").concat(site.siteCode, ")"))), /*#__PURE__*/_react.default.createElement("div", {
    ...
    state: {
      ...
      render: function render(row) {
        ...
        return !usstate ? null : /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Link.default, {
          ...
          className: classes.linkButton,
          onClick: function onClick() {
            return jumpTo(row.stateCode);
          },
          title: "Click to view ".concat(row.stateCode, " on the map")
        }, usstate.name));
      }
    },
    coordinates: {
      ...
      searchable: false,
      render: function render(row) {
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderCaptionString(row.latitude.toFixed(5), 'Latitude'), /*#__PURE__*/_react.default.createElement("br", null), renderCaptionString(row.longitude.toFixed(5), 'Longitude'));
      }
    },
    latitude: {
      field: 'latitude',
      ...
      filtering: false,
      render: function render(row) {
        return renderCaptionString(row.latitude.toFixed(5), 'Latitude');
      }
    },
    longitude: {
      field: 'longitude',
      ...
      filtering: false,
      render: function render(row) {
        return renderCaptionString(row.longitude.toFixed(5), 'Longitude');
      }
    }
  };
  /**
    ...
    columns = [{
      ...
      render: function render(row) {
        return /*#__PURE__*/_react.default.createElement(_Link.default, {
          ...
          title: "View ".concat(row.name, " on map")
        }, row.name);
      }
    }, {
      // Location Type
      ...
      render: function render(row) {
        ...
        if (!_SiteMapUtils.NLCD_CLASSES[row.nlcdClass]) {
          return renderCaptionString(row.nlcdClass, 'NLCD Class');
        }

        var _NLCD_CLASSES$row$nlc = _SiteMapUtils.NLCD_CLASSES[row.nlcdClass],
            title = _NLCD_CLASSES$row$nlc.name,
            backgroundColor = _NLCD_CLASSES$row$nlc.color;
        return /*#__PURE__*/_react.default.createElement("div", {
      ...
      filtering: false,
      render: function render(row) {
        return row.plotDimensions ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderCaptionString("".concat(row.plotDimensions), 'Plot Size (Dimensions)'), Number.isFinite(row.plotSize) ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("br", null), renderCaptionString("(".concat(row.plotSize.toFixed(0), "m\xB2)"), 'Plot Size (Area)')) : null) : renderCaptionString();
      }
    }, {
      // Plot Slope Aspect
      field: 'slopeAspect',
      ...
      render: function render(row) {
        return Array.isArray(row.samplingModules) ? /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
          ...
          className: classes.startFlex
        }, renderCaptionString(row.samplingModules.length, 'Potential Sampling Modules'), /*#__PURE__*/_react.default.createElement(_IconButton.default, {
          size: "small",
