  ...
  var commonColumns = {
    site: {
      ...
      render: function render(row) {
        ...
        return /*#__PURE__*/_react.default.createElement(_Link.default, {
          component: "button",
          className: "".concat(classes.linkButton, " ").concat(classes.startFlex),
          onClick: function onClick() {
            return jumpTo(site.siteCode);
          },
          "data-selenium": "sitemap-table-siteLink"
        }, renderFeatureIcon(featureKey), /*#__PURE__*/_react.default.createElement("span", null, "".concat(site.description, " (").concat(site.siteCode, ")")));
      }
    },
    domain: {
      field: 'domainCode',
      ...
      render: function render(row) {
        ...
        return !domain ? null : /*#__PURE__*/_react.default.createElement(_Link.default, {
          component: "button",
    ...
    state: {
      ...
      render: function render(row) {
        ...
        return !usstate ? null : /*#__PURE__*/_react.default.createElement(_Link.default, {
          component: "button",
          className: classes.linkButton,
          onClick: function onClick() {
  ...
  */
  ...
  var components = {
    ...
    Toolbar: function Toolbar(props) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_materialTable.MTableToolbar, props));
    },
