  ...
  toolbarContainer: {
    ...
    '& button': {
      ...
      '&:hover, &:active': {
        ...
        border: `1px solid ${_Theme.COLORS.LIGHT_BLUE[400]}`,
        backgroundColor: `${_Theme.COLORS.LIGHT_BLUE[400]}20`,
        padding: '11px'
      }
    }
  },
...
const SiteMapTable = () => {
  ...
  */
  ...
  const renderCaptionString = (str = '--', ariaLabel = null) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
    variant: "caption",
  ...
  const commonColumns = {
    site: {
      ...
      render: row => {
        ...
        const featureKey = isDecommissioned ? _SiteMapUtils.FEATURES.DECOMMISSIONED_SITES.KEY : `${site.terrain.toUpperCase()}_${site.type.toUpperCase()}_SITES`;
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_Link.default, {
            ...
            children: [renderFeatureIcon(featureKey, unselectable), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Link.default, {
              ...
              href: `${(0, _SiteMapUtils.getHref)('SITE_DETAILS', siteCode)}`,
              ...
              className: classes.siteDetailsLink,
              href: `${(0, _SiteMapUtils.getHref)('EXPLORE_DATA_PRODUCTS_BY_SITE', siteCode)}`,
              ...
              className: classes.siteDetailsLink,
              href: `${(0, _SiteMapUtils.getHref)('EXPLORE_SAMPLE_PRODUCTS_BY_SITE', siteCode)}`,
    ...
    domain: {
      ...
      render: row => {
        ...
        return !domain ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Link.default, {
            component: "button",
    ...
    state: {
      ...
      render: row => {
        ...
        return !usstate ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Link.default, {
            component: "button",
            className: classes.linkButton,
    ...
    coordinates: {
      ...
      render: row => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
          children: [renderCaptionString(latitude, 'Latitude'), /*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), renderCaptionString(longitude, 'Longitude')]
        });
      },
  ...
  */
  ...
  if (focus === _SiteMapUtils.FEATURE_TYPES.LOCATIONS.KEY) {
    columns = [{
      ...
      render: row => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          className: classes.startFlex,
          children: [renderFeatureIcon(featureKey), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
      ...
      render: row => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
          children: [renderCaptionString(`${plotDimensions}`, 'Plot Size (Dimensions)'), Number.isFinite(plotSize) ? /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("br", {}), renderCaptionString(`(${plotSize.toFixed(0)}m\u00b2)`, 'Plot Size (Area)')]
          }) : null]
        });
      },
      csvRender: row => {
      ...
      render: row => {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
          placement: "left",
          title: samplingModules.length ? /*#__PURE__*/(0, _jsxRuntime.jsx)("ul", {
            style: {
              marginLeft: _Theme.default.spacing(-1)
            },
            children: samplingModules.map(m => /*#__PURE__*/(0, _jsxRuntime.jsx)("li", {
              children: _SiteMapUtils.PLOT_SAMPLING_MODULES[m]
            }, m))
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
            className: classes.startFlex,
            children: [renderCaptionString(samplingModules.length, 'Potential Sampling Modules'), /*#__PURE__*/(0, _jsxRuntime.jsx)(_IconButton.default, {
              size: "small",
  ...
  const toolbarClassName = view === _SiteMapUtils.VIEWS.SPLIT ? classes.toolbarContainer : `${classes.toolbarContainer} ${classes.toolbarContainerNoSplit}`;
  const components = {
    Container: _Box.default,
    // eslint-disable-next-line react/no-unstable-nested-components
    Toolbar: toolbarProps => /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
  ...
  */
  ...
  if (!fullHeight && view !== _SiteMapUtils.VIEWS.SPLIT) {
    tableOptions.maxBodyHeight = `${maxBodyHeight || _SiteMapUtils.MIN_TABLE_MAX_BODY_HEIGHT}px`;
  }
