...
export const fetchDomainHierarchy = (domain = '')=>{
    ...
    return new Promise((resolve, reject)=>{
        NeonApi.getSiteLocationHierarchyObservable(domain).pipe(map((response)=>{
...
export const fetchSingleLocationREST = (location)=>{
    ...
    return new Promise((resolve, reject)=>{
        NeonApi.getLocationObservable(location).pipe(map((response)=>{
            if (response && response.data) {
                resolve([
                    response.data
                ]);
...
export const fetchManyLocationsGraphQL = (locations)=>{
    ...
    return new Promise((resolve, reject)=>{
        NeonGraphQL.getManyLocationsByName(locations).pipe(// Success
        map((result)=>{
