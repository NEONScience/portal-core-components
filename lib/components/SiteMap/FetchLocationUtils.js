...
var fetchDomainHierarchy = function fetchDomainHierarchy() {
  ...
  return new Promise(function (resolve, reject) {
    _NeonApi.default.getSiteLocationHierarchyObservable(domain).pipe((0, _rxjs.map)(function (response) {
...
var fetchSingleLocationREST = function fetchSingleLocationREST(location) {
  ...
  return new Promise(function (resolve, reject) {
    _NeonApi.default.getLocationObservable(location).pipe((0, _rxjs.map)(function (response) {
      if (response && response.data) {
        resolve([response.data]);
        return (0, _rxjs.of)(true);
      }
