...
var SiteMapContainer = function SiteMapContainer(props) {
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    ...
    var handleClick = function handleClick(event) {
      if (featuresRef.current && !featuresRef.current.contains(event.target) && contentDivRef.current && !contentDivRef.current.contains(event.target)) {
        dispatch({
  ...
  }, [state.filters.features.open, featuresRef, contentDivRef, dispatch]);
  /**
  ...
  */
  ...
  var renderLegendButton = function renderLegendButton() {
    var buttonStyle = filters.features.open ? {} : {
      backgroundColor: 'white'
    };
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      enterDelay: 500,
      enterNextDelay: 200,
      title: "".concat(filters.features.open ? 'Hide' : 'Show', " the legend"),
      placement: fullscreen ? 'bottom-end' : 'top-end'
    }, /*#__PURE__*/_react.default.createElement(_Button.default, {
      color: "primary",
      style: buttonStyle,
      variant: filters.features.open ? 'contained' : 'outlined',
      endIcon: filters.features.open ? /*#__PURE__*/_react.default.createElement(_ExpandLess.default, null) : /*#__PURE__*/_react.default.createElement(_ExpandMore.default, null),
  ...
  */
  ...
  var getSelectedItemDescription = function getSelectedItemDescription(item) {
    ...
    if (selectionActive === _SiteMapUtils.FEATURE_TYPES.SITES) {
  ...
  */
  ...
  var renderSelectionSummary = function renderSelectionSummary() {
    ...
    var unit = selectionActive === _SiteMapUtils.FEATURE_TYPES.SITES ? 'site' : 'location';
    var s = selection.size === 1 ? '' : 's';
    var title = "".concat(selection.size ? selection.size.toString() : 'No', " ").concat(unit).concat(s, " selected");
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      dense: true
    }, _toConsumableArray(selection).map(function (selectedItem) {
  ...
  */
  ...
  var renderVerticalResizeButton = function renderVerticalResizeButton() {
    return fullscreen ? null : /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
      placement: "left",
  ...
  */
  ...
  var featuresContainerClassName = classes.featuresContainer;
  var viewLegendButtonsContainerClassName = classes.viewLegendButtonsContainer;

  if (fullscreen) {
    /* eslint-disable max-len */
    featuresContainerClassName = "".concat(classes.featuresContainer, " ").concat(classes.featuresContainerFullscreen);
  ...
  }).map(renderFeatureOption)), /*#__PURE__*/_react.default.createElement("div", {
