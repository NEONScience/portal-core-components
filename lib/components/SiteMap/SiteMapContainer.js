...
const useStyles = (0, _styles.makeStyles)(theme => ({
  ...
  resizeBorder: {
    position: 'absolute',
    border: `3px solid ${_Theme.default.colors.LIGHT_BLUE[500]}`,
    top: '0px',
    left: '0px',
    width: '100%',
    zIndex: 998,
  ...
  legendButton: {
    border: `1px solid ${_Theme.default.palette.primary.main}`,
...
const SiteMapContainer = inProps => {
  ...
  const progressId = `sitemap-progress-${(0, _uniqueId.default)()}`;
  const {
    filters,
    fullscreen,
    aspectRatio,
  ...
  */
  const renderMapTableToggleButtonGroup = () => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ToggleButtonGroup.default, {
      ...
      children: Object.keys(_SiteMapUtils.VIEWS).filter(key => key !== _SiteMapUtils.VIEWS.SPLIT).map(key => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
          ...
          endIcon: filters.legendOpen ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_ExpandLess.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_ExpandMore.default, {}),
          ...
          children: belowMd ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Toc.default, {
            style: {
              fontSize: '20px'
            }
          }) : 'Legend'
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
          ...
          startIcon: hideUnselectable ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_VisibilityOff.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_Visibility.default, {}),
          ...
          children: belowMd ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_NotInterested.default, {
            style: {
              fontSize: '20px'
            }
          }) : 'Unselectable'
  ...
  */
  const renderSelectionSummary = () => {
    ...
    let icon = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Remove.default, {});
    let color = 'default';
    ...
    if (selection.size) {
      if (selectionValid) {
        ...
        color = 'secondary';
        backgroundColor = _Theme.default.palette.secondary.main;
      } else {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Zoom.default, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_List.default, {
            dense: true,
            children: [...selection].sort().map(selectedItem => {
              ...
              return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_ListItem.default, {
                children: [!src ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(_ListItemIcon.default, {
        ...
        deleteIcon: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
          enterDelay: 500,
          enterNextDelay: 200,
          title: "Deselect all",
  ...
  */
  const renderVerticalResizeButton = () => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
      ...
      enterDelay: 500,
      enterNextDelay: 200,
      title: `Resize ${view === _SiteMapUtils.VIEWS.TABLE ? 'table' : 'map'} vertically`,
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_IconButton.default, {
        draggable: true,
        type: "button",
        ref: resizeButtonRef,
        ...
        size: "large",
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Height.default, {
          fontSize: "small"
        })
      })
    });
  ...
  */
  const renderFeatureOption = key => {
      ...
      label = /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_IconButton.default, {
            ...
            children: collapsed ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_ArrowLeft.default, {
              fontSize: "inherit"
    ...
    const formControl = /*#__PURE__*/(0, _jsxRuntime.jsx)(_FormControlLabel.default, {
      label: label,
      "aria-label": tooltip,
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [tooltip ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
        title: tooltip,
        enterDelay: 500,
        enterNextDelay: 200,
        placement: "bottom-start",
        children: formControl
      }) : formControl, !allChildren.length ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        style: {
  ...
  */
  const renderOverlayLegend = legend => {
    const renderItem = legendKey => {
      ...
      const swatch = /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        className: classes.overlayLegendSwatch,
        style: {
          backgroundColor: itemColor
        }
      });
      const itemLabel = /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        className: classes.overlayLegendItem,
        children: [swatch, /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
          variant: "caption",
          children: itemName
        })]
      }, legendKey);
      return itemDescription ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
        title: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
            className: classes.overlayLegendItemTooltipTitle,
            children: [swatch, /*#__PURE__*/(0, _jsxRuntime.jsx)("b", {
              children: itemName
            })]
          }), itemDescription]
        }),
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      className: classes.overlayLegendContainer,
      children: Array.from(categories).map((category, idx) => /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react.default.Fragment, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
  ...
  const renderOverlayOption = key => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [tooltip ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
        ...
        placement: "bottom-start",
        children: formControl
      }) : formControl, collapsed || !legend ? null : renderOverlayLegend(legend)]
    }, key);
  };
  ...
  */
  const renderLegendNEONObservatoryFeatures = () => /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    }), Object.keys(_SiteMapUtils.FEATURES).filter(f => state.filters.features.available[f] && !_SiteMapUtils.FEATURES[f].parent).filter(f => !_SiteMapUtils.FEATURES[f].generalLegendGroup).map(renderFeatureOption)]
  });

  /**
     Render - Legend - Overlays
  */
  const renderLegendOverlays = () => /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
    children: Object.keys(_SiteMapUtils.OVERLAY_GROUPS).map(groupKey => {
      const {
        title,
        description
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("hr", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
            ...
            className: classes.legendSectionTitle,
            children: title
          }), !description ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
            title: description,
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_IconButton.default, {
              size: "small",
              style: {
  ...
  */
  const renderLegendGeneralFeatures = () => /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    className: classes.legendSection,
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("hr", {
      className: classes.legendDivider
  ...
  */
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ref: contentDivRef,
      ...contentDivProps,
      children: [view === _SiteMapUtils.VIEWS.MAP || view === _SiteMapUtils.VIEWS.SPLIT ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_SiteMapLeaflet.default, {}) : null, view === _SiteMapUtils.VIEWS.TABLE ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_SiteMapTable.default, {}) : null, renderVerticalResizeButton(), /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ref: legendRef,
        className: legendContainerClassName,
        style: {
          display: state.filters.legendOpen ? 'flex' : 'none'
        },
        children: [renderLegendNEONObservatoryFeatures(), renderLegendOverlays(), renderLegendGeneralFeatures()]
      }), /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        className: viewLegendButtonsContainerClassName,
        children: [renderUnselectablesButton(), renderMapTableToggleButtonGroup(), renderLegendButton()]
      }), renderSelectionSummary()]
    }), fullscreen ? null : /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      ref: resizeBorderRef,
      className: classes.resizeBorder
    }), view === _SiteMapUtils.VIEWS.SPLIT ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_SiteMapTable.default, {}) : null]
  });
};
