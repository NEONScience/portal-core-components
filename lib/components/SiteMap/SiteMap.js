...
var _iconShadow = _interopRequireDefault(require("./icon-shadow.svg"));

var _iconAquatic = _interopRequireDefault(require("./icon-aquatic.svg"));

var _iconTerrestrial = _interopRequireDefault(require("./icon-terrestrial.svg"));
...
var ICON_SVGS = {
  AQUATIC: _iconAquatic.default,
  TERRESTRIAL: _iconTerrestrial.default,
  SHADOW: _iconShadow.default
};
  ...
  */
  ...
  var renderSitePopup = function renderSitePopup(site) {
    ...
    var renderField = function renderField(title, value) {
      ...
      return _react.default.createElement("div", {
        style: {
          marginBottom: _Theme.default.spacing(marginBottom)
        }
      }, _react.default.createElement(_Typography.default, {
        variant: "subtitle2"
    ...
    }, terrainIcon, renderField(terrainTitle, terrainSubtitle, 0)), renderField('Latitude/Longitude', "".concat(site.latitude, ", ").concat(site.longitude))), _react.default.createElement(_Grid.default, {
      item: true,
      xs: 6
    }, renderField(stateFieldTitle, _states.default[site.stateCode].name), renderField('Domain', "".concat(site.domainCode, " - ").concat(_domains.default[site.domainCode].name)))), siteDetailsButton, _react.default.createElement("br", null), exploreDataProductsButton);
  };
