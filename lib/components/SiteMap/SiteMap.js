...
var _statesShapes = require('../../static/statesShapes/statesShapes.json');

var _statesShapes2 = _interopRequireDefault(_statesShapes);

var _domains = require('../../static/domains/domains.json');

var _domains2 = _interopRequireDefault(_domains);

var _domainsShapes = require('../../static/domainsShapes/domainsShapes.json');

var _domainsShapes2 = _interopRequireDefault(_domainsShapes);
...
var TILE_LAYERS = exports.TILE_LAYERS = {
  NatGeo_World_Map: {
    ...
    overlayColor: _Theme2.default.palette.primary.main
  },
  World_Imagery: {
...
var SiteMap = function SiteMap(props) {
  ...
  */
  ...
  var renderSitesOverlay = function renderSitesOverlay() {
    ...
    return _react2.default.createElement(
      Overlay,
      { name: 'NEON Sites', checked: state.sitesOverlay },
      _react2.default.createElement(
        _reactLeaflet.FeatureGroup,
        null,
        Object.keys(state.sites).map(function (siteCode) {
  ...
  var renderStatePopup = function renderStatePopup(stateCode) {
    if (!_states2.default[stateCode]) {
      return null;
    }
    var stateName = _states2.default[stateCode].name;
    return _react2.default.createElement(
      _reactLeaflet.Popup,
      { className: classes.popup },
      _react2.default.createElement(
  ...
  var renderStatesOverlay = function renderStatesOverlay() {
    return _react2.default.createElement(
      Overlay,
      { name: 'US States', checked: state.statesOverlay },
      _react2.default.createElement(
        _reactLeaflet.FeatureGroup,
        null,
        _statesShapes2.default.features.map(function (usState) {
          return _react2.default.createElement(
            _reactLeaflet.Polygon,
            {
  ...
  var renderDomainPopup = function renderDomainPopup(domainCode) {
    if (!_domains2.default[domainCode]) {
      return null;
    }
    var domainName = _domains2.default[domainCode].name;
    return _react2.default.createElement(
      _reactLeaflet.Popup,
      { className: classes.popup },
      _react2.default.createElement(
  ...
  var renderDomainsOverlay = function renderDomainsOverlay() {
    return _react2.default.createElement(
      Overlay,
      { name: 'NEON Domains', checked: state.domainsOverlay },
      _react2.default.createElement(
        _reactLeaflet.FeatureGroup,
        null,
        _domainsShapes2.default.features.map(function (domain) {
          return _react2.default.createElement(
            _reactLeaflet.Polygon,
            {
  ...
  var renderTileLayer = function renderTileLayer(key) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_reactLeaflet.TileLayer, { key: key, url: tileLayer.url, attribution: attributionString })
    );
  };
