...
var SiteMapComponent = function SiteMapComponent(props) {
  ...
  */
  ...
  var reducer = function reducer(state, action) {
    ...
    switch (action.type) {
      case 'setDerivedRegionSites':
        return deriveRegionSites(_extends({}, state, {
      ...
      case 'toggleSiteSelected':
        ...
        return deriveRegionSelections(_extends({}, state, {
  ...
  if (neonContextFetches.sites.status === 'SUCCESS') {
    initialState = deriveRegionSites(_extends({}, initialState, {
      regionSitesDerived: true
    }));
  }
  ...
  */
  ...
  var renderSitePopup = function renderSitePopup(site) {
    ...
    var renderActions = function renderActions() {
      if (mode === 'SELECT') {
        ...
        return _react.default.createElement(_SnackbarContent.default, {
          ...
          message: _react.default.createElement("div", {
            ...
            variant: "body2"
          }, "Click to ", _react.default.createElement("b", null, verb), " ", preposition, " selection")))
        });
      }
      ...
      }, actionButtonProps), "Site Details")), _react.default.createElement(_Grid.default, {
        item: true,
        xs: 6
      }, _react.default.createElement(_Button.default, _extends({
    ...
    return _react.default.createElement(_reactLeaflet.Popup, {
    ...
    }, "".concat(site.description, " (").concat(site.siteCode, ")"))), _react.default.createElement(_Grid.default, {
      container: true,
      spacing: 1,
      style: {
      ...
      variant: "caption"
    }, _react.default.createElement("i", null, terrainTypeSubtitle))), _react.default.createElement(_Grid.default, {
      item: true,
      xs: 4,
      style: {
        textAlign: 'right'
      ...
      variant: "body2"
    }, allStates[site.stateCode].name)), _react.default.createElement(_Grid.default, {
      item: true,
      xs: 5,
      style: {
        display: 'flex',
    ...
    }, site.latitude, _react.default.createElement("br", null), site.longitude))), _react.default.createElement(_Grid.default, {
      item: true,
      xs: 7,
      style: {
        textAlign: 'right'
  ...
  var renderSitesOverlay = function renderSitesOverlay() {
    var overlayName = _server.default.renderToStaticMarkup(_react.default.createElement("div", {
      style: {
        display: 'inline-flex',
        flexDirection: 'column'
      }
    }, _react.default.createElement("div", null, "NEON Sites"), _react.default.createElement("div", {
      className: classes.startFlex
    }, _react.default.createElement("img", {
      alt: "Terrestrial Core",
      src: ICON_SVGS.CORE.TERRESTRIAL.BASE,
      className: classes.keySiteIcon
    }), _react.default.createElement("div", null, "Terrestrial Core")), _react.default.createElement("div", {
      className: classes.startFlex
    }, _react.default.createElement("img", {
      alt: "Terrestrial Relocatable",
      src: ICON_SVGS.RELOCATABLE.TERRESTRIAL.BASE,
      className: classes.keySiteIcon
    }), _react.default.createElement("div", null, "Terrestrial Relocatable")), _react.default.createElement("div", {
      className: classes.startFlex
    }, _react.default.createElement("img", {
      alt: "Aquatic Core",
      src: ICON_SVGS.CORE.AQUATIC.BASE,
      className: classes.keySiteIcon
    }), _react.default.createElement("div", null, "Aquatic Core")), _react.default.createElement("div", {
      className: classes.startFlex
    }, _react.default.createElement("img", {
      alt: "Aquatic Relocatable",
      src: ICON_SVGS.RELOCATABLE.AQUATIC.BASE,
      className: classes.keySiteIcon
    }), _react.default.createElement("div", null, "Aquatic Relocatable"))));

    return _react.default.createElement(Overlay, {
      name: overlayName,
      checked: state.sitesOverlay
    }, _react.default.createElement(_reactLeaflet.FeatureGroup, null, Object.keys(allSites).map(function (siteCode) {
      ...
      return _react.default.createElement(_reactLeaflet.Marker, _extends({
        key: siteCode,
  ...
  var renderPopupSitesList = function renderPopupSitesList(sitesList) {
    if (!sitesList || !sitesList.size) {
      return _react.default.createElement(_Typography.default, {
        variant: "subtitle2",
        gutterBottom: true
      }, _react.default.createElement("i", null, "No NEON Sites"));
    }

    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Typography.default, {
      variant: "subtitle2",
      gutterBottom: true
    }, "NEON Sites (".concat(sitesList.size, "):")), _react.default.createElement("div", null, _toConsumableArray(sitesList).map(function (siteCode) {
      var site = allSites[siteCode];
      ...
      }), _react.default.createElement("div", null, "".concat(site.description, " (").concat(siteCode, ")")));
    })));
  };
  /**
     Render US States
  */
    ...
    var renderActions = function renderActions() {
      ...
      return _react.default.createElement(_SnackbarContent.default, {
        ...
        message: _react.default.createElement("div", {
          ...
          variant: "body2"
        }, "Click to ", _react.default.createElement("b", null, verb, " ", all, count, " site", plural), " ", preposition, " selection")))
      });
    };
  ...
  var renderStatesOverlay = function renderStatesOverlay() {
    ...
    }), _react.default.createElement("div", null, "US States")));
    ...
    return _react.default.createElement(Overlay, {
      ...
      return _react.default.createElement(_reactLeaflet.Polygon, _extends({
  ...
  */
  ...
  var renderDomainsOverlay = function renderDomainsOverlay() {
    ...
    }), _react.default.createElement("div", null, "NEON Domains")));
...
var SiteMap = function SiteMap(props) {
  var _NeonContext$useNeonC4 = _NeonContext.default.useNeonContextState(),
      _NeonContext$useNeonC5 = _slicedToArray(_NeonContext$useNeonC4, 1),
      isActive = _NeonContext$useNeonC5[0].isActive;

  if (!isActive) {
    return _react.default.createElement(_NeonContext.default.Provider, null, _react.default.createElement(SiteMapComponent, props));
  }

  return _react.default.createElement(SiteMapComponent, props);
};

var SiteMapPropTypes = {
