  ...
  */
  ...
  var renderPopupSitesList = function renderPopupSitesList(sitesList) {
    ...
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Typography.default, {
      ...
      var src = ICON_SVGS[site.type][site.terrain];
      return _react.default.createElement("div", {
        key: siteCode,
        style: {
          display: 'flex'
  ...
  var renderStatesOverlay = function renderStatesOverlay() {
    var keyStyle = {
      border: "2px solid ".concat(_Theme.COLORS.RED[500]),
      backgroundColor: "".concat(_Theme.COLORS.RED[500], "88"),
  ...
  var renderDomainsOverlay = function renderDomainsOverlay() {
    var keyStyle = {
      border: "2px solid ".concat(_Theme.COLORS.SECONDARY_BLUE[500]),
      backgroundColor: "".concat(_Theme.COLORS.SECONDARY_BLUE[500], "88"),
      width: _Theme.default.spacing(3),
      height: _Theme.default.spacing(1),
      margin: _Theme.default.spacing(0, 0.5, 0.25, 0)
    };
