...
var SiteMap = function SiteMap(props) {
  ...
  */
  ...
  var deriveRegionSites = function deriveRegionSites(state) {
    var stateSites = {};
    var domainSites = {};
    Object.keys(state.sites).forEach(function (siteCode) {
      var _state$sites$siteCode = state.sites[siteCode],
          stateCode = _state$sites$siteCode.stateCode,
          domainCode = _state$sites$siteCode.domainCode;
    ...
    Object.keys(_states.default).forEach(function (stateCode) {
      if (!stateSites[stateCode]) {
        stateSites[stateCode] = new Set();
      }
    });
  ...
  */
  ...
  var renderSitePopup = function renderSitePopup(site) {
    ...
    return _react.default.createElement(_reactLeaflet.Popup, {
      ...
      variant: "body2"
    }, _states.default[site.stateCode].name)), _react.default.createElement(_Grid.default, {
      item: true,
      xs: 5,
      style: {
        display: 'flex',
      ...
      variant: "body2"
    }, "".concat(site.domainCode, " - ").concat(_domains.default[site.domainCode].name)))), renderActions());
  };
  ...
  */
  ...
  var renderStatePopup = function renderStatePopup(stateCode) {
    ...
    return _react.default.createElement(_reactLeaflet.Popup, {
      ...
      variant: "h6",
      gutterBottom: true
    }, "".concat(_states.default[stateCode].name, " (").concat(stateCode, ")")), renderPopupSitesList(state.stateSites[stateCode]), renderActions());
  };
  ...
  */
  ...
  var renderDomainPopup = function renderDomainPopup(domainCode) {
    ...
    return _react.default.createElement(_reactLeaflet.Popup, {
      ...
      variant: "h6",
      gutterBottom: true
    }, "".concat(_domains.default[domainCode].name, " (").concat(domainCode, ")")), renderPopupSitesList(state.domainSites[domainCode]), renderActions());
  };
