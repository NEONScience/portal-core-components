...
var rootOverlayColors = {
  states: _Theme.COLORS.RED[300],
  domains: _Theme.COLORS.GREY[300],
  ...
  */
  ...
  var renderSitePopup = function renderSitePopup(site) {
    ...
    var renderActions = function renderActions() {
      ...
      }, actionButtonProps), "Site Details"), _react.default.createElement("br", null), _react.default.createElement(_Button.default, _extends({
      ...
      }, actionButtonProps), "Explore Data Products"));
    };
    ...
    return _react.default.createElement(_reactLeaflet.Popup, {
      ...
      item: true,
      xs: 4
    }, renderField('Lat./Lon.', "".concat(site.latitude, ", ").concat(site.longitude)))), renderActions());
  };
