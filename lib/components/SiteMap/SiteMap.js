...
var _SiteIcon = _interopRequireDefault(require("./SiteIcon"));

var _SiteMarker = _interopRequireDefault(require("./SiteMarker"));
...
var selectedSites = ['ABBY', 'MOAB', 'PUUM', 'ORNL', 'TREE', 'STEI', 'LIRO', 'UNDE', 'CRAM'];
var TILE_LAYERS = {
  NatGeo_World_Map: {
...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  return {
    ...
    keySwatchStates: {
      border: "2px solid ".concat(baseOverlayColors.states),
      backgroundColor: "".concat(baseOverlayColors.states, "88"),
      width: _Theme.default.spacing(3),
      height: _Theme.default.spacing(1),
      margin: _Theme.default.spacing(0, 0.5, 0.25, 0)
    },
    keySwatchDomains: {
      border: "2px solid ".concat(baseOverlayColors.domains),
      backgroundColor: "".concat(baseOverlayColors.domains, "88"),
      width: _Theme.default.spacing(3),
      height: _Theme.default.spacing(1),
      margin: _Theme.default.spacing(0, 0.5, 0.25, 0)
    },
...
var SiteMap = function SiteMap(props) {
  ...
  */
  ...
  var renderSitesOverlay = function renderSitesOverlay() {
    ...
    }, _react.default.createElement(_SiteIcon.default, {
      type: "CORE",
      terrain: "TERRESTRIAL",
    ...
    return _react.default.createElement(Overlay, {
      ...
      return _react.default.createElement(_SiteMarker.default, {
        key: siteCode,
        zoom: state.zoom,
  ...
  var renderPopupSitesList = function renderPopupSitesList(sitesList) {
    ...
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Typography.default, {
      variant: "subtitle2",
      gutterBottom: true
    }, "NEON Sites (".concat(sitesList.length, "):")), _react.default.createElement("div", null, sitesList.map(function (siteCode) {
      return _react.default.createElement("div", {
        key: siteCode,
        style: {
          display: 'flex'
      ...
      }), _react.default.createElement("div", null, "".concat(state.sites[siteCode].description, " (").concat(siteCode, ")")));
    })));
  };
  ...
  var renderStatePopup = function renderStatePopup(stateCode) {
    ...
    var sitesList = Object.keys(state.sites).filter(function (siteCode) {
      return state.sites[siteCode].stateCode === stateCode;
    });
    return _react.default.createElement(_reactLeaflet.Popup, {
      ...
      variant: "h6",
      gutterBottom: true
    }, "".concat(stateName, " (").concat(stateCode, ")")), renderPopupSitesList(sitesList));
  };
  ...
  var renderDomainPopup = function renderDomainPopup(domainCode) {
    ...
    var sitesList = Object.keys(state.sites).filter(function (siteCode) {
      return state.sites[siteCode].domainCode === domainCode;
    });
    return _react.default.createElement(_reactLeaflet.Popup, {
      className: classes.popup
    }, _react.default.createElement(_Typography.default, {
      variant: "h6",
      gutterBottom: true
    }, "".concat(domainName, " (").concat(domainCode, ")")), renderPopupSitesList(sitesList));
  };
