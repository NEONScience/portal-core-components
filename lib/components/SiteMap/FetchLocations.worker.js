...
var fetchLocations = function fetchLocations() {
  ...
  var locations = (event || {}).data || null; // Extract locations list and validate
...
self.addEventListener('message', fetchLocations); // Must have a default export for production build

var _default = fetchLocations;
