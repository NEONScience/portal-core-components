...
function DownloadDataDialog() {
  ...
  */
  ...
  return /*#__PURE__*/_react.default.createElement(_DialogBase.default, {
    ...
    variant: "subtitle2"
  }, productData.productCode)), /*#__PURE__*/_react.default.createElement("div", {
    className: classes.startFlex
  }, /*#__PURE__*/_react.default.createElement(_Typography.default, {
    variant: "subtitle2",
    className: classes.releaseTitle
  }, release.value === null ? 'Latest released and provisional data' : "Release: ".concat(release.value)), /*#__PURE__*/_react.default.createElement(_Tooltip.default, {
    placement: "right",
