...
function DownloadDataDialog() {
  ...
  var belowSmMdStepper = (0, _useMediaQuery.default)('(max-width: 700px)');
  var belowMdStepper = (0, _useMediaQuery.default)('(max-width: 800px)');
  ...
  */
  var _DownloadDataContext$ = _DownloadDataContext.default.useDownloadDataState(),
    ...
    provisionalData = _DownloadDataContext$3.provisionalData,
  ...
  */
  var renderSizeEstimate = function renderSizeEstimate() {
    ...
    if (fromManifest && (manifest.status === 'fetched' || manifest.status === 'no-data') && !(manifest.sizeEstimate > 0) || fromAOPManifest && !(s3Files.totalSize > 0)) {
      ...
      var showNoReleaseData = hasProvisionalDataStep && excludeProvisionalData;
      return /*#__PURE__*/_react.default.createElement(_Typography.default, {
        variant: "body2",
        color: "error"
  ...
  var renderStepper = function renderStepper() {
    ...
    var hideLabel = requiredSteps.length > 5 && belowMdStepper || requiredSteps.length <= 5 && belowSmMdStepper;
    if (belowSm) {
