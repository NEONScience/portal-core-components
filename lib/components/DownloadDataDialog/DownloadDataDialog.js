...
function DownloadDataDialog() {
  ...
  */
  ...
  const handleDownload = () => {
    ...
    if (fromAOPManifest) {
      ...
      return (0, _manifestUtil.downloadAopManifest)(config, s3Files, headers, documentation.value);
    }
    ...
    return (0, _manifestUtil.downloadManifest)(manifestBody, headers);
  };
  ...
  */
  ...
  const renderDownloadButton = () => {
    ...
    if (downloadStatus === _DownloadDataContext.default.DOWNLOAD_STATUS.AWAITING_PRECONDITIONS) {
      disabled = true;
    ...
    } else if (downloadStatus === _DownloadDataContext.default.DOWNLOAD_STATUS.DISALLOW_DOWNLOAD) {
      disabled = true;
  ...
  const renderLoginRequired = () => {
    const init = downloadStatus === _DownloadDataContext.default.DOWNLOAD_STATUS.AWAITING_PRECONDITIONS;
    const allowDownload = downloadStatus === _DownloadDataContext.default.DOWNLOAD_STATUS.ALLOW_DOWNLOAD;
  ...
  const renderActions = () => {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: classes.gtmCaptureButton
    }, showDownloadButton ? 'Cancel' : 'Done'), showDownloadButton ? renderDownloadButton() : null), renderDownloadButtonStepNote());
  };
  ...
  }, renderFileType())) : null)), renderLoginRequired(), renderExternalHostInfo(), renderDownloadSizeWarning(), getSizeEstimateBytes() < _manifestUtil.DOWNLOAD_SIZE_WARN ? /*#__PURE__*/_react.default.createElement(_Divider.default, null) : null, renderStepper(), renderActiveStep());
}