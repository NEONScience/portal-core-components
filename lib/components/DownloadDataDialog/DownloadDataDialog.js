...
function DownloadDataDialog() {
  ...
  */
  ...
  const renderExternalHostInfo = () => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ExternalHostInfo.default, {
  ...
  */
  const renderSizeEstimate = () => {
    ...
    if (fromManifest && manifest.status === 'fetching') {
      return belowSm ? /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    if (fromManifest && manifest.status === 'fetched' && manifest.sizeEstimate > 0 || fromAOPManifest && s3Files.isValid) {
      ...
      const estimateIcon = bytes > _manifestUtil.DOWNLOAD_SIZE_WARN ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Warning.default, {
        style: {
          marginRight: '8px',
          marginBottom: '-5px'
        }
      ...
      if (belowSm) {
        ...
        return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Typography.default, {
          variant: "body2",
          children: ["Estimated size", uncompressed, ":\xA0", /*#__PURE__*/(0, _jsxRuntime.jsxs)("span", {
            style: {
              fontWeight: 700,
              color: estimateColor
            },
            children: [estimateIcon, (0, _manifestUtil.formatBytes)(bytes)]
          })]
        });
      }
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_Typography.default, {
          variant: "subtitle1",
          ...subtitleStyle,
          children: ["Estimated size", uncompressed]
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_CardContent.default, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Warning.default, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_Typography.default, {
            ...
            children: ["Be sure you have at least ", formattedBytes, " of free disk space for this download!"]
  ...
  const renderFileType = () => {
    ...
    if (manifest.status !== 'fetched' || manifest.status === 'fetched' && !(manifest.sizeEstimate > 0)) {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Typography.default, {
        ...
        children: ["File Type:\xA0", /*#__PURE__*/(0, _jsxRuntime.jsx)("b", {
  ...
  const renderDownloadButton = () => {
    ...
    let icon = /*#__PURE__*/(0, _jsxRuntime.jsx)(_SaveAlt.default, {
      ...iconProps
    });
    if (allStepsComplete) {
      if (fromAOPManifest) {
      ...
      if (fromManifest) {
        switch (manifest.status) {
          ...
          case 'fetching':
            ...
            icon = /*#__PURE__*/(0, _jsxRuntime.jsx)(_CircularProgress.default, {
              size: 16,
              color: "inherit",
              ...iconProps
            });
          ...
          case 'error':
            ...
            icon = /*#__PURE__*/(0, _jsxRuntime.jsx)(_ErrorOutline.default, {
              ...iconProps
            });
            break;
  ...
  const renderAuthSuggestion = () => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_NeonSignInButton.default, {})]
    });
    /* eslint-enable react/jsx-one-expression-per-line */
  };
    ...
    if (belowSm) {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_Grid.default, {
          container: true,
          spacing: 2,
          children: [showDownloadButton ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Grid.default, {
            item: true,
            xs: 12,
            sm: 12,
            md: 8,
          ...
          children: [renderDownloadButtonStepNote(), renderAuthSuggestion()]
        })]
      });
    }
  ...
  const renderStepNavButtons = () => /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    style: {
      whiteSpace: 'nowrap'
    },
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.default, {
      ...
      startIcon: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronLeft.default, {}),
      ...
      onClick: () => changeToStep(activeStepIndex + 1),
      endIcon: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronRight.default, {}),
  ...
  const renderStepper = () => {
    ...
    if (belowSm) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_MobileStepper.default, {
          steps: maxSteps,
          variant: "dots",
          activeStep: activeStepIndex,
          backButton: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Button.default, {
            ...buttonProps,
            onClick: handleBack,
            disabled: activeStepIndex === 0,
            children: [_Theme.default.direction === 'rtl' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronRight.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronLeft.default, {}), "Back"]
          }),
          nextButton: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Button.default, {
            ...buttonProps,
            onClick: handleNext,
            disabled: activeStepIndex === maxSteps - 1,
            children: ["Next", _Theme.default.direction === 'rtl' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronLeft.default, {}) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_ChevronRight.default, {})]
          })
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Stepper.default, {
        ...
        children: requiredSteps.map((step, index) => {
          ...
          if (step.key === 'summary') {
            buttonProps.icon = /*#__PURE__*/(0, _jsxRuntime.jsx)(_Stars.default, {
          ...
          return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip.default, {
            ...
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Step.default, {
              ...
              children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_StepButton.default, {
                ...buttonProps,
  ...
  const renderActiveStep = () => {
    ...
    if (requiredSteps.length < 2) {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [getStep(activeStepIndex).title ? /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          style: {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_DownloadStepForm.default, {
            stepKey: requiredSteps[activeStepIndex].key
          })
        })]
      });
    }
    const titleMarker = requiredSteps[activeStepIndex].key === 'summary' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Stars.default, {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [titleMarker, /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
          variant: "h5",
          style: {
            flexGrow: 1
          },
  ...
  const renderGtmTags = () => /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_DialogBase.default, {
    ...
    toolbarChildren: fromManifest || fromAOPManifest ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Hidden.default, {
      smDown: true,
    ...
    children: [renderGtmTags(), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Grid.default, {
      container: true,
      spacing: 2,
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_Grid.default, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
          ...
          }), (productData.themes || []).map(dataTheme => /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
            style: {
              marginLeft: _Theme.default.spacing(1.5)
            },
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_DataThemeIcon.default, {
              size: 3,
              theme: dataTheme
            })
          }, dataTheme))]
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ReleaseChip.default, {
            chipLabel: /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        ...
        md: 6,
        lg: 4,
        children: [fromManifest || fromAOPManifest ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Hidden.default, {
          smUp: true,
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
            style: {
              marginBottom: _Theme.default.spacing(2)
            },
            children: [renderFileType(), /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
              "data-selenium": "download-data-dialog.size-estimate",
              children: renderSizeEstimate()
            })]
          })
        }) : null, renderActions(), fromManifest || fromAOPManifest ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Hidden.default, {
          smDown: true,
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
            style: {
              marginTop: _Theme.default.spacing(1),
    ...
    }), renderExternalHostInfo(), renderDownloadSizeWarning(), getSizeEstimateBytes() < _manifestUtil.DOWNLOAD_SIZE_WARN ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Divider.default, {}) : null, renderStepper(), renderActiveStep()]
  });
}