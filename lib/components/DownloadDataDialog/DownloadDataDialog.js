...
function DownloadDataDialog() {
  ...
  */
  ...
  var _NeonContext$useNeonC = _NeonContext.default.useNeonContextState(),
      ...
      isAuthenticated = _NeonContext$useNeonC2[0].isAuthenticated;
  /**
     State (local)
  */
  ...
  */
  ...
  var renderDownloadSizeWarning = function renderDownloadSizeWarning() {
    ...
    var aopHardDriveLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_blank",
    ...
    var aopBlurb = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "An alternate way to obtain lots of AOP data is to submit an ", aopHardDriveLink, ".");
    ...
    return /*#__PURE__*/_react.default.createElement(_SnackbarContent.default, {
      ...
      message: /*#__PURE__*/_react.default.createElement("div", {
        ...
        variant: "subtitle1"
      }, /*#__PURE__*/_react.default.createElement("b", null, "Be sure you have at least ", formattedBytes, " of free disk space for this download!"), /*#__PURE__*/_react.default.createElement("br", null), "If needed, you can reduce the download size by selecting fewer sites or a more restrictive date range. ", fromAOPManifest ? aopBlurb : null)))
    });
  };
  ...
  var renderDownloadButton = function renderDownloadButton() {
    ...
    var icon = /*#__PURE__*/_react.default.createElement(_CloudDownload.default, iconProps);
  ...
  var renderAuthSuggestion = function renderAuthSuggestion() {
    ...
    var signInLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_new",
      href: (0, _routes.getFullRoute)(_routes.ROUTES.LOGIN)
    }, "signing in");

    var benefitsLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_new",
    ...
    var authStyles = {
      color: _Theme.COLORS.YELLOW[600],
      textAlign: 'right',
      whiteSpace: 'nowrap'
    };
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      style: _extends(_extends({}, authStyles), {}, {
        marginTop: _Theme.default.spacing(1),
        fontWeight: 600
      })
    }, "Have an account? Consider ", signInLink, " before proceeding."), /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      style: _extends(_extends({}, authStyles), {}, {
        fontStyle: 'italic',
        fontSize: '0.8rem'
  ...
  var renderActions = function renderActions() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: classes.gtmCaptureButton
    }, showDownloadButton ? 'Cancel' : 'Done'), showDownloadButton ? renderDownloadButton() : null), showDownloadButton && !allStepsComplete ? /*#__PURE__*/_react.default.createElement(_Typography.default, {
      variant: "body2",
      style: {
        marginTop: _Theme.default.spacing(1)
      }
    }, "Complete all steps to enable download") : null, renderAuthSuggestion());
  };
  ...
  var renderStepNavButtons = function renderStepNavButtons() {
    ...
    }, belowSm ? null : 'Next', /*#__PURE__*/_react.default.createElement(_ChevronRight.default, {
      style: {
  ...
  return /*#__PURE__*/_react.default.createElement(_DialogBase.default, {
    ...
    variant: "subtitle2"
  }, productData.productCode))), /*#__PURE__*/_react.default.createElement(_Grid.default, {
    item: true,
    xs: 12,
    sm: 6,
    md: 4
