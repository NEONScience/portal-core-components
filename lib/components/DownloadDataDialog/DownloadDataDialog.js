...
function DownloadDataDialog() {
  ...
  */
  ...
  var handleDownload = function handleDownload() {
    ...
    if (fromAOPManifest) {
      var _config = (0, _manifestUtil.buildManifestConfig)(manifestSelection, '', true);
  ...
  */
  ...
  var renderDownloadSizeWarning = function renderDownloadSizeWarning() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Card.default, {
      ...
      variant: "body1"
    }, "If needed, you can reduce the download size by selecting fewer sites or a more restrictive date range. ", fromAOPManifest ? aopBlurb : null))));
  };
  ...
  var renderAuthSuggestion = function renderAuthSuggestion() {
    ...
    var signInLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_new",
      href: _NeonEnvironment.default.getFullAuthPath('login')
    }, "signing in");

    var benefitsLink = /*#__PURE__*/_react.default.createElement(_Link.default, {
      target: "_new",
      href: "https://www.neonscience.org/about/user-accounts"
    }, "here");
    /* eslint-disable react/jsx-one-expression-per-line */
