...
var _themeDesc = _interopRequireDefault(require("../../staticJSON/themeDesc.json"));
...
const dataThemes = {
  atmosphere: {
    ...
    desc: _themeDesc.default['Atmosphere']
  },
  biogeochemistry: {
    title: 'Biogeochemistry',
    aliases: ['biogeo'],
    src: _biogeochemistry.default,
    desc: _themeDesc.default['Biogeochemistry']
  },
  ecohydrology: {
    title: 'Ecohydrology',
    aliases: ['ecohydro'],
    src: _ecohydrology.default,
    desc: _themeDesc.default['Ecohydrology']
  },
  landcover: {
    ...
    desc: _themeDesc.default['Land Cover & Processes']
  },
  organisms: {
    title: 'Organisms, Populations, and Communities',
    aliases: [],
    src: _organisms.default,
    desc: _themeDesc.default['Organisms, Populations, and Communities']
  }
};
