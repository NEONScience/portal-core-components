...
var _atmosphere = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg_optimized/atmosphere.svg"));

var _biogeochemistry = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg_optimized/biogeochemistry.svg"));

var _ecohydrology = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg_optimized/ecohydrology.svg"));

var _landcover = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg_optimized/landcover.svg"));

var _organisms = _interopRequireDefault(require("!file-loader?name=static/media/[name].[hash].[ext]!./svg_optimized/organisms.svg"));

var _excluded = ["theme", "size", "avatar", "className"];
