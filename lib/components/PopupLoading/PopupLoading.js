...
function (_Component) {
  ...
  function PopupLoading() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(PopupLoading).apply(this, arguments));
  }

  _createClass(PopupLoading, [{
    key: "render",
    value: function render() {
      var popupBackground = _react.default.createElement("div", {
      ...
      var left = '50%';
      var zIndex = 198;
      return _react.default.createElement(_PopupBase.default, {
        ...
        left: left,
        zIndex: zIndex
      }, popupBackground, _react.default.createElement("div", {
