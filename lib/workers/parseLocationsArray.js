...
function parseLocationsArray() {
  ...
  return worker.spawn(function (inData) {
    ...
    var DEFAULT_LOCATION_PROPERTIES_WHITELIST = ['maximumElevation', 'minimumElevation', 'nationalLandCoverDatabase2001', 'plotDimensions', 'plotId', 'plotSize', 'plotSubtype', 'plotType', 'slopeAspect', 'slopeGradient', 'soilTypeOrder,']; // A mapping of location property names to aliases to be worked with more easily
    ...
    */
    ...
    var parseLocationProperties = function parseLocationProperties() {
      ...
      var fullWhiteList = whiteList.concat(whiteListAliases); // outProps is the structure we plan to fill with parsed variables and return
