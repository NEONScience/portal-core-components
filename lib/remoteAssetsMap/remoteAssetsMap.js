...
const REMOTE_ASSETS = {
  DRUPAL_THEME_CSS: {
    ...
    url: `${_NeonEnvironment.default.getWebHost()}${_remoteAssets.REMOTE_ASSET_PATHS.DRUPAL_THEME_CSS}`
  },
  DRUPAL_HEADER_JS: {
    name: _remoteAssets.REMOTE_ASSET_NAMES.DRUPAL_HEADER_JS,
    url: `${_NeonEnvironment.default.getWebHost()}${_remoteAssets.REMOTE_ASSET_PATHS.DRUPAL_HEADER_JS}`
  },
  DRUPAL_HEADER_HTML: {
    name: _remoteAssets.REMOTE_ASSET_NAMES.DRUPAL_HEADER_HTML,
    url: `${_NeonEnvironment.default.getWebHost()}${_remoteAssets.REMOTE_ASSET_PATHS.DRUPAL_HEADER_HTML}`
  },
  DRUPAL_FOOTER_HTML: {
    name: _remoteAssets.REMOTE_ASSET_NAMES.DRUPAL_FOOTER_HTML,
    url: `${_NeonEnvironment.default.getWebHost()}${_remoteAssets.REMOTE_ASSET_PATHS.DRUPAL_FOOTER_HTML}`
  }
};
