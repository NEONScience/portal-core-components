  ...
  3: [function (require, module, exports) {
    ...
    (function ($) {
      ...
      function onReady() {
        ...
        $header.css("top", mainNavOffset.top + "px"); // Throlle Function
        ...
        $(".js-mobile-nav-trigger").on("change", function (e) {
          $("body")[e.target.checked ? "addClass" : "removeClass"]("js-prevent-scroll"); // console.log("mobile trigger");
        ...
        $("nav#block-neon-main-menu ul.menu--main li.menu__item.menu__item--expanded .mobileBack").click(function (e) {
          e.stopPropagation(); // console.log("mobile back");
        ...
        $('nav#block-neon-main-menu ul.menu--main[data-depth="1"] > li.expandable').click(function (e) {
          ...
          var $active = $(this).hasClass("active").toString(); // console.log(`level one ${$active}`);
          ...
          if ($active === "true") {
            ...
            } else if ($MegaMenu3rdCol === "true") {// console.log("not active 2");
            } else {
        ...
        $("nav#block-neon-main-menu ul.menu--main[data-depth='1'] > li.expandable").click(function (e) {
          ...
          $(this).toggleClass("active").siblings("li").removeClass("active"); // console.log("remove active - Level One");
