(function($) {
    ...
    function onReady() {
        ...
        function throttle(fn, wait) {
            let isThrottled = false, lastArgs = null;
        ...
        $("nav#block-neon-main-menu ul.menu--main li.menu__item.menu__item--expanded .subNavClose").click(function(e) {
            e.stopPropagation();
            let $thisListParent = $(this).parent().parent().closest("li.menu__item.menu__item--expanded");
        ...
        $('nav#block-neon-main-menu ul.menu--main[data-depth="1"] > li.expandable').click(function(e) {
            ...
            let $MegaMenu4thCol = $(".subNavWrapper").hasClass("depthThree").toString();
            if ($active === "true") {
                // console.log("active");
