...
export declare type AjaxObservableCreator<A extends AnyAction> = (ajax: typeof AjaxCreationMethod, ajaxRequest: AjaxConfig | AjaxConfig[], successAction: SuccessAction<A>, errorAction: ErrorAction<A>, action?: A, takeUntilOperator?: MonoTypeOperatorFunction<any>, ajaxBodyCreator?: AjaxBodyCreator<A>, useForkJoin?: boolean) => Observable<AnyAction>;
export declare type WorkingAction = (data?: any) => any;
export declare type SuccessAction<A extends AnyAction> = (response: AjaxResponse<unknown> | AjaxResponse<unknown>[], action?: A) => any;
