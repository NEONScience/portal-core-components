  ...
  <div class="footer-top__logo-social">
    ...
    <div class="footer-top__newsletter">
      ...
      <div class="footer-top__newsletter-btn">
        <a href="https://visitor.r20.constantcontact.com/manage/optin?v=001VGGvr8xQIKjYc_kFiPLlwmIvCFFYaYpTzc4dWCQOSphhadpd8z_FF9t2eE7JasPellXDEGnyqho068gWv1BKLmmiQYT_barjVqESL4SKSxe2MxmaCyz-62KZGt__jQeYHagiJB8oMxvlSXVeclIX2wxNJ9kt8EUjrKSz2XAFwps%3D">Subscribe Now
...
<!-- BEGIN OUTPUT from 'themes/custom/neon/templates/menu/menu.html.twig' -->
        ...
        <a href="/user/login" title="My Account" class="menu__link" data-drupal-link-system-path="user/login">My Account</a>
          ...
          <li  class="menu__item">
        <a href="/about" title="About Us" class="menu__link" data-drupal-link-system-path="node/8793">About Us</a>
              </li>
          <li  class="menu__item">
        <a href="/impact/newsroom" class="menu__link" data-drupal-link-system-path="node/10890">Newsroom</a>
              </li>
          <li  class="menu__item">
        <a href="/about/contact-us" title="Contact Us" class="menu__link" data-drupal-link-system-path="node/24">Contact Us</a>
              </li>
          <li  class="menu__item">
        <a href="/terms-use" title="Terms &amp; Conditions" class="menu__link" data-drupal-link-system-path="node/31">Terms &amp; Conditions</a>
              </li>
        </ul>
...
<!-- END OUTPUT from 'core/themes/stable/templates/layout/region.html.twig' -->
    ...
    <div class="footer-bottom__copyright">
      <p>Copyright &copy; Battelle, 2019-2020</p>
    </div>
