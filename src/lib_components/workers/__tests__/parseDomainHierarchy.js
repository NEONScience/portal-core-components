...
const expectedOutput = {
  ARIK: {
    ...
    'ARIK.AOS.reach': { parent: null, type: 'AOS reach named location type', description: null },
  },
};

describe('parseDomainHierarchy worker', () => {
  test('generates an empty output for an empty input', (done) => {
    parseDomainHierarchy().then((actualOutput) => {
      try {
