...
[
  ...
  {
    name: 'sidebarContentClassName',
    type: 'string (that maps to a className generated by useStyles)',
    default: 'null',
    description: (
      <p>
        When defining arbitrary sidebar content via the <tt>sidebarContents</tt> prop this prop
        may be additionally supplied to override CSS behavior of the outermost element for the
