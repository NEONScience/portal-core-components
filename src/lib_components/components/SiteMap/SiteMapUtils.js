...
import iconPlaceholderSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-placeholder.svg';

import iconShapeCircleShadowSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-shadow.svg';
import iconShapeCircleSelectSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-select.svg';
import iconShapeCircleHighlightSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-circle-highlight.svg';
import iconShapeDiamondShadowSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-shadow.svg';
import iconShapeDiamondSelectSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-select.svg';
import iconShapeDiamondHighlightSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-diamond-highlight.svg';
import iconShapeHomeplateShadowSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-shadow.svg';
import iconShapeHomeplateSelectSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-select.svg';
import iconShapeHomeplateHighlightSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-homeplate-highlight.svg';
import iconShapeSquareShadowSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-shadow.svg';
import iconShapeSquareSelectSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-select.svg';
import iconShapeSquareHighlightSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-shape-square-highlight.svg';

import iconSiteCoreTerrestrialSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-terrestrial.svg';
import iconSiteCoreTerrestrialSelectedSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-terrestrial-selected.svg';
import iconSiteCoreAquaticSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-aquatic.svg';
import iconSiteCoreAquaticSelectedSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-core-aquatic-selected.svg';
import iconSiteGradientTerrestrialSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-terrestrial.svg';
import iconSiteGradientTerrestrialSelectedSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-terrestrial-selected.svg';
import iconSiteGradientAquaticSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-aquatic.svg';
import iconSiteGradientAquaticSelectedSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-gradient-aquatic-selected.svg';
import iconSiteDecommissionedSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-site-decommissioned.svg';

import iconBenchmarkSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-benchmark.svg';
import iconBuoySVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-buoy.svg';
import iconDischargePointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-discharge-point.svg';
import iconDistributedBasePlotSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-base-plot.svg';
import iconDistributedBirdGridSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-bird-grid.svg';
import iconDistributedMammalGridSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-mammal-grid.svg';
import iconDistributedMosquitoPointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-mosquito-point.svg';
import iconDistributedTickPlotSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-distributed-tick-plot.svg';
import iconFishPointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-fish-point.svg';
import iconGroundwaterWellSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-groundwater-well.svg';
import iconHutSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-hut.svg';
import iconPourPointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-pour-point.svg';
import iconMegapitSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-megapit.svg';
import iconMeteorologicalStationSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-meteorological-station.svg';
import iconPlantTransectSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-plant-transect.svg';
import iconRiparianAssessmentSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-riparian-assessment.svg';
import iconSedimentPointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-sediment-point.svg';
import iconSensorStationSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-sensor-station.svg';
import iconStaffGaugeSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-staff-gauge.svg';
import iconTowerSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower.svg';
import iconTowerBasePlotSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-base-plot.svg';
import iconTowerPhenologyPlotSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-phenology-plot.svg';
import iconTowerSoilPlotSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-tower-soil-plot.svg';
import iconWetDepositionPointSVG from '!file-loader?name=static/media/[name].[hash].[ext]!./svg/icon-wet-deposition-point.svg';
