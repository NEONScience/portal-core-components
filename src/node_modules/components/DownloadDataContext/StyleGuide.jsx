...
const MyAppComponent = () => {
  ...
  // Create an rxjs subject to broadcast the global state to all child contexts.
  ...
  useEffect(() => {
    if (myAppState.downloadState.broadcast) {
      subject.next(myAppState.downloadState);
      myAppDispatch({ type: 'setBroadcastDone' });
    }
  }, [myAppState.downloadState, subject]);
      ...
      {products.map(productData => (
        <div key={productData.productCode} style={{ marginBottom: '20px' }}>
          ...
          <DownloadDataContext.Provider
            ...
            stateObservable={() => subject.asObservable()}
          >
...
export default function StyleGuide(props) {
  ...
  const rxjsSubjectsLink = (
    <Link
      target="_new"
      href="https://rxjs-dev.firebaseapp.com/guide/subject"
    >
      RxJS Subjects
    </Link>
  );
  ...
  return (
    <React.Fragment>
      ...
      <CodeBlock>
        {`
import { DownloadDataContext } from 'portal-shared';
        `}
      </CodeBlock>
      ...
      <CodeBlock>
        {`
import { DownloadDataContext, DownloadDataButton } from 'portal-shared';
...
>
  <DownloadDataButton />
      ...
      <CodeBlock>
        {`
import { DownloadDataContext, DataProductAvailability } from 'portal-shared';
...
>
  ...
  <DataProductAvailability />
      ...
      <DocBlock>
        ...
        <ul>
          ...
          <li>
            ...
            <br />
            Export of an RxJS Subject as an Observable for subscribing to broadcasted state updates from all Download Data Contexts
          </li>
        </ul>
      </DocBlock>
      <DocBlock>
        As shown in the example below, {rxjsSubjectsLink} can be used to connect the state in
      ...
      <DocBlock>
        ...
        context to be broadcasted through the context&apos;s RxJS Subject. Then, any higher order
      ...
      <DocBlock>
        ...
        shown in the example below, the higher order component creates its own RxJS Subject.
