    ...
    Object.keys(previousState.s3FileFetches)
      ...
      .filter((key) => {
        ...
        return (
          ...
          && newState.dateRange.value[1] >= yearMonth
        );
      })
      .forEach((key) => {
...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case 'setS3FilesFilterValue':
      ...
      newState.s3Files.filteredFileCount = newState.s3Files.validValues
        .filter(row => Object.keys(newState.s3Files.filters).every(col => (
          !newState.s3Files.filters[col].length || newState.s3Files.filters[col].includes(row[col])
        )))
        .length;
    ...
    case 'setS3FileFetchesCompleted':
      ...
      newState.s3Files.idxById = newState.s3Files.validValues
        .reduce((acc, file, idx) => {
          acc[file.id] = idx;
          return acc;
        }, {});
