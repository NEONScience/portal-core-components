...
NeonGraphQL.getDataProductById = id => getObservable(TYPES.DATA_PRODUCTS, DIMENSIONALITIES.ONE, id);
NeonGraphQL.getAllDataProducts = () => getObservable(TYPES.DATA_PRODUCTS, DIMENSIONALITIES.MANY);

NeonGraphQL.getSiteById = id => getObservable(TYPES.SITES, DIMENSIONALITIES.ONE, id);
NeonGraphQL.getAllSites = () => getObservable(TYPES.SITES, DIMENSIONALITIES.MANY);
